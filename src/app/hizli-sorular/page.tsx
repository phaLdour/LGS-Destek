  ...
  return (
    <AppShell user={user}>
      ...
      <header className="ring-hairline relative mb-5 flex items-center gap-4 overflow-hidden rounded-3xl border border-rehberim-border bg-white p-5 shadow-card">
        ...
        />
        <span className="relative flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-rehberim-accent to-amber-500 text-white ring-1 ring-rehberim-accent/40 shadow-card">
