...
[soru] "Aşağıdakilerden hangisi soyut anlamlıdır?" sorularında algılanamayan kavramı ara.`,
      ...
      quickQuestions: [
        ...
        { question: `"Ayağa kalktı." cümlesindeki "ayak" sözcüğü hangi anlamda kullanılmıştır?`, options: [`Gerçek anlam`, `Mecaz`, `Terim`, `Yansıma`], correctIndex: 0, explanation: `Doğru cevap: Gerçek anlam (vücudun ayağı)` },
      ],
    },
    {
      id: "cumlede-anlam",
...
[soru] Cümlede "daha/en/göre" varsa karşılaştırma; "belki/galiba" varsa olasılık aranır.`,
      ...
      quickQuestions: [
        ...
        { question: `"Çalışırsan başarırsın." cümlesinde hangi anlam vardır?`, options: [`Koşul`, `Sebep-sonuç`, `Amaç`, `Karşılaştırma`], correctIndex: 0, explanation: `Doğru cevap: Koşul (şart)` },
        ...
        { question: `"Bu kitap çok sıkıcıydı." cümlesinde hangi anlam vardır?`, options: [`Yakınma`, `Beğeni`, `Şart`, `Uyarı`], correctIndex: 0, explanation: `Doğru cevap: Yakınma (eleştiri)` },
        ...
        { question: `"Yağmur yağıyordu, yine de dışarı çıktık." cümlesinde hangi anlam vardır?`, options: [`Beklenmeyen durum`, `Sebep`, `Şart`, `Amaç`], correctIndex: 0, explanation: `Doğru cevap: Beklenmeyen durum (karşıtlık)` },
        { question: `"Çok çalışmasına rağmen sınavda başarısız oldu." cümlesinde hangi anlam vardır?`, options: [`Karşıtlık`, `Sebep-sonuç`, `Şart`, `Amaç`], correctIndex: 0, explanation: `Doğru cevap: Karşıtlık (beklenenin tersi)` },
...
[soru] "Paragraftan çıkarılması gereken cümle hangisidir?" → anlam akışını bozan, konu dışı cümle.`,
      ...
      quickQuestions: [
        ...
        { question: `Paragrafta düşünce akışını sağlayan, cümleler arası bağı kuran sözcüklere ne denir?`, options: [`Bağlayıcı sözcükler`, `Yansıma sözcükler`, `Pekiştirme sözcükler`, `İkilemeler`], correctIndex: 0, explanation: `Doğru cevap: Bağlayıcı (geçiş) sözcükler` },
        ...
        { question: `Paragrafta "anlatım biçimi" nedir?`, options: [`Konuyu sunma yolu`, `Paragrafın türü`, `Paragrafın başlığı`, `Paragrafın sözcük sayısı`], correctIndex: 0, explanation: `Doğru cevap: Konuyu sunma yolu (öyküleyici/betimleyici/açıklayıcı/tartışmacı)` },
        ...
        { question: `Bir paragrafta yazarın doğrudan söylemediği ama söylediklerinden mantıkla ulaşılabilen yargıya ne ad verilir?`, options: [`Çıkarım`, `Konu`, `Başlık`, `Yansıma`], correctIndex: 0, explanation: `Doğru cevap: Çıkarım (dolaylı anlam)` },
        { question: `Paragrafın "anlatıcı tipi" nedir?`, options: [`Olayın kim tarafından anlatıldığı`, `Olayın geçtiği yer`, `Olayın zamanı`, `Anlatım biçimi`], correctIndex: 0, explanation: `Doğru cevap: Olayın kim tarafından anlatıldığı (ben/o/biz)` },
        ...
        { question: `Bir paragrafın "konusu" ile "ana düşüncesi" arasındaki en önemli fark nedir?`, options: [`Konu genel bir öbektir; ana düşünce yazarın iletmek istediği yargıdır`, `Konu cümle, ana düşünce paragraftır`, `Konu yazarın adı, ana düşünce başlıktır`, `İkisi de aynı şeydir`], correctIndex: 0 },
        { question: `Paragraf tamamlama soruları, okuyucudan öncelikle hangi beceriyi ister?`, options: [`Düşüncenin sürekliliğini ve anlam akışını kavramak`, `Hızlı yazma`, `Yazım kurallarını ezberlemek`, `Sözcük sayısını saymak`], correctIndex: 0 },
        { question: `Bir paragrafta diğer cümlelerle anlam yönünden uyuşmayan, konudan kopuk olan cümleye ne ad verilir?`, options: [`Anlam akışını bozan cümle`, `Ana düşünce cümlesi`, `Konu cümlesi`, `Sonuç cümlesi`], correctIndex: 0 },
      ],
    },
    {
      id: "fiilimsiler",
...
[soru] "Cümledeki fiilimsinin türü nedir?" → eke bak: -arak/-ince → zarf-fiil, -an/-ecek → sıfat-fiil, -mak/-ma → isim-fiil.`,
      ...
      quickQuestions: [
        ...
        { question: `Fiilimsiler aşağıdaki seçeneklerin hangisini yapmazlar?`, options: [`Cümlede yüklem olamazlar`, `İsim, sıfat ya da zarf görevinde olabilirler`, `Yan cümlecik kurabilirler`, `Cümleyi birleşik yapabilirler`], correctIndex: 0, explanation: `Doğru cevap: Cümlede yüklem (çekimli fiil) olamazlar` },
        ...
        { question: `"Akmaz bir su gördüm." cümlesinde "akmaz" hangi fiilimsidir?`, options: [`Sıfat-fiil`, `Zarf-fiil`, `İsim-fiil`, `Çekimli fiil`], correctIndex: 0, explanation: `Doğru cevap: Sıfat-fiil (mez/maz)` },
        { question: `"Yıkılası bir köşk gördüm." cümlesinde "yıkılası" hangi fiilimsidir?`, options: [`Sıfat-fiil`, `İsim-fiil`, `Zarf-fiil`, `Çekimli fiil`], correctIndex: 0, explanation: `Doğru cevap: Sıfat-fiil (ası/esi)` },
        { question: `"Çalışırken telefonu çaldı." cümlesinde "çalışırken" hangi fiilimsidir?`, options: [`Zarf-fiil`, `İsim-fiil`, `Sıfat-fiil`, `Çekimli fiil`], correctIndex: 0, explanation: `Doğru cevap: Zarf-fiil (-ken)` },
        ...
        { question: `"Gelme!" cümlesinde "gel-me" ekinin görevi nedir?`, options: [`Olumsuzluk eki`, `İsim-fiil`, `Sıfat-fiil`, `Zarf-fiil`], correctIndex: 0, explanation: `Doğru cevap: Olumsuzluk eki (fiilimsi değil)` },
        ...
        { question: `"Düşünüp karar verdi." cümlesinde "düşünüp" hangi fiilimsidir?`, options: [`Zarf-fiil`, `İsim-fiil`, `Sıfat-fiil`, `Çekimli fiil`], correctIndex: 0, explanation: `Doğru cevap: Zarf-fiil (-ip)` },
        ...
        { question: `"Söylemiş olduğun sözleri unutmadım." cümlesinde "söylemiş" hangi fiilimsidir?`, options: [`Sıfat-fiil`, `İsim-fiil`, `Zarf-fiil`, `Çekimli fiil`], correctIndex: 0, explanation: `Doğru cevap: Sıfat-fiil (-miş)` },
        ...
        { question: `"Doğan güneş geceyi sona erdirir." cümlesinde "doğan" hangi fiilimsidir?`, options: [`Sıfat-fiil`, `İsim-fiil`, `Zarf-fiil`, `Çekimli fiil`], correctIndex: 0, explanation: `Doğru cevap: Sıfat-fiil (-an)` },
        ...
        { question: `"Sandalyede oturmakta olan adam babamdı." cümlesinde fiilimsi hangisidir?`, options: [`oturmakta`, `babamdı`, `sandalyede`, `adam`], correctIndex: 0, explanation: `Doğru cevap: oturmakta (olan)` },
...
[ipucu] Önce **yüklem** bulunur; sonra yükleme "Kim?", "Neyi?", "Nereye?", "Nasıl?" soruları sorularak diğer ögeler bulunur.`,
      ...
      quickQuestions: [
        ...
        { question: `Dolaylı tümleç, yükleme hangi sorular sorularak bulunur?`, options: [`-e/-de/-den hâl ekleri`, `Kimi/Neyi`, `Nasıl/Niçin`, `Kim/Ne`], correctIndex: 0, explanation: `Doğru cevap: -e/-de/-den hâl ekleri (Nereye, Nerede, Nereden, Kime, Kimde, Kimden)` },
        ...
        { question: `"Dün eve geç geldim." cümlesinde "dün" sözcüğünün görevi nedir?`, options: [`Zarf tümleci`, `Dolaylı tümleç`, `Nesne`, `Özne`], correctIndex: 0, explanation: `Doğru cevap: Zarf tümleci (zaman)` },
        ...
        { question: `"Dün eve geç geldim." cümlesinde "geç" sözcüğünün görevi nedir?`, options: [`Zarf tümleci`, `Dolaylı tümleç`, `Nesne`, `Özne`], correctIndex: 0, explanation: `Doğru cevap: Zarf tümleci (durum)` },
        { question: `"Yağmur yağıyor." cümlesinde özne nedir?`, options: [`Yağmur`, `yağıyor`, `(gizli)`, `Bilinmiyor`], correctIndex: 0 },
        { question: `"Çalışıyorum." cümlesinde özne nedir?`, options: [`Gizli özne`, `Çalışıyorum`, `Yoktur`, `Çalış`], correctIndex: 0, explanation: `Doğru cevap: Gizli özne (ben)` },
        ...
        { question: `"Akşam parkta yürüdüm." cümlesinde "akşam" hangi ögedir?`, options: [`Zarf tümleci`, `Dolaylı tümleç`, `Nesne`, `Özne`], correctIndex: 0, explanation: `Doğru cevap: Zarf tümleci (zaman)` },
        ...
        { question: `"Akşamleyin telefonla konuşur." cümlesinde "telefonla" hangi ögedir?`, options: [`Edat tümleci`, `Dolaylı tümleç`, `Nesne`, `Özne`], correctIndex: 0, explanation: `Doğru cevap: Edat tümleci (zarf tümleci)` },
...
[soru] "Aşağıdaki cümlenin çatısı nedir?" → önce fiil cümlesi mi bak, sonra özne (etken/edilgen) ve nesne (geçişli/geçişsiz) ilişkisine bak.`,
      ...
      quickQuestions: [
        { question: `Fiilde çatı kaç açıdan incelenir?`, options: [`İki`, `Bir`, `Üç`, `Dört`], correctIndex: 0, explanation: `Doğru cevap: İki (özne ve nesne)` },
        ...
        { question: `Dönüşlü çatı eki hangisidir?`, options: [`-n`, `-ar/-er`, `-i, -t`, `-mak/-mek`], correctIndex: 0, explanation: `Doğru cevap: -n (taran-, yıkan-, giyin-)` },
        ...
        { question: `Geçişli fiilden geçişsiz fiil yapan ek hangisidir?`, options: [`-l/-n`, `-t`, `-ar/-er`, `-mak/-mek`], correctIndex: 0, explanation: `Doğru cevap: -l/-n (edilgenlik eki)` },
        { question: `Geçişsiz bir fiili "geçişli" yapan ek hangisidir?`, options: [`-t, -tır, -dır`, `-l, -n`, `-mak`, `-an, -en`], correctIndex: 0, explanation: `Doğru cevap: -t, -tır, -dır (oldurganlık eki)` },
        { question: `"Uyumak" fiili "uyutmak" yapılarak hangi çatı kazanılır?`, options: [`Oldurgan`, `Edilgen`, `İşteş`, `Dönüşlü`], correctIndex: 0, explanation: `Doğru cevap: Oldurgan (geçişli)` },
        ...
        { question: `Aşağıdaki fiillerden hangisi dönüşlüdür?`, options: [`Taranmak`, `Yıkmak`, `Yazmak`, `Görmek`], correctIndex: 0, explanation: `Doğru cevap: Taranmak (kendini taradı)` },
        { question: `"Kapı çocuk tarafından açıldı." cümlesi çatısı bakımından nedir?`, options: [`Edilgen`, `Etken`, `Dönüşlü`, `İşteş`], correctIndex: 0, explanation: `Doğru cevap: Edilgen (eylemi yapan belli; ama özne sözdedir)` },
        ...
        { question: `Geçişli bir fiil edilgen yapıldığında nesne ne olur?`, options: [`Özne hâline gelir`, `Aynen nesne kalır`, `Yok olur`, `Zarfa dönüşür`], correctIndex: 0, explanation: `Doğru cevap: Özne (sözde özne) hâline gelir` },
        ...
        { question: `Edilgenlik eki "-n" hangi durumlarda kullanılır?`, options: [`Ünlü ile biten fiillerden sonra`, `Sadece ünsüzlerden sonra`, `Sadece çift heceli fiillerde`, `Sadece geniş zamanda`], correctIndex: 0, explanation: `Doğru cevap: Ünlü ile biten fiillerden sonra (oku-n-du, ye-n-di)` },
        { question: `"Okul açıldı." cümlesinin çatısı nedir?`, options: [`Edilgen`, `Etken`, `Dönüşlü`, `İşteş`], correctIndex: 0 },
        { question: `"Çocuk başını taradı." cümlesinin çatısı nedir?`, options: [`Etken`, `Dönüşlü`, `Edilgen`, `İşteş`], correctIndex: 0, explanation: `Doğru cevap: Etken (geçişli)` },
        { question: `"Çocuk tarandı." cümlesinin çatısı nedir?`, options: [`Dönüşlü`, `Edilgen`, `Etken`, `İşteş`], correctIndex: 0 },
        { question: `"Konuşmak" → "konuşturmak" değişimi hangi çatıyı verir?`, options: [`Ettirgen`, `Edilgen`, `İşteş`, `Dönüşlü`], correctIndex: 0, explanation: `Doğru cevap: Ettirgen (oldurgan)` },
...
[tuzak] **Yapım ekleri** kesme ile **ayrılmaz**: "Türk'çe" değil **"Türkçe"**; "Avrupa'lı" değil **"Avrupalı"**.`,
      ...
      quickQuestions: [
        ...
        { question: `"Hâlbuki, oysaki, sanki, mademki" sözcüklerinde "ki" nasıl yazılır?`, options: [`Bitişik`, `Ayrı`, `Tireli`, `Büyük harfle`], correctIndex: 0, explanation: `Doğru cevap: Bitişik (kalıplaşmıştır)` },
        ...
        { question: `Kurum-kuruluş adlarına gelen ekler nasıl yazılır?`, options: [`Bitişik, kesme kullanılmaz`, `Her zaman kesmeyle ayrılır`, `Her zaman tireyle ayrılır`, `Her zaman boşlukla ayrılır`], correctIndex: 0, explanation: `Doğru cevap: Bitişik, kesme kullanılmaz (TBMM'ye ama Türkiye Cumhuriyeti'ne gibi durumlar dışında)` },
        ...
        { question: `Aşağıdakilerden hangisinin yazımı doğrudur?`, options: [`pekiştirme`, `sapa-sağlam`, `mas mavi`, `sap sağlam`], correctIndex: 0, explanation: `Doğru cevap: pekiştirme (sapasağlam, masmavi)` },
        { question: `"Aşağıdakilerden hangisi" gibi bir soru cümlesinde özel ad geçtiğinde nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Doğru cevap: Büyük harfle (Türkiye, Atatürk)` },
        { question: `Cins isimleri (genel adlar) nasıl yazılır?`, options: [`Küçük harfle`, `Büyük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0 },
        { question: `Kişi adlarının önündeki unvanlar nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Doğru cevap: Büyük harfle (Doktor Ahmet, Albay Mehmet)` },
        ...
        { question: `Gezegen, yıldız ve takımyıldız adları nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Doğru cevap: Büyük harfle (Mars, Dünya, Güneş)` },
        { question: `Dil ve millet adları nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Doğru cevap: Büyük harfle (Türkçe, İngilizce, Türk, Alman)` },
        { question: `Gün ve ay adları cümle içinde nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Doğru cevap: Büyük harfle (Pazartesi, Ocak)` },
        { question: `Yön adları başka bir isimle birlikte özel ad oluşturursa nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Doğru cevap: Büyük harfle (Doğu Anadolu, Batı Karadeniz)` },
        { question: `Sadece yön bildiriyorsa nasıl yazılır?`, options: [`Küçük harfle`, `Büyük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Doğru cevap: Küçük harfle (rüzgâr doğudan esiyor)` },
        ...
        { question: `Sayıların yazımında özel kullanım: "5'inci sınıf" mı, "5 inci sınıf" mı doğru?`, options: [`5'inci sınıf`, `5 inci sınıf`, `5inci sınıf`, `5.inci sınıf`], correctIndex: 0, explanation: `Doğru cevap: 5'inci sınıf (sıra ek kesmeyle ayrılır)` },
        { question: `"Yirmi birinci yüzyıl" mı "yirmi-birinci yüzyıl" mı doğru?`, options: [`Yirmi birinci yüzyıl`, `Yirmi-birinci`, `Yirmibirinci`, `Yirmibıri`], correctIndex: 0, explanation: `Doğru cevap: Yirmi birinci yüzyıl (ayrı)` },
        ...
        { question: `"İkişer ikişer" ifadesi nasıl yazılır?`, options: [`Ayrı`, `Bitişik`, `Tireyle`, `Tek sözcük`], correctIndex: 0, explanation: `Doğru cevap: Ayrı (her ikileme ayrı)` },
        ...
        { question: `"Bay/Bayan" kısaltmaları kişi adıyla nasıl yazılır?`, options: [`Büyük harfle ve adın önünde`, `Küçük harfle`, `Tırnak içinde`, `Bitişik`], correctIndex: 0, explanation: `Doğru cevap: Büyük harfle ve adın önünde (Bay Ahmet)` },
      ],
    },
    {
...
[tuzak] **Yapım eklerini ayırmaz:** "Türk'çe" değil **"Türkçe"**; "Antalya'lı" değil **"Antalyalı"**. (LGS'nin en sık tuzağı!)`,
      ...
      quickQuestions: [
        ...
        { question: `Kısa çizgi (-) hangi durumda kullanılır?`, options: [`Satır sonu hece bölme ve birleşik isimlerde`, `Soru sormak`, `Konuşma aktarmak`, `Vurgu yapmak`], correctIndex: 0, explanation: `Doğru cevap: Satır sonu hece bölme ve birleşik isimlerde (Türk-İslam)` },
        { question: `Uzun çizgi (—) hangi durumda kullanılır?`, options: [`Konuşma çizgisi`, `Soru sormak`, `Vurgu yapmak`, `Hece bölmek`], correctIndex: 0, explanation: `Doğru cevap: Konuşma çizgisi (diyalog başlangıcı)` },
        ...
        { question: `"Acaba bugün ders olacak mı?" cümlesindeki soru işareti hangi sözcüğe bağlıdır?`, options: [`Mı`, `Acaba`, `Bugün`, `Ders`], correctIndex: 0, explanation: `Doğru cevap: Mı (soru eki)` },
        ...
        { question: `"Geç kaldım çünkü trafik vardı." cümlesinde noktalama doğru mu?`, options: [`Doğru`, `Yanlış, soru olmalı`, `Yanlış, ünlem olmalı`, `Yanlış, üç nokta olmalı`], correctIndex: 0, explanation: `Doğru cevap: Doğru (çünkü öncesi tercihen virgül de olabilir)` },
        { question: `Tırnak içine alınmış sözcükteki noktalama nereye konur?`, options: [`Tırnağın içine`, `Her zaman dışına`, `Hiç konmaz`, `Hem içine hem dışına`], correctIndex: 0, explanation: `Doğru cevap: Tırnağın içine (eğer aktarılan söz bir cümleyse)` },
        ...
        { question: `Eğer bir cümle hem soru hem ünlem anlamı taşıyorsa ne yapılır?`, options: [`Soru işaretinden sonra ünlem konur veya yalnız uygunsa`, `Sadece soru işareti`, `Sadece ünlem`, `Üç nokta`], correctIndex: 0, explanation: `Doğru cevap: Soru işaretinden sonra ünlem konur (?!) veya yalnız uygunsa` },
        { question: `Adres yazımında yer adları arasına ne konur?`, options: [`Virgül`, `Nokta`, `İki nokta`, `Tırnak`], correctIndex: 0, explanation: `Doğru cevap: Virgül (Çankaya, Ankara)` },
        ...
        { question: `"H.Ü." gibi kısaltmalarda nokta nereye konur?`, options: [`Her büyük harften sonra`, `Sadece sona`, `Sadece başa`, `Hiç kullanılmaz`], correctIndex: 0, explanation: `Doğru cevap: Her büyük harften sonra (H.Ü.)` },
        ...
        { question: `"Yağmur yağıyor, çocuklar oynayamıyor." cümlesinde virgül hangi göreve sahiptir?`, options: [`İki cümleyi birbirinden ayırır`, `Eş görevli ögeleri ayırır`, `Hitap belirler`, `Vurgu yapar`], correctIndex: 0, explanation: `Doğru cevap: İki cümleyi (yargıyı) birbirinden ayırır` },
...
[soru] "Aşağıdaki cümlelerin hangisinde anlatım bozukluğu vardır?" → gereksiz tekrar, yanlış sözcük, uyumsuzluk veya çelişki ara.`,
      ...
      quickQuestions: [
        ...
        { question: `"Aşağıya inmek" ifadesindeki anlatım bozukluğunun nedeni nedir?`, options: [`Anlamca çelişen/gereksiz sözcük`, `Tamlama hatası`, `Yüklem hatası`, `Noktalama hatası`], correctIndex: 0, explanation: `Doğru cevap: Anlamca çelişen/gereksiz sözcük (inmek zaten aşağıya doğrudur)` },
        ...
        { question: `"Çocuklar parkta koştu, oynadılar." cümlesinde nasıl bir bozukluk vardır?`, options: [`Yüklemde çoğul-tekil uyumsuzluğu`, `Tamlama hatası`, `Çatı uyumsuzluğu`, `Anlamca çelişme`], correctIndex: 0, explanation: `Doğru cevap: Yüklemde çoğul-tekil uyumsuzluğu (koştu/oynadılar farklı)` },
        ...
        { question: `"Tahminen 100 kişi vardı kesinlikle." cümlesinde nasıl bir bozukluk vardır?`, options: [`Anlamca çelişme`, `Tamlama hatası`, `Özne uyumsuzluğu`, `Yüklem hatası`], correctIndex: 0, explanation: `Doğru cevap: Anlamca çelişme (tahminen-kesinlikle birlikte)` },
        { question: `"Onun kitabını ve defteri kayboldu." cümlesindeki bozukluğun nedeni nedir?`, options: [`Tamlama yanlışlığı`, `Özne-yüklem`, `Anlamca çelişki`, `Gereksiz sözcük`], correctIndex: 0, explanation: `Doğru cevap: Tamlama yanlışlığı (her ikisi de "onun" tamlayanını almalı)` },
        ...
        { question: `"Bu film izlenir ve seyredilir." cümlesinde nasıl bir bozukluk vardır?`, options: [`Eş anlamlı sözcüklerin gereksiz kullanımı`, `Çelişki`, `Özne uyumsuzluğu`, `Tamlama hatası`], correctIndex: 0, explanation: `Doğru cevap: Eş anlamlı (anlamca aynı) sözcüklerin gereksiz kullanımı` },
        ...
        { question: `"Onun saçları ve gözleri kahverengiydi." cümlesinde yüklem uyumu nasıldır?`, options: [`Doğru`, `Yanlış, özne çoğul`, `Yanlış, gereksiz`, `Çelişki var`], correctIndex: 0, explanation: `Doğru cevap: Doğru (cansız nesneler tekilde de çoğulda da uyumlu)` },
        ...
        { question: `"Bana hiç soru sorma sakın." cümlesinde nasıl bir bozukluk vardır?`, options: [`Anlamı pekiştirici sözcüklerin birden çok kullanımı`, `Çelişki`, `Yüklem`, `Tamlama`], correctIndex: 0, explanation: `Doğru cevap: Anlamı pekiştirici sözcüklerin birden çok kullanımı (yanlış değil ama gereksiz)` },
        { question: `"Yarın akşam yedide yolculuğa çıkarken hava yağmurluydu." cümlesinde nasıl bir bozukluk vardır?`, options: [`Zaman uyumsuzluğu`, `Çelişki yok`, `Tamlama hatası`, `Özne uyumsuzluğu`], correctIndex: 0, explanation: `Doğru cevap: Zaman uyumsuzluğu (yarın - yağmurluydu)` },
        { question: `"Ona söylediğim şeyleri unuttum söylemeyi." cümlesinde nasıl bir bozukluk vardır?`, options: [`Sıralama/anlam karışıklığı`, `Tamlama hatası`, `Çelişki yok`, `Yüklem`], correctIndex: 0, explanation: `Doğru cevap: Sıralama/anlam karışıklığı (söylenen şeyi unutmak vs. söylemeyi unutmak)` },
        { question: `"İçeri girip kapıyı kapattı ve dışarı çıktı." cümlesinde nasıl bir bozukluk vardır?`, options: [`Mantık çelişkisi`, `Yok`, `Tamlama`, `Yüklem`], correctIndex: 0, explanation: `Doğru cevap: Mantık çelişkisi (içeri girip dışarı çıkıldı)` },
        { question: `"Hayatım boyu bu kadar mutlu olmadım." cümlesi anlamca doğru mu?`, options: [`Doğru`, `Yanlış, çelişki var`, `Yanlış, tamlama hatası`, `Yanlış, özne uyumsuz`], correctIndex: 0, explanation: `Doğru cevap: Doğru ("hayatım boyunca" daha yaygın)` },
        { question: `"Saat yedi-yedi buçuk gibi geldi." doğru mudur?`, options: [`Doğru`, `Yanlış, tire yanlış`, `Yanlış, çelişki`, `Yanlış, özne yok`], correctIndex: 0, explanation: `Doğru cevap: Doğru (yaklaşıklık ifadesi)` },
        { question: `"Annem ve baba pazara gittiler." cümlesinde bozukluk var mı?`, options: [`Var; "babam" olmalı ve yüklem uyumu sorgulanır`, `Yok`, `Çelişki`, `Yüklem hatası yok`], correctIndex: 0, explanation: `Doğru cevap: Var; "babam" olmalı (tamlayan eki eksik) ve yüklem uyumu sorgulanır` },
        ...
        { question: `"Ona hediye olarak armağan verdim." cümlesinde nasıl bir bozukluk vardır?`, options: [`Eş anlamlı sözcükler bir arada`, `Çelişki`, `Tamlama`, `Özne uyumsuzluğu`], correctIndex: 0, explanation: `Doğru cevap: Eş anlamlı sözcükler bir arada (hediye-armağan)` },
        ...
        { question: `"Burada başka birisi yok." cümlesinde bozukluk var mı?`, options: [`Yok`, `Çelişki var`, `Tamlama hatası`, `Yüklem hatası`], correctIndex: 0, explanation: `Doğru cevap: Yok ("başka biri" daha doğru olmakla birlikte yaygın)` },
        ...
        { question: `"Onun ödevlerini ben de yaptım." cümlesinde "de" bağlacı yerinde mi?`, options: [`Yerinde`, `Yanlış, bitişik olmalı`, `Çelişki`, `Gereksiz`], correctIndex: 0, explanation: `Doğru cevap: Yerinde (ben de = "ben dahi" anlamı verir)` },
        { question: `"Sokağa çıkıp dolaştık ama yine eve geri döndük." cümlesinde nasıl bir bozukluk vardır?`, options: [`Gereksiz sözcük`, `Çelişki`, `Tamlama`, `Yüklem`], correctIndex: 0, explanation: `Doğru cevap: Gereksiz sözcük ("geri" dönmek anlam karışıklığı yaratır)` },
        { question: `"Eve yaklaşık olarak tam 5 dakikada vardım." cümlesindeki anlatım bozukluğunun nedeni nedir?`, options: [`Birbiriyle çelişen sözcüklerin bir arada kullanılması`, `Yüklem eksikliği`, `Tamlama yanlışlığı`, `Noktalama yanlışı`], correctIndex: 0, explanation: `Doğru cevap: Birbiriyle çelişen sözcüklerin bir arada kullanılması ("yaklaşık" + "tam")` },
        { question: `"Pencereden dışarı baktım." cümlesinde bozukluk var mı?`, options: [`Yok`, `Çelişki`, `Tamlama`, `Yüklem`], correctIndex: 0, explanation: `Doğru cevap: Yok ("dışarı" pekiştirici olarak yaygın)` },
