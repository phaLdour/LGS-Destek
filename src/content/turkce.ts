...
[soru] "Aşağıdakilerden hangisi soyut anlamlıdır?" sorularında algılanamayan kavramı ara.`,
      ...
      quickQuestions: [
        ...
        { question: `"Ayağa kalktı." cümlesindeki "ayak" sözcüğü hangi anlamda kullanılmıştır?`, options: [`Gerçek anlam`, `Mecaz`, `Terim`, `Yansıma`], correctIndex: 0, explanation: `Gerçek anlam (vücudun ayağı)` },
      ],
    },
    {
      id: "cumlede-anlam",
...
[soru] Cümlede "daha/en/göre" varsa karşılaştırma; "belki/galiba" varsa olasılık aranır.`,
      ...
      quickQuestions: [
        ...
        { question: `"Yağmur yağıyordu, yine de dışarı çıktık." cümlesinde hangi anlam vardır?`, options: [`Beklenmeyen durum`, `Sebep`, `Şart`, `Amaç`], correctIndex: 0 },
...
[soru] "Paragraftan çıkarılması gereken cümle hangisidir?" → anlam akışını bozan, konu dışı cümle.`,
      ...
      quickQuestions: [
        ...
        { question: `Paragrafın "anlatıcı tipi" nedir?`, options: [`Olayın kim tarafından anlatıldığı`, `Olayın geçtiği yer`, `Olayın zamanı`, `Anlatım biçimi`], correctIndex: 0 },
...
[soru] "Cümledeki fiilimsinin türü nedir?" → eke bak: -arak/-ince → zarf-fiil, -an/-ecek → sıfat-fiil, -mak/-ma → isim-fiil.`,
      ...
      quickQuestions: [
        ...
        { question: `"Gelme!" cümlesinde "gel-me" ekinin görevi nedir?`, options: [`Olumsuzluk eki`, `İsim-fiil`, `Sıfat-fiil`, `Zarf-fiil`], correctIndex: 0, explanation: `Olumsuzluk eki (fiilimsi değil)` },
...
[ipucu] Önce **yüklem** bulunur; sonra yükleme "Kim?", "Neyi?", "Nereye?", "Nasıl?" soruları sorularak diğer ögeler bulunur.`,
      ...
      quickQuestions: [
        ...
        { question: `Dolaylı tümleç, yükleme hangi sorular sorularak bulunur?`, options: [`-e/-de/-den hâl ekleri`, `Kimi/Neyi`, `Nasıl/Niçin`, `Kim/Ne`], correctIndex: 0, explanation: `-e/-de/-den hâl ekleri (Nereye, Nerede, Nereden, Kime, Kimde, Kimden)` },
...
[soru] "Aşağıdaki cümlenin çatısı nedir?" → önce fiil cümlesi mi bak, sonra özne (etken/edilgen) ve nesne (geçişli/geçişsiz) ilişkisine bak.`,
      ...
      quickQuestions: [
        ...
        { question: `Geçişsiz bir fiili "geçişli" yapan ek hangisidir?`, options: [`-t, -tır, -dır`, `-l, -n`, `-mak`, `-an, -en`], correctIndex: 0, explanation: `-t, -tır, -dır (oldurganlık eki)` },
        ...
        { question: `Aşağıdaki fiillerden hangisi dönüşlüdür?`, options: [`Taranmak`, `Yıkmak`, `Yazmak`, `Görmek`], correctIndex: 0, explanation: `Taranmak (kendini taradı)` },
...
[tuzak] **Yapım ekleri** kesme ile **ayrılmaz**: "Türk'çe" değil **"Türkçe"**; "Avrupa'lı" değil **"Avrupalı"**.`,
      ...
      quickQuestions: [
        ...
        { question: `"Yirmi birinci yüzyıl" mı "yirmi-birinci yüzyıl" mı doğru?`, options: [`Yirmi birinci yüzyıl`, `Yirmi-birinci`, `Yirmibirinci`, `Yirmibıri`], correctIndex: 0 },
        ...
        { question: `"Bay/Bayan" kısaltmaları kişi adıyla nasıl yazılır?`, options: [`Büyük harfle ve adın önünde`, `Küçük harfle`, `Tırnak içinde`, `Bitişik`], correctIndex: 0 },
      ],
    },
    {
...
[tuzak] **Yapım eklerini ayırmaz:** "Türk'çe" değil **"Türkçe"**; "Antalya'lı" değil **"Antalyalı"**. (LGS'nin en sık tuzağı!)`,
      ...
      quickQuestions: [
        ...
        { question: `Kısa çizgi (-) hangi durumda kullanılır?`, options: [`Satır sonu hece bölme ve birleşik isimlerde`, `Soru sormak`, `Konuşma aktarmak`, `Vurgu yapmak`], correctIndex: 0 },
        { question: `Uzun çizgi (—) hangi durumda kullanılır?`, options: [`Konuşma çizgisi`, `Soru sormak`, `Vurgu yapmak`, `Hece bölmek`], correctIndex: 0, explanation: `Konuşma çizgisi (diyalog başlangıcı)` },
        ...
        { question: `"H.Ü." gibi kısaltmalarda nokta nereye konur?`, options: [`Her büyük harften sonra`, `Sadece sona`, `Sadece başa`, `Hiç kullanılmaz`], correctIndex: 0 },
...
[soru] "Aşağıdaki cümlelerin hangisinde anlatım bozukluğu vardır?" → gereksiz tekrar, yanlış sözcük, uyumsuzluk veya çelişki ara.`,
      ...
      quickQuestions: [
        ...
        { question: `"Aşağıya inmek" ifadesindeki anlatım bozukluğunun nedeni nedir?`, options: [`Anlamca çelişen/gereksiz sözcük`, `Tamlama hatası`, `Yüklem hatası`, `Noktalama hatası`], correctIndex: 0, explanation: `Anlamca çelişen/gereksiz sözcük (inmek zaten aşağıya doğrudur)` },
        ...
        { question: `"Çocuklar parkta koştu, oynadılar." cümlesinde nasıl bir bozukluk vardır?`, options: [`Yüklemde çoğul-tekil uyumsuzluğu`, `Tamlama hatası`, `Çatı uyumsuzluğu`, `Anlamca çelişme`], correctIndex: 0, explanation: `Yüklemde çoğul-tekil uyumsuzluğu (koştu/oynadılar farklı)` },
        ...
        { question: `"Bu film izlenir ve seyredilir." cümlesinde nasıl bir bozukluk vardır?`, options: [`Eş anlamlı sözcüklerin gereksiz kullanımı`, `Çelişki`, `Özne uyumsuzluğu`, `Tamlama hatası`], correctIndex: 0, explanation: `Eş anlamlı (anlamca aynı) sözcüklerin gereksiz kullanımı` },
        ...
        { question: `"Bana hiç soru sorma sakın." cümlesinde nasıl bir bozukluk vardır?`, options: [`Anlamı pekiştirici sözcüklerin birden çok kullanımı`, `Çelişki`, `Yüklem`, `Tamlama`], correctIndex: 0, explanation: `Anlamı pekiştirici sözcüklerin birden çok kullanımı (yanlış değil ama gereksiz)` },
        ...
        { question: `"Ona söylediğim şeyleri unuttum söylemeyi." cümlesinde nasıl bir bozukluk vardır?`, options: [`Sıralama/anlam karışıklığı`, `Tamlama hatası`, `Çelişki yok`, `Yüklem`], correctIndex: 0, explanation: `Sıralama/anlam karışıklığı (söylenen şeyi unutmak vs. söylemeyi unutmak)` },
        { question: `"İçeri girip kapıyı kapattı ve dışarı çıktı." cümlesinde nasıl bir bozukluk vardır?`, options: [`Mantık çelişkisi`, `Yok`, `Tamlama`, `Yüklem`], correctIndex: 0, explanation: `Mantık çelişkisi (içeri girip dışarı çıkıldı)` },
        ...
        { question: `"Annem ve baba pazara gittiler." cümlesinde bozukluk var mı?`, options: [`Var; "babam" olmalı ve yüklem uyumu sorgulanır`, `Yok`, `Çelişki`, `Yüklem hatası yok`], correctIndex: 0, explanation: `Var; "babam" olmalı (tamlayan eki eksik) ve yüklem uyumu sorgulanır` },
        ...
        { question: `"Ona hediye olarak armağan verdim." cümlesinde nasıl bir bozukluk vardır?`, options: [`Eş anlamlı sözcükler bir arada`, `Çelişki`, `Tamlama`, `Özne uyumsuzluğu`], correctIndex: 0, explanation: `Eş anlamlı sözcükler bir arada (hediye-armağan)` },
        ...
        { question: `"Sokağa çıkıp dolaştık ama yine eve geri döndük." cümlesinde nasıl bir bozukluk vardır?`, options: [`Gereksiz sözcük`, `Çelişki`, `Tamlama`, `Yüklem`], correctIndex: 0, explanation: `Gereksiz sözcük ("geri" dönmek anlam karışıklığı yaratır)` },
        { question: `"Eve yaklaşık olarak tam 5 dakikada vardım." cümlesindeki anlatım bozukluğunun nedeni nedir?`, options: [`Birbiriyle çelişen sözcüklerin bir arada kullanılması`, `Yüklem eksikliği`, `Tamlama yanlışlığı`, `Noktalama yanlışı`], correctIndex: 0, explanation: `Birbiriyle çelişen sözcüklerin bir arada kullanılması ("yaklaşık" + "tam")` },
