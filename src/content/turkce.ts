...
[soru] "Paragraftan çıkarılması gereken cümle hangisidir?" → anlam akışını bozan, konu dışı cümle.`,
      ...
      quickQuestions: [
        ...
        { question: `Bir paragrafta yazarın doğrudan söylemediği ama söylediklerinden mantıkla ulaşılabilen yargıya ne ad verilir?`, options: [`Çıkarım (dolaylı anlam)`, `Konu`, `Başlık`, `Yansıma`], correctIndex: 0 },
...
[soru] "Aşağıdaki cümlenin çatısı nedir?" → önce fiil cümlesi mi bak, sonra özne (etken/edilgen) ve nesne (geçişli/geçişsiz) ilişkisine bak.`,
      ...
      quickQuestions: [
        ...
        { question: `Dönüşlü çatı eki hangisidir?`, options: [`-n (taran-, yıkan-, giyin-)`, `-ar/-er`, `-i, -t`, `-mak/-mek`], correctIndex: 0 },
        ...
        { question: `"Uyumak" fiili "uyutmak" yapılarak hangi çatı kazanılır?`, options: [`Oldurgan (geçişli)`, `Edilgen`, `İşteş`, `Dönüşlü`], correctIndex: 0 },
        ...
        { question: `Edilgenlik eki "-n" hangi durumlarda kullanılır?`, options: [`Ünlü ile biten fiillerden sonra (oku-n-du, ye-n-di)`, `Sadece ünsüzlerden sonra`, `Sadece çift heceli fiillerde`, `Sadece geniş zamanda`], correctIndex: 0 },
...
[tuzak] **Yapım eklerini ayırmaz:** "Türk'çe" değil **"Türkçe"**; "Antalya'lı" değil **"Antalyalı"**. (LGS'nin en sık tuzağı!)`,
      ...
      quickQuestions: [
        ...
        { question: `Kısa çizgi (-) hangi durumda kullanılır?`, options: [`Satır sonu hece bölme ve birleşik isimlerde (Türk-İslam)`, `Soru sormak`, `Konuşma aktarmak`, `Vurgu yapmak`], correctIndex: 0 },
...
[soru] "Aşağıdaki cümlelerin hangisinde anlatım bozukluğu vardır?" → gereksiz tekrar, yanlış sözcük, uyumsuzluk veya çelişki ara.`,
      ...
      quickQuestions: [
        ...
        { question: `"Çocuklar parkta koştu, oynadılar." cümlesinde nasıl bir bozukluk vardır?`, options: [`Yüklemde çoğul-tekil uyumsuzluğu (koştu/oynadılar farklı)`, `Tamlama hatası`, `Çatı uyumsuzluğu`, `Anlamca çelişme`], correctIndex: 0 },
        ...
        { question: `"Eve yaklaşık olarak tam 5 dakikada vardım." cümlesindeki anlatım bozukluğunun nedeni nedir?`, options: [`Birbiriyle çelişen sözcüklerin bir arada kullanılması ("yaklaşık" + "tam")`, `Yüklem eksikliği`, `Tamlama yanlışlığı`, `Noktalama yanlışı`], correctIndex: 0 },
