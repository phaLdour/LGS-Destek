...
[soru] "Aşağıdakilerden hangisi soyut anlamlıdır?" sorularında algılanamayan kavramı ara.`,
      ...
      quickQuestions: [
        { question: `"Yüz" sözcüğü hangisinde sayı anlamında kullanılmıştır?`, options: [`Sınıfta yüz öğrenci var.`, `Yüzünü sabunla yıkadı.`, `Havuzda hızlı hızlı yüz!`, `Yüzü çok güzel gülüyor.`], correctIndex: 0 },
        ...
        { question: `"Soğuk" sözcüğü hangisinde mecaz anlamdadır?`, options: [`Bana çok soğuk davrandı.`, `Testiden soğuk su içtim.`, `Hava bu sabah çok soğuk.`, `Soğuk demir dövülmez.`], correctIndex: 0 },
        ...
        { question: `Aşağıdakilerden hangisi atasözüdür?`, options: [`Damlaya damlaya göl olur`, `Burnundan kıl aldırmamak`, `Ağzı kulaklarına varmak`, `Ağzından baklayı çıkarmak`], correctIndex: 0 },
        ...
        { question: `"Damdan düşer gibi" deyimi ne anlama gelir?`, options: [`Sözü birdenbire söylemek`, `Sözü uzatarak anlatmak`, `Konuyu dolaylı anlatmak`, `Yüksekten atıp tutmak`], correctIndex: 0 },
        { question: `"Ağzı kulaklarına varmak" deyimi ne anlama gelir?`, options: [`Çok sevinmek`, `Bağırmak`, `Şaşırmak`, `Konuşmamak`], correctIndex: 0 },
        { question: `"Sakla samanı gelir zamanı" atasözünün anlamı nedir?`, options: [`Bugün gereksiz olan yarın gerekir`, `Zamanı gelmeyen hiçbir iş yapılmaz`, `Biriktirmek insanı cimri yapar`, `Eskiyen eşyalar atılmalıdır`], correctIndex: 0 },
        { question: `"Bir elin nesi var, iki elin sesi var" atasözü neyi anlatır?`, options: [`Birlik ve dayanışmayı`, `Tek başına çalışmayı`, `Sessiz kalmanın gücünü`, `Az konuşup çok dinlemeyi`], correctIndex: 0 },
        ...
        { question: `Aşağıdakilerden hangisi terim anlamlıdır?`, options: [`Açı (matematik terimi)`, `Açık (kapalı olmayan)`, `Açmak (kapıyı açmak)`, `Açık renk (soluk ton)`], correctIndex: 0 },
        ...
        { question: `"Sapasağlam" sözcüğü hangi yolla türetilmiştir?`, options: [`Pekiştirme yoluyla`, `İkileme yoluyla`, `Yansıma yoluyla`, `Yapım ekiyle türetme`], correctIndex: 0 },
        ...
        { question: `"Kırmak" sözcüğü hangisinde mecaz anlamdadır?`, options: [`Çocuğun kalbini kırdı.`, `Tahtayı dizinde kırdı.`, `Kuru dalları kırdı.`, `Tabakları düşürüp kırdı.`], correctIndex: 0 },
        ...
        { question: `"Çıkmak" sözcüğü hangisinde mecaz anlamdadır?`, options: [`Sınavdan iyi çıktı.`, `Evden erken çıktı.`, `Yokuşu koşarak çıktı.`, `Merdivenleri çıktı.`], correctIndex: 0 },
        { question: `Aşağıdakilerden hangisinde sözcükler eş seslidir?`, options: [`Bin (sayı) – bin (binmek)`, `Sene – yıl (eş anlamlılık)`, `Uzun – kısa (zıt anlamlılık)`, `Kalp – yürek (eş anlamlılık)`], correctIndex: 0 },
        { question: `"Gül - gül" sözcükleri arasındaki ilişki nedir?`, options: [`Sesteş`, `Eş anlamlı`, `Zıt anlamlı`, `Yakın anlamlı`], correctIndex: 0 },
        { question: `"Kara" sözcüğü hangisinde mecaz anlamdadır?`, options: [`Kara haber çabuk yayılır.`, `Kara çamura battı ayakkabım.`, `Karadeniz kıyısına gittik.`, `Kara kalemle resim çizdim.`], correctIndex: 0 },
        { question: `"Gözden düşmek" deyimi ne anlama gelir?`, options: [`Saygınlığını yitirmek`, `Gözlerini yumup uyumak`, `Dikkatten kaçmak`, `Üzüntüden ağlamak`], correctIndex: 0 },
        { question: `"Burnu büyümek" deyimi ne anlama gelir?`, options: [`Kibirlenmek`, `Hastalanmak`, `Üzülmek`, `Korkmak`], correctIndex: 0 },
        { question: `"Pireyi deve yapmak" deyimi ne anlama gelir?`, options: [`Küçük şeyi büyütmek`, `Hayvanlara acımak`, `Büyük işi küçümsemek`, `Boş yere yorulmak`], correctIndex: 0 },
        { question: `"Damlaya damlaya göl olur" atasözünün anlamı nedir?`, options: [`Azar azar biriken çoğalır`, `Yağmurlar göl oluşturur`, `Küçük damlalar önemsizdir`, `Su israf edilmemelidir`], correctIndex: 0 },
        { question: `"Tatlı dil yılanı deliğinden çıkarır" atasözü neyi anlatır?`, options: [`Güzel sözün etkisini`, `Yılanların korkusunu`, `Tatlı yemenin zararını`, `Sert konuşmanın gücünü`], correctIndex: 0 },
        { question: `"Akıllı düşman akılsız dosttan iyidir" atasözünün anlamı nedir?`, options: [`Akılsız dostun zararı büyüktür`, `Düşmanla dost olmak gerekir`, `Dostluk her şeyden daha önemlidir`, `Akıllı insan dost edinmemeli`], correctIndex: 0 },
        ...
        { question: `"Tatlı bir çocuk." cümlesindeki "tatlı" sözcüğü hangi anlamda kullanılmıştır?`, options: [`Mecaz anlam (sevimli)`, `Temel anlam (şekerli)`, `Terim anlam (bilimsel)`, `Yansıma sözcük (ses)`], correctIndex: 0 },
        { question: `"Ayağa kalktı." cümlesindeki "ayak" sözcüğü hangi anlamda kullanılmıştır?`, options: [`Gerçek (temel) anlam`, `Mecaz anlam (aktarma)`, `Terim anlam (bilimsel)`, `Yansıma söz (ses taklidi)`], correctIndex: 0, explanation: `Gerçek anlam (vücudun ayağı)` },
      ],
    },
    {
      id: "cumlede-anlam",
...
[soru] Cümlede "daha/en/göre" varsa karşılaştırma; "belki/galiba" varsa olasılık aranır.`,
      ...
      quickQuestions: [
        ...
        { question: `"Çalışırsan başarırsın." cümlesinde hangi anlam vardır?`, options: [`Koşul`, `Sebep-sonuç`, `Amaç`, `Karşılaştırma`], correctIndex: 0 },
        { question: `"Yağmur yağdığı için maç iptal edildi." cümlesinde hangi anlam vardır?`, options: [`Sebep-sonuç ilişkisi`, `Koşula bağlılık`, `Amaç ve istek ilişkisi`, `Olasılık bildirme`], correctIndex: 0 },
        ...
        { question: `"Senin kadar uzun değilim." cümlesinde hangi anlam vardır?`, options: [`Karşılaştırma`, `Koşul (şart)`, `Neden-sonuç`, `Amaç-istek`], correctIndex: 0 },
        ...
        { question: `"Keşke daha çok çalışsaydım." cümlesinde hangi anlam vardır?`, options: [`Pişmanlık duyma`, `Sevinç duyma`, `Beğeni belirtme`, `Uyarıda bulunma`], correctIndex: 0 },
        ...
        { question: `"Bu kitap çok sıkıcıydı." cümlesinde hangi anlam vardır?`, options: [`Yakınma`, `Beğeni`, `Şart`, `Uyarı`], correctIndex: 0 },
        ...
        { question: `"Sen de gelseydin keşke." cümlesinde hangi duygu hâkimdir?`, options: [`Pişmanlık ve özlem`, `Uyarı ve tehdit`, `Beğeni ve övgü`, `Eleştiri ve alay`], correctIndex: 0 },
        ...
        { question: `"Çiçekler bana selam veriyor." cümlesinde hangi söz sanatı vardır?`, options: [`Kişileştirme`, `Benzetme (teşbih)`, `Abartma (mübalağa)`, `Konuşturma (intak)`], correctIndex: 0 },
        ...
        { question: `"Yağmur yağıyordu, yine de dışarı çıktık." cümlesinde hangi anlam vardır?`, options: [`Beklenmeyen durum`, `Neden-sonuç ilişkisi`, `Koşul-şart ilişkisi`, `Amaç-sonuç ilişkisi`], correctIndex: 0 },
        { question: `"Çok çalışmasına rağmen sınavda başarısız oldu." cümlesinde hangi anlam vardır?`, options: [`Karşıtlık`, `Sebep-sonuç`, `Şart`, `Amaç`], correctIndex: 0, explanation: `Karşıtlık (beklenenin tersi)` },
        { question: `"Sözüm ona benim için geldi." cümlesindeki "sözüm ona" ne anlam katar?`, options: [`Kuşku ve inanmama`, `Kesinlik ve inanç`, `Beğeni ve övgü`, `Pişmanlık ve üzüntü`], correctIndex: 0 },
        ...
        { question: `"Henüz işini bitirmedi." cümlesindeki "henüz" sözcüğü ne anlam katar?`, options: [`Şimdiye kadar olmama`, `Şu anda olup bitme`, `Yakında olacak olma`, `Hiçbir zaman olmayacak`], correctIndex: 0 },
        { question: `"Galiba kapı çalıyor." cümlesinde hangi anlam vardır?`, options: [`Olasılık ve tahmin`, `Kesinlik ve inanç`, `Koşula bağlama`, `Beğeni bildirme`], correctIndex: 0 },
        { question: `"Mutlaka derslerine çalışmalısın." cümlesinde hangi anlam vardır?`, options: [`Gereklilik, kesinlik`, `Olasılık ve tahmin`, `Koşul ve şart`, `Karşılaştırma yapma`], correctIndex: 0 },
        { question: `"Daha güzel bir kitap okumadım." cümlesinde hangi anlam vardır?`, options: [`Üstünlük bildirme`, `Koşula bağlama`, `Olasılık bildirme`, `Pişmanlık bildirme`], correctIndex: 0 },
        ...
        { question: `"Bu kitabı çocuk bile anlayabilir." cümlesinde hangi anlam vardır?`, options: [`Kolaylık vurgusu`, `Beğeni vurgusu`, `Koşul vurgusu`, `Olasılık vurgusu`], correctIndex: 0 },
        { question: `"Onun saçları ipek gibi yumuşaktı." cümlesinde hangi söz sanatı vardır?`, options: [`Benzetme`, `Abartma`, `Karşıtlık`, `Kişileştirme`], correctIndex: 0 },
        ...
        { question: `"Onun gibi çalışkanı görmedim." cümlesinde hangi anlam vardır?`, options: [`Üstünlük belirtme`, `Olasılık belirtme`, `Koşul belirtme`, `Pişmanlık belirtme`], correctIndex: 0 },
...
[soru] "Paragraftan çıkarılması gereken cümle hangisidir?" → anlam akışını bozan, konu dışı cümle.`,
      ...
      quickQuestions: [
        ...
        { question: `Bir düşünceyi somutlaştırmak için ölçü, oran, istatistik vermeye ne denir?`, options: [`Sayısal verilerden yararlanma`, `Örneklerle somutlaştırma`, `Tanık göstererek destekleme`, `Karşılaştırma yaparak anlatma`], correctIndex: 0 },
        ...
        { question: `Paragrafın giriş cümlesi için aşağıdakilerden hangisi söylenebilir?`, options: [`Konuyu tanıtır, ilgi çeker`, `Konuyu özetleyip bitirir`, `Konuyu örneklerle açar`, `Karşı görüşü tartışır`], correctIndex: 0 },
        { question: `Bir paragrafta gelişme bölümünün işlevi nedir?`, options: [`Konuyu örneklerle geliştirmek`, `Konuyu özetleyip bitirmek`, `Okuru konuya hazırlamak`, `Yalnızca konu başlığı belirlemek`], correctIndex: 0 },
        { question: `Paragrafın sonuç bölümünün işlevi nedir?`, options: [`Konuyu özetleyip bağlamak`, `Konuya yeni örnek katmak`, `Yeni bir konuya geçmek`, `Karşıt görüş öne sürmek`], correctIndex: 0 },
        ...
        { question: `Paragrafın akışını bozan cümleyi anlamak için ne yapmalıyız?`, options: [`Konudan kopan cümleyi bulmalıyız`, `En uzun olan cümleyi seçmeliyiz`, `Paragrafın ilk cümlesini almalıyız`, `Soru biçimli cümleyi seçmeliyiz`], correctIndex: 0 },
        { question: `"Bu paragrafın başına nasıl bir cümle getirilebilir?" sorusu için en uygun cümle hangisidir?`, options: [`Sonrasıyla bağlantılı bir giriş cümlesi`, `Konuyu özetleyip bitiren bir sonuç cümlesi`, `Paragraftan tümüyle kopuk bir cümle`, `Yanıtı verilmeyen bir soru cümlesi`], correctIndex: 0 },
        ...
        { question: `Bir paragrafın türü "anı" ise hangisini içerir?`, options: [`Yazarın yaşadığı geçmiş olaylar`, `Deney ve gözlem verileri`, `Karşıt görüşlerin tartışması`, `Kavramların tanımlanması`], correctIndex: 0 },
        { question: `Bir paragrafın türü "deneme" ise temel özelliği nedir?`, options: [`Kanıtlama kaygısı olmadan düşünce sunması`, `Savunduğu görüşü kanıtlarla ispatlaması`, `Yaşanmış bir olayı zaman sırasıyla anlatması`, `Bir manzarayı ayrıntılı betimlemesi`], correctIndex: 0 },
        { question: `Aşağıdakilerden hangisi paragrafın yardımcı düşüncesidir?`, options: [`Ana düşünceyi destekleyen fikir`, `Paragrafta sözü edilen genel konu`, `Paragrafa verilecek başlık`, `Paragrafın yazınsal türü`], correctIndex: 0 },
        { question: `Paragrafta "okuyucuya verilmek istenen mesaj" hangisidir?`, options: [`Ana düşünce`, `Paragrafın konusu`, `Anlatıcının bakışı`, `Anlatılan olay`], correctIndex: 0 },
        { question: `Paragrafta düşünce akışını sağlayan, cümleler arası bağı kuran sözcüklere ne denir?`, options: [`Bağlayıcı sözcükler`, `Yansıma sözcükler`, `Pekiştirme sözcükler`, `İkilemeler`], correctIndex: 0 },
        { question: `"Çünkü, fakat, ancak, oysa" gibi sözcükler paragrafta hangi göreve sahiptir?`, options: [`Cümleler arasında anlam bağı kurar`, `Cümlelere soru ve ünlem anlamı katar`, `Paragrafın başlığını oluşturur`, `Paragrafın konusunu belirler`], correctIndex: 0 },
        { question: `Paragrafın konusu ve ana düşüncesi arasındaki temel fark nedir?`, options: [`Konu sözü edilen şey, ana düşünce mesajdır`, `İkisi de tümüyle aynı şeydir`, `Konu bir cümle, ana düşünce başlıktır`, `Konu son cümle, ana düşünce ilk cümledir`], correctIndex: 0 },
        { question: `Paragrafta "anlatım biçimi" nedir?`, options: [`Konuyu sunma yolu`, `Paragrafın türü`, `Paragrafın başlığı`, `Paragrafın sözcük sayısı`], correctIndex: 0, explanation: `Konuyu sunma yolu (öyküleyici/betimleyici/açıklayıcı/tartışmacı)` },
        ...
        { question: `"İnsanların %80'i günde en az 1 saat sosyal medya kullanıyor." ifadesi hangi düşünceyi geliştirme yoludur?`, options: [`Sayısal verilerden yararlanma`, `Örneklerle somutlaştırma`, `Uzman tanık göstererek destekleme`, `Benzetmeden yararlanma`], correctIndex: 0 },
        ...
        { question: `Paragrafın akışına uygun, ondan koparılmış bir cümle nasıl yerleştirilir?`, options: [`Bağlayıcı ve gönderim ipuçlarıyla`, `Her durumda en başa yerleştirilerek`, `Her durumda son sıraya konularak`, `Cümlelerin uzunluğuna bakılarak`], correctIndex: 0 },
        { question: `Paragrafta ikiye bölündüğünde "ilk bölümün son cümlesi" genellikle ne işlevdedir?`, options: [`İlk konuyu bitirip yenisine geçer`, `Paragrafa yeni bir konu başlığı koyar`, `Okura yanıtı olmayan soru sorar`, `Bilinmeyen kavramı tanımlar`], correctIndex: 0 },
        { question: `Bir paragrafta yazarın doğrudan söylemediği ama söylediklerinden mantıkla ulaşılabilen yargıya ne ad verilir?`, options: [`Çıkarım`, `Konu`, `Başlık`, `Yansıma`], correctIndex: 0, explanation: `Çıkarım (dolaylı anlam)` },
        { question: `Paragrafın "anlatıcı tipi" nedir?`, options: [`Olayı kimin anlattığı`, `Olayın geçtiği mekân`, `Olayın geçtiği zaman`, `Kullanılan anlatım türü`], correctIndex: 0 },
        { question: `Paragrafta "I. tekil kişi (ben)" anlatım hangi türde sık görülür?`, options: [`Anı, günlük, otobiyografi`, `Bilimsel makale ve tez`, `Ansiklopedi maddeleri`, `Sözlük ve kılavuzlar`], correctIndex: 0 },
        ...
        { question: `Bir paragrafın "konusu" ile "ana düşüncesi" arasındaki en önemli fark nedir?`, options: [`Konu genel öbek, ana düşünce yargıdır`, `Konu cümle, ana düşünce paragraftır`, `Konu yazarın adı, ana düşünce başlıktır`, `İkisi de birbirinin aynısıdır`], correctIndex: 0 },
        { question: `Paragraf tamamlama soruları, okuyucudan öncelikle hangi beceriyi ister?`, options: [`Anlam akışını ve sürekliliği görmek`, `Metni olabildiğince hızlı okuyup geçmek`, `Yazım kurallarını ezbere bilmek`, `Cümlelerdeki sözcükleri saymak`], correctIndex: 0 },
        { question: `Bir paragrafta diğer cümlelerle anlam yönünden uyuşmayan, konudan kopuk olan cümleye ne ad verilir?`, options: [`Anlam akışını bozan cümle`, `Ana düşünceyi veren cümle`, `Konuyu tanıtan cümle`, `Sonucu bildiren cümle`], correctIndex: 0 },
      ],
    },
    {
      id: "fiilimsiler",
        ...
        branches: [
          ...
          },
          {
            ...
            sections: [
              ...
              { kind: "ornek", title: `-r / -maz`, content: `Çalar saat (çal-ar), görünmez kaza (gör-ün-mez), akmaz su (ak-maz), bilmem ne (bil-me-m). Not: "keser, tükenmez kalem" gibi bazıları zamanla kalıcı isim olmuştur.` },
            ],
          },
          {
            label: `Zarf-Fiil`,
...
[soru] "Cümledeki fiilimsinin türü nedir?" → eke bak: -arak/-ince → zarf-fiil, -an/-ecek → sıfat-fiil, -mak/-ma → isim-fiil.`,
      ...
      quickQuestions: [
        ...
        { question: `İsim-fiil ekleri hangileridir?`, options: [`-mak/-mek, -ma/-me, -ış/-iş`, `-an/-en, -dik/-dık, -ası/-esi`, `-ip, -erek, -ince, -ken`, `-acak/-ecek, -mez/-maz`], correctIndex: 0 },
        { question: `Sıfat-fiil ekleri hangileridir?`, options: [`-an, -ası, -mez, -ar, -dik, -ecek, -miş`, `-mak, -ma, -ış, -mek, -me, -iş`, `-ip, -erek, -ince, -ken, -madan, -eli`, `-lık, -cı, -lı, -sız, -daş, -cik`], correctIndex: 0 },
        { question: `Zarf-fiil (bağ-fiil) ekleri hangileridir?`, options: [`-ip, -erek, -ince, -ken, -madan, -eli`, `-mak, -ma, -ış, -mek, -me, -iş`, `-an, -ası, -mez, -ar, -dik, -ecek, -miş`, `-lık, -cı, -lı, -sız, -daş, -cik`], correctIndex: 0 },
        ...
        { question: `Aşağıdakilerden hangisi fiilimsi içerir?`, options: [`Çalışırken müzik dinlerim.`, `Ben her gün çalışıyorum.`, `Bu müzik çok güzeldir.`, `Bugün sabahtan beri yorgunum.`], correctIndex: 0 },
        ...
        { question: `Fiilimsiler aşağıdaki seçeneklerin hangisini yapmazlar?`, options: [`Cümlede yüklem olamazlar`, `İsim, sıfat ya da zarf görevinde olabilirler`, `Yan cümlecik kurabilirler`, `Cümleyi birleşik yapabilirler`], correctIndex: 0, explanation: `Cümlede yüklem (çekimli fiil) olamazlar` },
        ...
        { question: `"Akmaz bir su gördüm." cümlesinde "akmaz" hangi fiilimsidir?`, options: [`Sıfat-fiil`, `Zarf-fiil`, `İsim-fiil`, `Çekimli fiil`], correctIndex: 0 },
        { question: `"Yıkılası bir köşk gördüm." cümlesinde "yıkılası" hangi fiilimsidir?`, options: [`Sıfat-fiil`, `İsim-fiil`, `Zarf-fiil`, `Çekimli fiil`], correctIndex: 0 },
        { question: `"Çalışırken telefonu çaldı." cümlesinde "çalışırken" hangi fiilimsidir?`, options: [`Zarf-fiil`, `İsim-fiil`, `Sıfat-fiil`, `Çekimli fiil`], correctIndex: 0 },
        ...
        { question: `"Çiçek satıcısı kapıda durdu." cümlesinde "satıcı" sözcüğü fiilimsi midir?`, options: [`Hayır, -cı eki kalıcı isim yapar`, `Evet, -cı eki isim-fiil ekidir`, `Evet, sıfat-fiil görevindedir`, `Evet, zarf-fiil görevindedir`], correctIndex: 0 },
        { question: `"-ma/-me" eki her yerde isim-fiil midir?`, options: [`Hayır, olumsuzluk eki ile karışabilir`, `Evet, her zaman isim-fiil ekidir`, `Evet, sıfat-fiil eki olarak kullanılır`, `Hayır, her zaman zarf-fiil ekidir`], correctIndex: 0 },
        { question: `"Gelme!" cümlesinde "gel-me" ekinin görevi nedir?`, options: [`Olumsuzluk eki`, `İsim-fiil eki`, `Sıfat-fiil eki`, `Zarf-fiil eki`], correctIndex: 0, explanation: `Olumsuzluk eki (fiilimsi değil)` },
        ...
        { question: `"Düşünüp karar verdi." cümlesinde "düşünüp" hangi fiilimsidir?`, options: [`Zarf-fiil`, `İsim-fiil`, `Sıfat-fiil`, `Çekimli fiil`], correctIndex: 0 },
        ...
        { question: `"Söylemiş olduğun sözleri unutmadım." cümlesinde "söylemiş" hangi fiilimsidir?`, options: [`Sıfat-fiil`, `İsim-fiil`, `Zarf-fiil`, `Çekimli fiil`], correctIndex: 0 },
        ...
        { question: `Aşağıdaki cümlelerin hangisinde zarf-fiil vardır?`, options: [`Eve giderken markete uğradım.`, `Eve akşam çok geç saatte gittim.`, `Bizim evimiz çok güzeldir.`, `Bu ev bize çok küçüktü.`], correctIndex: 0 },
        { question: `"Bilmediğim bir konuyu öğrendim." cümlesinde kaç fiilimsi vardır?`, options: [`1`, `2`, `3`, `0`], correctIndex: 0 },
        { question: `"Okuyup öğrendiklerimi yazıyorum." cümlesinde kaç fiilimsi vardır?`, options: [`2`, `1`, `3`, `0`], correctIndex: 0, explanation: `2 (okuyup, öğrendiklerimi)` },
        ...
        { question: `"Doğan güneş geceyi sona erdirir." cümlesinde "doğan" hangi fiilimsidir?`, options: [`Sıfat-fiil`, `İsim-fiil`, `Zarf-fiil`, `Çekimli fiil`], correctIndex: 0 },
        ...
        { question: `"Sandalyede oturmakta olan adam babamdı." cümlesinde fiilimsi hangisidir?`, options: [`oturmakta`, `babamdı`, `sandalyede`, `adam`], correctIndex: 0 },
...
[ipucu] Önce **yüklem** bulunur; sonra yükleme "Kim?", "Neyi?", "Nereye?", "Nasıl?" soruları sorularak diğer ögeler bulunur.`,
      ...
      quickQuestions: [
        ...
        { question: `Cümlenin yardımcı ögeleri hangileridir?`, options: [`Nesne, dolaylı ve zarf tümleci`, `Özne, yüklem ve zarf tümleci`, `Sadece nesne ve dolaylı tümleç`, `Yalnızca özne ile yüklem`], correctIndex: 0 },
        { question: `Yüklem nedir?`, options: [`İş, oluş ya da yargı bildiren ögedir`, `Cümlede işi yapan varlığı bildiren ögedir`, `İşten etkilenen varlığı bildirir`, `Yer ve yön anlamı katan ögedir`], correctIndex: 0 },
        { question: `Özne, yükleme hangi soru sorularak bulunur?`, options: [`Kim/Ne`, `Kimi/Neyi`, `Nereye/Nereden`, `Nasıl/Niçin`], correctIndex: 0 },
        { question: `Belirtili nesne, yükleme hangi soru sorularak bulunur?`, options: [`Kimi? Neyi?`, `Kim? Ne?`, `Nereye? Nerede?`, `Nasıl? Ne kadar?`], correctIndex: 0 },
        { question: `Belirtisiz nesne, yükleme hangi soru sorularak bulunur?`, options: [`Ne`, `Kimi`, `Neyi`, `Nereye`], correctIndex: 0 },
        { question: `Dolaylı tümleç, yükleme hangi sorular sorularak bulunur?`, options: [`-e, -de, -den hâl ekleri`, `-i belirtme hâl eki`, `Nasıl ve ne kadar soruları`, `Yalın hâldeki sözcükler`], correctIndex: 0, explanation: `-e/-de/-den hâl ekleri (Nereye, Nerede, Nereden, Kime, Kimde, Kimden)` },
        { question: `Zarf tümleci, yükleme hangi sorularla bulunur?`, options: [`Nasıl, Ne zaman, Niçin, Ne kadar`, `Kim, Ne, Kimler, Neler`, `Kimi, Neyi, Kimleri, Neleri`, `Nereye, Nerede, Nereden, Kime, Kimde`], correctIndex: 0 },
        ...
        { question: `"Dün eve geç geldim." cümlesinde "dün" sözcüğünün görevi nedir?`, options: [`Zarf tümleci`, `Dolaylı tümleç`, `Nesne`, `Özne`], correctIndex: 0 },
        ...
        { question: `"Dün eve geç geldim." cümlesinde "geç" sözcüğünün görevi nedir?`, options: [`Zarf tümleci`, `Dolaylı tümleç`, `Nesne`, `Özne`], correctIndex: 0 },
        { question: `"Yağmur yağıyor." cümlesinde özne nedir?`, options: [`Yağmur`, `yağıyor`, `(gizli)`, `Bilinmiyor`], correctIndex: 0 },
        { question: `"Çalışıyorum." cümlesinde özne nedir?`, options: [`Gizli özne`, `Çalışıyorum`, `Yoktur`, `Çalış`], correctIndex: 0 },
        ...
        { question: `"Sınıfta tek bir çocuk..." cümlesi nasıl bir cümledir?`, options: [`Eksiltili cümle`, `Devrik cümle`, `Ünlem cümlesi`, `Birleşik cümle`], correctIndex: 0 },
        ...
        { question: `"Akşam parkta yürüdüm." cümlesinde "akşam" hangi ögedir?`, options: [`Zarf tümleci`, `Dolaylı tümleç`, `Nesne`, `Özne`], correctIndex: 0 },
        ...
        { question: `"Sınıfa giren öğrenci kitabını çıkardı." cümlesinde özne nedir?`, options: [`Sınıfa giren öğrenci`, `Sadece öğrenci sözcüğü`, `Sınıfa giren söz öbeği`, `Kitabını sözcüğü`], correctIndex: 0 },
        { question: `Cümlede özne ve yüklem dışındaki ögelere ne ad verilir?`, options: [`Yardımcı ögeler`, `Cümlenin temel ögeleri`, `Cümle dışı unsurlar`, `Cümlenin sözcük türleri`], correctIndex: 0 },
        ...
        { question: `"Akşamleyin telefonla konuşur." cümlesinde "telefonla" hangi ögedir?`, options: [`Edat tümleci`, `Dolaylı tümleç`, `Nesne`, `Özne`], correctIndex: 0, explanation: `Edat tümleci (zarf tümleci)` },
...
[soru] "Aşağıdaki cümlenin çatısı nedir?" → önce fiil cümlesi mi bak, sonra özne (etken/edilgen) ve nesne (geçişli/geçişsiz) ilişkisine bak.`,
      ...
      quickQuestions: [
        { question: `Fiilde çatı kaç açıdan incelenir?`, options: [`İki`, `Bir`, `Üç`, `Dört`], correctIndex: 0, explanation: `İki (özne ve nesne)` },
        { question: `Özne-yüklem ilişkisine göre fiil türleri nelerdir?`, options: [`Etken, edilgen, dönüşlü, işteş`, `Geçişli, geçişsiz, ettirgen`, `Olumlu, olumsuz, soru, ünlem`, `Basit, türemiş ve birleşik`], correctIndex: 0 },
        ...
        { question: `Dönüşlü çatı eki hangisidir?`, options: [`-n`, `-ar/-er`, `-i, -t`, `-mak/-mek`], correctIndex: 0, explanation: `-n (taran-, yıkan-, giyin-)` },
        ...
        { question: `Geçişli fiilden geçişsiz fiil yapan ek hangisidir?`, options: [`-l/-n`, `-t`, `-ar/-er`, `-mak/-mek`], correctIndex: 0, explanation: `-l/-n (edilgenlik eki)` },
        { question: `Geçişsiz bir fiili "geçişli" yapan ek hangisidir?`, options: [`-t, -tır, -dır`, `-l ve -n ekleri`, `-mak, -mek ekleri`, `-an, -en ekleri`], correctIndex: 0, explanation: `-t, -tır, -dır (oldurganlık eki)` },
        { question: `"Uyumak" fiili "uyutmak" yapılarak hangi çatı kazanılır?`, options: [`Oldurgan`, `Edilgen`, `İşteş`, `Dönüşlü`], correctIndex: 0 },
        ...
        { question: `Aşağıdaki fiillerden hangisi işteş çatılıdır?`, options: [`Tartışmak`, `Taranmak`, `Yazılmak`, `Süslenmek`], correctIndex: 0 },
        { question: `Aşağıdaki fiillerden hangisi dönüşlüdür?`, options: [`Taranmak`, `Gülüşmek`, `Kırılmak`, `Bakışmak`], correctIndex: 0, explanation: `Taranmak (kendini taradı)` },
        { question: `"Kapı çocuk tarafından açıldı." cümlesi çatısı bakımından nedir?`, options: [`Edilgen`, `Etken`, `Dönüşlü`, `İşteş`], correctIndex: 0, explanation: `Edilgen (eylemi yapan belli; ama özne sözdedir)` },
        ...
        { question: `Geçişli bir fiil edilgen yapıldığında nesne ne olur?`, options: [`Özne hâline gelir`, `Aynen nesne kalır`, `Yok olur`, `Zarfa dönüşür`], correctIndex: 0 },
        ...
        { question: `"Düşünmek" fiili özne-yüklem ilişkisine göre hangi çatıdadır?`, options: [`Dönüşlü (kendine yönelik)`, `İşteş (karşılıklı yapılan)`, `Edilgen (öznesi belirsiz)`, `Ettirgen (yaptırma bildiren)`], correctIndex: 0 },
        ...
        { question: `Edilgenlik eki "-n" hangi durumlarda kullanılır?`, options: [`Ünlü ile biten fiillerden sonra`, `Sadece ünsüzlerden sonra`, `Sadece çift heceli fiillerde`, `Sadece geniş zamanda`], correctIndex: 0, explanation: `Ünlü ile biten fiillerden sonra (oku-n-du, ye-n-di)` },
        { question: `"Okul açıldı." cümlesinin çatısı nedir?`, options: [`Edilgen`, `Etken`, `Dönüşlü`, `İşteş`], correctIndex: 0 },
        { question: `"Çocuk başını taradı." cümlesinin çatısı nedir?`, options: [`Etken`, `Dönüşlü`, `Edilgen`, `İşteş`], correctIndex: 0 },
        { question: `"Çocuk tarandı." cümlesinin çatısı nedir?`, options: [`Dönüşlü`, `Edilgen`, `Etken`, `İşteş`], correctIndex: 0 },
        { question: `"Konuşmak" → "konuşturmak" değişimi hangi çatıyı verir?`, options: [`Ettirgen`, `Edilgen`, `İşteş`, `Dönüşlü`], correctIndex: 0 },
...
[tuzak] **Yapım ekleri** kesme ile **ayrılmaz**: "Türk'çe" değil **"Türkçe"**; "Avrupa'lı" değil **"Avrupalı"**.`,
      ...
      quickQuestions: [
        ...
        { question: `"-de/-da" eki için aşağıdakilerden hangisi doğrudur?`, options: [`Ek ise bitişik, bağlaç ise ayrı yazılır`, `Bağlaç ise bitişik, ek ise ayrı yazılır`, `Her durumda bitişik ve kesmeyle yazılır`, `Ünlü uyumuna göre ayrı ya da bitişik olur`], correctIndex: 0 },
        ...
        { question: `"-ki" eki için aşağıdakilerden hangisi doğrudur?`, options: [`Bağlaç ise ayrı, ek ise bitişik yazılır`, `Bağlaç ise bitişik, ek ise ayrı yazılır`, `Her durumda ayrı ve kesmeyle yazılır`, `Ünlü uyumuna uyar, hep bitişik yazılır`], correctIndex: 0 },
        ...
        { question: `"Hâlbuki, oysaki, sanki, mademki" sözcüklerinde "ki" nasıl yazılır?`, options: [`Bitişik`, `Ayrı`, `Tireli`, `Büyük harfle`], correctIndex: 0, explanation: `Bitişik (kalıplaşmıştır)` },
        { question: `Soru eki "mi"nin yazımı için aşağıdakilerden hangisi doğrudur?`, options: [`Kendinden önceki sözcükten ayrı yazılır`, `Kendinden önceki sözcüğe bitişik yazılır`, `Her durumda kesme işaretiyle ayrılır`, `Ünlü uyumuna uymaz, bitişik yazılır`], correctIndex: 0 },
        { question: `Aşağıdakilerden hangisinde "mi" doğru yazılmıştır?`, options: [`Geldin mi?`, `Geldinmi?`, `Geldi-nmi?`, `Geldinmı?`], correctIndex: 0 },
        { question: `Büyük harfle başlayan özel adlara getirilen ekler nasıl ayrılır?`, options: [`Kesme işaretiyle (Ali'nin)`, `Tireyle ayrılır (Ali-nin)`, `Bitişik yazılır (Alinin)`, `Boşluk bırakılır (Ali nin)`], correctIndex: 0 },
        ...
        { question: `Kurum-kuruluş adlarına gelen ekler nasıl yazılır?`, options: [`Bitişik, kesme kullanılmaz`, `Her zaman kesmeyle ayrılır`, `Her zaman tireyle ayrılır`, `Her zaman boşlukla ayrılır`], correctIndex: 0, explanation: `Bitişik, kesme kullanılmaz (TBMM'ye ama Türkiye Cumhuriyeti'ne gibi durumlar dışında)` },
        { question: `Aşağıdakilerden hangisinde kesme işareti yanlış kullanılmıştır?`, options: [`Türk'lerin tarihi`, `Ali'nin defteri`, `İstanbul'a gittim`, `Atatürk'ün ilkeleri`], correctIndex: 0 },
        { question: `Sayı adları nasıl yazılır?`, options: [`Her sözcük ayrı yazılır (yüz on beş)`, `Bitişik tek sözcük yazılır (yüzonbeş)`, `Kısa çizgiyle yazılır (yüz-on-beş)`, `Yalnız rakamla yazılabilir (115)`], correctIndex: 0 },
        ...
        { question: `Aşağıdakilerden hangisinin yazımı doğrudur?`, options: [`sapasağlam`, `sapa-sağlam`, `mas mavi`, `sap sağlam`], correctIndex: 0, explanation: `Pekiştirmeli sözcükler bitişik yazılır: sapasağlam, masmavi, çepeçevre.` },
        { question: `"Aşağıdakilerden hangisi" gibi bir soru cümlesinde özel ad geçtiğinde nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Büyük harfle (Türkiye, Atatürk)` },
        { question: `Cins isimleri (genel adlar) nasıl yazılır?`, options: [`Küçük harfle`, `Büyük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0 },
        { question: `Kişi adlarının önündeki unvanlar nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Büyük harfle (Doktor Ahmet, Albay Mehmet)` },
        ...
        { question: `Gezegen, yıldız ve takımyıldız adları nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Büyük harfle (Mars, Dünya, Güneş)` },
        { question: `Dil ve millet adları nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Büyük harfle (Türkçe, İngilizce, Türk, Alman)` },
        { question: `Gün ve ay adları cümle içinde nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Büyük harfle (Pazartesi, Ocak)` },
        { question: `Yön adları başka bir isimle birlikte özel ad oluşturursa nasıl yazılır?`, options: [`Büyük harfle`, `Küçük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Büyük harfle (Doğu Anadolu, Batı Karadeniz)` },
        { question: `Sadece yön bildiriyorsa nasıl yazılır?`, options: [`Küçük harfle`, `Büyük harfle`, `Tırnak içinde`, `Tireyle`], correctIndex: 0, explanation: `Küçük harfle (rüzgâr doğudan esiyor)` },
        ...
        { question: `"Çalıkuşu" romanı, "Cumhuriyet" gazetesi yazımları nasıl olmalıdır?`, options: [`Büyük harfle başlayan özel ad`, `Küçük harfle yazılan tür adı`, `Tırnak içinde küçük harfle`, `Her harfi büyük yazılan kısaltma`], correctIndex: 0 },
        { question: `"Hâl, kâr, hâkim" gibi sözcüklerde "â" şapkalı harf neyi gösterir?`, options: [`İnce okunuş ve uzun ses`, `Sözcükteki vurgulu hece`, `Ünsüz yumuşaması olduğunu`, `Kalın ve kısa okunuşu`], correctIndex: 0 },
        ...
        { question: `"İle" sözcüğü ek olarak yazıldığında ne olur?`, options: [`-(y)le/-(y)la biçimini alır`, `Bitişik olarak "ile" yazılır`, `Biçimi hiç değişmeden kalır`, `Kısa çizgiyle sözcüğe bağlanır`], correctIndex: 0 },
        { question: `Aşağıdakilerden hangisi doğru yazımdır?`, options: [`Ali ile geldim. / Ali'yle geldim.`, `Aliıle geldim. / Ali ıle geldim.`, `Aliyle geldim. / Ali'le geldim.`, `Ali-ile geldim. / Ali-yle geldim.`], correctIndex: 0 },
        { question: `Kısaltmalara getirilen ekler nasıl yazılır?`, options: [`Kesme işaretiyle (TBMM'ye)`, `Bitişik yazılır (TBMMye)`, `Tireyle yazılır (TBMM-ye)`, `Boşluk bırakılır (TBMM ye)`], correctIndex: 0 },
        { question: `Yabancı kökenli sözcüklerin Türkçe yazımı için ne yapılmalı?`, options: [`Türkçenin ses ve yazım kurallarına uyar`, `Özgün yazımı korunarak olduğu gibi yazılır`, `Her durumda tırnak içinde gösterilir`, `Kısa çizgiyle hecelerine ayrılır`], correctIndex: 0 },
        { question: `"E-posta" sözcüğü nasıl yazılır?`, options: [`Tireli (e-posta)`, `Bitişik (eposta)`, `Ayrı (e posta)`, `Büyük harfle`], correctIndex: 0 },
        { question: `Sayıların yazımında özel kullanım: "5'inci sınıf" mı, "5 inci sınıf" mı doğru?`, options: [`5'inci sınıf`, `5 inci sınıf`, `5inci sınıf`, `5.inci sınıf`], correctIndex: 0, explanation: `5'inci sınıf (sıra ek kesmeyle ayrılır)` },
        { question: `"Yirmi birinci yüzyıl" mı "yirmi-birinci yüzyıl" mı doğru?`, options: [`Yirmi birinci yüzyıl`, `Yirmi-birinci yüzyıl`, `Yirmibirinci yüzyıl`, `Yirmi Birinci yüzyıl`], correctIndex: 0 },
        { question: `Yer adlarına gelen ek nasıl yazılır?`, options: [`Kesme işareti ile (Ankara'da)`, `Bitişik yazılır (Ankarada)`, `Tireyle yazılır (Ankara-da)`, `Boşluk bırakılarak (Ankara da)`], correctIndex: 0 },
        { question: `"Kuzeydoğu, güneybatı" gibi yön adları nasıl yazılır?`, options: [`Bitişik`, `Ayrı`, `Tireli`, `Büyük harfle`], correctIndex: 0 },
        { question: `İkilemelerde "-de" eki ne yapılır?`, options: [`Bağlaçsa ayrı yazılır`, `Her durumda bitişik yazılır`, `Kesme işaretiyle ayrı yazılır`, `Kısa çizgiyle yazılır`], correctIndex: 0 },
        { question: `"İkişer ikişer" ifadesi nasıl yazılır?`, options: [`Ayrı`, `Bitişik`, `Tireyle`, `Tek sözcük`], correctIndex: 0, explanation: `Ayrı (her ikileme ayrı)` },
        { question: `Aşağıdakilerden hangisinde kesme işareti gereksizdir?`, options: [`Yazar'lar romanı sevdi.`, `Ali'ye yardım ettim.`, `İstanbul'da yaşıyorum.`, `Atatürk'e saygı duyarız.`], correctIndex: 0 },
        { question: `"Doğum tarihinizi yazınız." cümlesinde sayı yazılırken nasıl yazılır?`, options: [`05.06.2010 ya da 5 Haziran 2010`, `05-06-2010 ya da 5-Haziran-2010`, `05/06/2010 ya da 5/Haziran/2010`, `05,06,2010 ya da 5 Haziran, 2010`], correctIndex: 0 },
        { question: `"Bay/Bayan" kısaltmaları kişi adıyla nasıl yazılır?`, options: [`Büyük harfle ve adın önünde`, `Küçük harfle ve adın önünde`, `Büyük harfle ve adın sonunda`, `Küçük harfle, tırnak içinde`], correctIndex: 0 },
      ],
    },
    {
...
[tuzak] **Yapım eklerini ayırmaz:** "Türk'çe" değil **"Türkçe"**; "Antalya'lı" değil **"Antalyalı"**. (LGS'nin en sık tuzağı!)`,
      ...
      quickQuestions: [
        ...
        { question: `Soru cümlelerinin sonuna hangi noktalama işareti konur?`, options: [`Soru işareti (?)`, `Ünlem işareti (!)`, `Noktalı virgül (;)`, `Üç nokta (...)`], correctIndex: 0 },
        ...
        { question: `Uzun cümlelerde özneyi vurgulamak için ne kullanılır?`, options: [`Özneden sonra virgül`, `Özneden sonra noktalı virgül`, `Yüklemden sonra iki nokta`, `Öznenin çevresinde tırnak`], correctIndex: 0 },
        ...
        { question: `Virgülle ayrılan grupları daha büyük bir ayrımla bölmek için ne kullanılır?`, options: [`Noktalı virgül (;)`, `İki nokta işareti (:)`, `Üç nokta işareti (...)`, `Kısa çizgi işareti (-)`], correctIndex: 0 },
        { question: `"Gözlerinden yaşlar akıyordu…" cümlesindeki üç nokta hangi anlamı verir?`, options: [`Sözün tamamlanmadığını gösterir`, `Cümlenin bittiğini kesinleştirir`, `Alıntı yapıldığını belirtir`, `Şaşkınlık ve heyecan bildirir`], correctIndex: 0 },
        { question: `Tırnak işareti hangi durumda kullanılır?`, options: [`Aktarılan sözleri belirtmek için`, `Cümlenin sonunu bildirmek için`, `Açıklama cümlesi eklemek için`, `Sözün yarıda kaldığını göstermek`], correctIndex: 0 },
        ...
        { question: `Yay ayraç ( ) hangi durumda kullanılır?`, options: [`Cümleye ara açıklama eklemek için`, `Başkasının sözünü aktarmak için`, `Eş görevli sözcükleri ayırmak için`, `Sıralı cümleleri bitirmek için`], correctIndex: 0 },
        { question: `Kesme işaretinin görevi nedir?`, options: [`Özel adlara getirilen ekleri ayırmak`, `Cins adlara getirilen ekleri ayırmak`, `Eş görevli sözcükleri ayırmak`, `Aktarılan sözleri belirtmek`], correctIndex: 0 },
        { question: `Kısa çizgi (-) hangi durumda kullanılır?`, options: [`Satır sonunda sözcüğü hecelere ayırmada`, `Karşılıklı konuşma bölümlerini başlatmada`, `Özel adlara gelen çekim eklerini ayırmada`, `Aktarılan sözleri belirtmede`], correctIndex: 0 },
        { question: `Uzun çizgi (—) hangi durumda kullanılır?`, options: [`Konuşma çizgisi`, `Hece bölme çizgisi`, `Birleştirme çizgisi`, `Kesme işareti`], correctIndex: 0, explanation: `Konuşma çizgisi (diyalog başlangıcı)` },
        ...
        { question: `"Acaba bugün ders olacak mı?" cümlesindeki soru işareti hangi sözcüğe bağlıdır?`, options: [`Mı`, `Acaba`, `Bugün`, `Ders`], correctIndex: 0 },
        { question: `Soru anlamı taşıyan ama biçimce soru cümlesi olmayan cümlelerin sonuna ne konur?`, options: [`Soru işareti`, `Ünlem işareti`, `Noktalı virgül`, `Kısa çizgi`], correctIndex: 0 },
        { question: `"Geç kaldım çünkü trafik vardı." cümlesinde noktalama doğru mu?`, options: [`Doğru`, `Yanlış, soru olmalı`, `Yanlış, ünlem olmalı`, `Yanlış, üç nokta olmalı`], correctIndex: 0, explanation: `Doğru (çünkü öncesi tercihen virgül de olabilir)` },
        { question: `Tırnak içine alınmış sözcükteki noktalama nereye konur?`, options: [`Tırnağın içine`, `Her zaman dışına`, `Hiç konmaz`, `Hem içine hem dışına`], correctIndex: 0, explanation: `Tırnağın içine (eğer aktarılan söz bir cümleyse)` },
        ...
        { question: `Aşağıdaki seçeneklerden hangisinde "ki"den önce virgül konur?`, options: [`Yapı gerektiriyorsa konabilir`, `Her kullanımında mutlaka konur`, `Hiçbir durumda konulmaz`, `Yalnızca soru cümlelerinde konur`], correctIndex: 0 },
        { question: `Aşağıdakilerden hangisi konuşma aktarımının doğru yazımıdır?`, options: [`Ali, "Hadi gidelim." dedi.`, `Ali, dedi: Hadi gidelim.`, `Ali "Hadi gidelim" dedi`, `Ali — Hadi gidelim — dedi.`], correctIndex: 0 },
        ...
        { question: `Eğer bir cümle hem soru hem ünlem anlamı taşıyorsa ne yapılır?`, options: [`Soru işaretinden sonra ünlem konur`, `Yalnızca soru işareti konur`, `Yalnızca ünlem işareti konur`, `Yalnızca üç nokta ile bitirilmelidir`], correctIndex: 0 },
        { question: `Adres yazımında yer adları arasına ne konur?`, options: [`Virgül`, `Nokta`, `İki nokta`, `Tırnak`], correctIndex: 0, explanation: `Virgül (Çankaya, Ankara)` },
        { question: `Tarih yazımında gün-ay-yıl arasına ne konur?`, options: [`Nokta ya da boşluk (29.10.1923)`, `Her zaman virgül (29,10,1923)`, `Her zaman kısa çizgi (29-10-1923)`, `Her zaman eğik çizgi (29/10/1923)`], correctIndex: 0 },
        ...
        { question: `Soru zarfı içeren ama cevap beklenmeyen cümleye ne denir ve nasıl noktalanır?`, options: [`Sözde soru; nokta veya ünlem konur`, `Gerçek soru; soru işareti konur`, `Ünlem cümlesi; yalnızca ünlem konur`, `Devrik cümle; üç nokta konur`], correctIndex: 0 },
        ...
        { question: `"H.Ü." gibi kısaltmalarda nokta nereye konur?`, options: [`Her büyük harften sonra`, `Yalnızca son harften sonra`, `Yalnızca ilk harften sonra`, `Hiçbir harften sonra konmaz`], correctIndex: 0 },
        { question: `"TBMM, TRT" gibi kısaltmalarda nokta neden yoktur?`, options: [`Büyük harfli kurum kısaltmalarında nokta konmaz`, `Sonu ünsüzle biten kısaltmalarda hiç nokta konmaz`, `Yalnızca yabancı kısaltmalarda nokta konmaz`, `Ekli yazılan kısaltmalarda nokta konmaz`], correctIndex: 0 },
        ...
        { question: `"Yağmur yağıyor, çocuklar oynayamıyor." cümlesinde virgül hangi göreve sahiptir?`, options: [`İki cümleyi birbirinden ayırır`, `Eş görevli ögeleri ayırır`, `Hitap belirler`, `Vurgu yapar`], correctIndex: 0 },
        { question: `"Kim, ne, nerede, ne zaman, nasıl" gibi sözcükler cümle başında ünlem değil soru oluştururlarsa hangi işaret kullanılır?`, options: [`Soru işareti`, `Ünlem işareti`, `Noktalı virgül`, `Kısa çizgi`], correctIndex: 0 },
      ],
    },
    {
...
[soru] "Aşağıdaki cümlelerin hangisinde anlatım bozukluğu vardır?" → gereksiz tekrar, yanlış sözcük, uyumsuzluk veya çelişki ara.`,
      ...
      quickQuestions: [
        { question: `Anlatım bozukluklarının temel nedeni nedir?`, options: [`Dil bilgisi ve anlam kurallarına uymamak`, `Cümlede gereğinden çok fazla sözcük kullanmak`, `Noktalama işaretlerini eksik kullanmak`, `Yabancı kökenli sözcükler kullanmak`], correctIndex: 0 },
        { question: `Aşağıdaki cümlelerin hangisinde gereksiz sözcük kullanımı vardır?`, options: [`Bana geri iade etti.`, `Kitabı bana dün iade etti.`, `Onu telefonla hemen çağırdı.`, `Yarın sabah erkenden geleceğim.`], correctIndex: 0 },
        { question: `"Aşağıya inmek" ifadesindeki anlatım bozukluğunun nedeni nedir?`, options: [`Anlamca çelişen/gereksiz sözcük`, `Ad tamlaması yanlışlığı`, `Özne-yüklem uyumsuzluğu`, `Nesne eksikliğinden kaynaklanır`], correctIndex: 0, explanation: `Anlamca çelişen/gereksiz sözcük (inmek zaten aşağıya doğrudur)` },
        ...
        { question: `"Çocuklar parkta koştu, oynadılar." cümlesinde nasıl bir bozukluk vardır?`, options: [`Yüklemde çoğul-tekil uyumsuzluğu`, `Ad tamlamasında ek eksikliği`, `Yüklemde çatı bakımından uyumsuzluk`, `Gereksiz sözcük kullanılması`], correctIndex: 0, explanation: `Yüklemde çoğul-tekil uyumsuzluğu (koştu/oynadılar farklı)` },
        ...
        { question: `"Sen ve o gidecek." cümlesi yüklem uyumu açısından doğru mudur?`, options: [`Yanlış; yüklem "gideceksiniz" olmalı`, `Doğrudur; herhangi bir uyum hatası yok`, `Yanlış; yüklem "gideceğiz" olmalı`, `Yanlış; yüklem "gidecekler" olmalı`], correctIndex: 0 },
        ...
        { question: `"Tahminen 100 kişi vardı kesinlikle." cümlesinde nasıl bir bozukluk vardır?`, options: [`Anlamca çelişme`, `Tamlama hatası`, `Özne uyumsuzluğu`, `Yüklem hatası`], correctIndex: 0, explanation: `Anlamca çelişme (tahminen-kesinlikle birlikte)` },
        { question: `"Onun kitabını ve defteri kayboldu." cümlesindeki bozukluğun nedeni nedir?`, options: [`Tamlama yanlışlığı`, `Özne-yüklem`, `Anlamca çelişki`, `Gereksiz sözcük`], correctIndex: 0, explanation: `Tamlama yanlışlığı (her ikisi de "onun" tamlayanını almalı)` },
        ...
        { question: `"Bu film izlenir ve seyredilir." cümlesinde nasıl bir bozukluk vardır?`, options: [`Eş anlamlı sözcüklerin gereksizliği`, `Karşıt anlamlı sözcüklerin çelişkisi`, `Özne ile yüklemin uyuşmaması`, `Ad tamlamasında ek eksikliği`], correctIndex: 0, explanation: `Eş anlamlı (anlamca aynı) sözcüklerin gereksiz kullanımı` },
        ...
        { question: `Aşağıdaki cümlelerin hangisinde mantık bozukluğu (anlamca çelişki) vardır?`, options: [`Belki, kesinlikle yarın gelirim.`, `Belki yarın sabah erken gelirim.`, `Kesinlikle yarın akşam gelirim.`, `Sanırım yarın akşam geç gelirim.`], correctIndex: 0 },
        { question: `"Genelde her zaman ders çalışırım." cümlesindeki bozukluğun nedeni nedir?`, options: [`Anlamca çelişki / gereksiz sözcük`, `Ad tamlamasında tamlayan eksikliği`, `Özne ile yüklemin uyuşmaması`, `Noktalama işaretinin eksikliği`], correctIndex: 0 },
        { question: `"Kelimeleri sözlükten araştırdı." cümlesinde bozukluk var mı?`, options: [`Var; "araştırdı" yerine "aradı" denmeli`, `Yok; cümlede herhangi bir bozukluk yoktur`, `Var; ad tamlaması yanlış kurulmuş`, `Var; özne ile yüklem uyuşmamaktadır`], correctIndex: 0 },
        { question: `"Bütün herkes geldi." cümlesinde hangi bozukluk vardır?`, options: [`Anlamdaş sözcüklerin yan yana kullanımı`, `Karşıt anlamlı sözcüklerin çelişki yaratması`, `Yüklemin çatı bakımından uyumsuzluğu`, `Ad tamlamasında tamlayan eksikliği`], correctIndex: 0 },
        { question: `"Yaklaşık olarak 3 metre kadardı." cümlesinde nasıl bir bozukluk vardır?`, options: [`Aynı anlamdaki sözcükler yinelenmiş`, `Karşıt anlamlı sözcükler çelişmektedir`, `Ad tamlamasında ek eksikliği var`, `Özne ile yüklem uyum içinde değil`], correctIndex: 0 },
        { question: `"Telefonum çalınınca telefonumun çaldığını anladım." cümlesinde bozukluk var mı?`, options: [`"Çalınmak" ve "çalmak" karıştırılmış`, `Cümlede herhangi bir bozukluk bulunmuyor`, `Ad tamlamasında ek eksikliği var`, `Özne ile yüklem uyum içinde değil`], correctIndex: 0 },
        { question: `"Onun saçları ve gözleri kahverengiydi." cümlesinde yüklem uyumu nasıldır?`, options: [`Doğru`, `Yanlış, özne çoğul`, `Yanlış, gereksiz`, `Çelişki var`], correctIndex: 0, explanation: `Doğru (cansız nesneler tekilde de çoğulda da uyumlu)` },
        { question: `"Türkçe dili öğretmenim çok iyidir." cümlesinde bozukluk var mı?`, options: [`Var; "dili" sözcüğü gereksiz kullanılmış`, `Yok; cümlede bir bozukluk bulunmuyor`, `Var; karşıt anlamlı sözcükler çelişmektedir`, `Var; özne ile yüklem uyuşmamaktadır`], correctIndex: 0 },
        { question: `"Bana hiç soru sorma sakın." cümlesinde nasıl bir bozukluk vardır?`, options: [`Pekiştiricilerin gereksiz yinelenmesi`, `Karşıt anlamlı sözcüklerin çelişmesi`, `Ad tamlamasında tamlayan eksikliği`, `Özne ile yüklemin uyum içinde olmaması`], correctIndex: 0, explanation: `Anlamı pekiştirici sözcüklerin birden çok kullanımı (yanlış değil ama gereksiz)` },
        { question: `"Yarın akşam yedide yolculuğa çıkarken hava yağmurluydu." cümlesinde nasıl bir bozukluk vardır?`, options: [`Zaman uyumsuzluğu`, `Çelişki yok`, `Tamlama hatası`, `Özne uyumsuzluğu`], correctIndex: 0, explanation: `Zaman uyumsuzluğu (yarın - yağmurluydu)` },
        { question: `"Ona söylediğim şeyleri unuttum söylemeyi." cümlesinde nasıl bir bozukluk vardır?`, options: [`Sıralama/anlam karışıklığı`, `Ad tamlamasında ek eksikliği`, `Özne-yüklem uyumsuzluğu`, `Yüklemde kip uyumsuzluğu`], correctIndex: 0, explanation: `Sıralama/anlam karışıklığı (söylenen şeyi unutmak vs. söylemeyi unutmak)` },
        { question: `"İçeri girip kapıyı kapattı ve dışarı çıktı." cümlesinde nasıl bir bozukluk vardır?`, options: [`Mantık çelişkisi`, `Ad tamlaması hatası`, `Yüklemde kip hatası`, `Özne uyumsuzluğu`], correctIndex: 0, explanation: `Mantık çelişkisi (içeri girip dışarı çıkıldı)` },
        { question: `"Hayatım boyu bu kadar mutlu olmadım." cümlesi anlamca doğru mu?`, options: [`Doğru`, `Yanlış, çelişki var`, `Yanlış, tamlama hatası`, `Yanlış, özne uyumsuz`], correctIndex: 0, explanation: `Doğru ("hayatım boyunca" daha yaygın)` },
        { question: `"Saat yedi-yedi buçuk gibi geldi." doğru mudur?`, options: [`Doğru`, `Yanlış, tire yanlış`, `Yanlış, çelişki`, `Yanlış, özne yok`], correctIndex: 0, explanation: `Doğru (yaklaşıklık ifadesi)` },
        { question: `"Annem ve baba pazara gittiler." cümlesinde bozukluk var mı?`, options: [`Var; "baba" sözcüğü "babam" olmalı`, `Yok; cümle kurallara uygun yazılmıştır`, `Var; nesne eksikliği bulunmakta`, `Var; sözcükler anlamca çelişiyor`], correctIndex: 0, explanation: `Var; "babam" olmalı (tamlayan eki eksik) ve yüklem uyumu sorgulanır` },
        { question: `"Kapıyı vurduktan sonra ses gelmedi." cümlesinde mantık doğrudur. Aşağıdaki hangisi mantık hatalıdır?`, options: [`Kapıyı gürültüyle kırdı ama kimse duymadı.`, `Kapıyı çaldı, kimse açmadı, uzaklaştı.`, `Kapıyı çaldıktan sonra bir süre daha bekledi.`, `Kapıyı çaldı ve içeri davet edildi.`], correctIndex: 0 },
        { question: `"Bahçeye birkaç çiçek diktim ve hepsi de büyüdü." cümlesinde "hepsi de" ifadesi gereksiz midir?`, options: [`Hayır; "de" bağlacı pekiştirme katar`, `Evet; "hepsi de" tümüyle gereksizdir`, `Evet; "birkaç" ile çelişki oluşturur`, `Evet; anlatımı gereksiz uzatmaktadır`], correctIndex: 0 },
        { question: `"Belge orijinal aslına uygundur." cümlesinde nasıl bir bozukluk vardır?`, options: [`Eş anlamlı sözcükler bir arada kullanılmış`, `Karşıt anlamlı sözcükler çelişki yaratmış`, `Ad tamlamasında tamlayan eki düşmüş`, `Özne ile yüklem uyum içinde değil`], correctIndex: 0 },
        { question: `"Ona hediye olarak armağan verdim." cümlesinde nasıl bir bozukluk vardır?`, options: [`Eş anlamlı sözcükler bir arada`, `Karşıt anlamlı sözcükler bir arada`, `Ad tamlamasında ek eksikliği`, `Özne ile yüklemin uyuşmaması`], correctIndex: 0, explanation: `Eş anlamlı sözcükler bir arada (hediye-armağan)` },
        { question: `"Üzerime giyeceğim elbiseyi seçtim." cümlesinde nasıl bir bozukluk vardır?`, options: [`"Üzerime" sözcüğü gereksiz kullanılmış`, `Karşıt anlamlı sözcükler çelişmektedir`, `Ad tamlamasında tamlayan eki eksiktir`, `Özne ile yüklem uyum içinde değildir`], correctIndex: 0 },
        { question: `"Ağzıyla konuştu." cümlesinde nasıl bir bozukluk vardır?`, options: [`"Ağzıyla" sözcüğü gereksiz kullanılmış`, `Sözcükler anlamca birbiriyle çelişiyor`, `Yüklem yanlış çatıda kullanılmıştır`, `Nesne eksikliği anlam kaymasına yol açmış`], correctIndex: 0 },
        { question: `"Çabuk ve hızlı koştu." cümlesinde nasıl bir bozukluk vardır?`, options: [`Anlamdaş sözcükler birlikte kullanılmış`, `Karşıt anlamlı sözcükler çelişki yaratmış`, `Ad tamlamasında tamlayan eki düşmüş`, `Yüklem yanlış kipte çekimlenmiştir`], correctIndex: 0 },
        ...
        { question: `"Yanıma birkaç tane arkadaşlar geldi." cümlesinde nasıl bir bozukluk vardır?`, options: [`Sayı sıfatından sonra ad tekil olmalı`, `Sayı sıfatından sonra ad çoğul olmalı`, `Ad tamlamasında tamlayan eki eksiktir`, `Özne ile yüklem uyum içinde değildir`], correctIndex: 0 },
        ...
        { question: `"Burada başka birisi yok." cümlesinde bozukluk var mı?`, options: [`Yok`, `Çelişki var`, `Tamlama hatası`, `Yüklem hatası`], correctIndex: 0, explanation: `Yok ("başka biri" daha doğru olmakla birlikte yaygın)` },
        ...
        { question: `"Sınıfımızdaki tüm öğrenciler okula geç kalan, ödev yapmayan ve sınıfta gürültü çıkaran kişilerdir." cümlesinde mantık hatası var mı?`, options: [`Var; "tüm" ile aşırı genelleme yapılmış`, `Yok; cümlede herhangi bir mantık hatası yok`, `Var; ad tamlamasında ek eksikliği var`, `Var; özne ile yüklem uyuşmamaktadır`], correctIndex: 0 },
        { question: `"Onun ödevlerini ben de yaptım." cümlesinde "de" bağlacı yerinde mi?`, options: [`Yerinde`, `Yanlış, bitişik olmalı`, `Çelişki`, `Gereksiz`], correctIndex: 0, explanation: `Yerinde (ben de = "ben dahi" anlamı verir)` },
        { question: `"Sokağa çıkıp dolaştık ama yine eve geri döndük." cümlesinde nasıl bir bozukluk vardır?`, options: [`Gereksiz sözcük`, `Anlamca çelişki`, `Tamlama hatası`, `Yüklem eksikliği`], correctIndex: 0, explanation: `Gereksiz sözcük ("geri" dönmek anlam karışıklığı yaratır)` },
        { question: `"Eve yaklaşık olarak tam 5 dakikada vardım." cümlesindeki anlatım bozukluğunun nedeni nedir?`, options: [`Çelişen sözcüklerin bir arada kullanılması`, `Eş anlamlı sözcüklerin gereksiz kullanımı`, `Ad tamlamasında tamlayan ekinin eksikliği`, `Özne ile yüklem arasındaki uyumsuzluk`], correctIndex: 0, explanation: `Birbiriyle çelişen sözcüklerin bir arada kullanılması ("yaklaşık" + "tam")` },
        { question: `"Pencereden dışarı baktım." cümlesinde bozukluk var mı?`, options: [`Yok`, `Çelişki`, `Tamlama`, `Yüklem`], correctIndex: 0, explanation: `Yok ("dışarı" pekiştirici olarak yaygın)` },
