...
const SOZEL: SubjectSpec[] = [
  { slug: "turkce", name: "Türkçe", key: "ACDCBCBADCBBDABBADDC" },
  { slug: "inkilap", name: "T.C. İnkılap Tarihi", key: "CDCBADCDAB" },
  { slug: "din", name: "Din Kültürü", key: "BCDCADBADC" },
  { slug: "ingilizce", name: "İngilizce", key: "ADCBADBCAC" },
];

// ── SAYISAL — A Kitapçığı cevap anahtarı ────────────────────────────
const SAYISAL: SubjectSpec[] = [
  { slug: "matematik", name: "Matematik", key: "CABDBCBABCBDCADBADCA" },
  { slug: "fen", name: "Fen Bilimleri", key: "ADBCBCADABBCDBACADCD" },
];
...
export const SOZEL_2023: PastQuestion[] = build(SOZEL, "sozel");
export const SAYISAL_2023: PastQuestion[] = build(SAYISAL, "sayisal");
