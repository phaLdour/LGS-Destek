...
[örnek] Fosil yakıt kullanımı → sera gazlarının artışı → küresel ısınma → buzulların erimesi ve deniz seviyesinin yükselmesi.`,
      ...
      quickQuestions: [
        ...
        { question: `Dünya'nın dönme ekseni kaç derece eğiktir?`, options: [`23° 27'`, `45°`, `90°`, `0°`], correctIndex: 0 },
        ...
        { question: `Hava olayları kaç saatlik kısa süreli olaylardır?`, options: [`Hava durumu kısa süreli, iklim uzun sürelidir`, `Aynı şeydir`, `Her ikisi de aynı süreyi belirtir`, `İklim daha kısa sürelidir`], correctIndex: 0 },
...
[tuzak] Cinsiyeti belirleyen kromozom **babadan** gelir.`,
      ...
      quickQuestions: [
        ...
        { question: `DNA hücrenin neresinde bulunur?`, options: [`Çekirdek (asıl), mitokondri ve kloroplast`, `Sadece sitoplazma`, `Sadece zar`, `Hücre dışı`], correctIndex: 0 },
        ...
        { question: `RNA kaç iplikten oluşur?`, options: [`Tek iplik`, `İki iplik`, `Üç iplik`, `Dört iplik`], correctIndex: 0 },
        { question: `RNA'da bulunmayan baz hangisidir?`, options: [`Timin`, `Adenin`, `Guanin`, `Sitozin`], correctIndex: 0 },
        { question: `RNA'da Timin yerine hangi baz bulunur?`, options: [`Urasil`, `Adenin`, `Guanin`, `Sitozin`], correctIndex: 0 },
        { question: `RNA'nın şekeri hangisidir?`, options: [`Riboz`, `Deoksiriboz`, `Glikoz`, `Fruktoz`], correctIndex: 0 },
        { question: `DNA'nın şekeri hangisidir?`, options: [`Deoksiriboz`, `Riboz`, `Glikoz`, `Fruktoz`], correctIndex: 0 },
        ...
        { question: `İnsan vücut hücreleri kaç kromozom takımına sahiptir?`, options: [`2n (diploit)`, `n (haploit)`, `3n`, `4n`], correctIndex: 0 },
        { question: `Üreme hücreleri kaç kromozom takımına sahiptir?`, options: [`n (haploit)`, `2n`, `3n`, `4n`], correctIndex: 0 },
        ...
        { question: `Aynı genleri taşıyan birey için kullanılan terim hangisidir?`, options: [`Homozigot (saf döl)`, `Heterozigot`, `Diploit`, `Haploit`], correctIndex: 0 },
        { question: `Farklı alelleri taşıyan birey için kullanılan terim hangisidir?`, options: [`Heterozigot (melez)`, `Homozigot`, `Diploit`, `Haploit`], correctIndex: 0 },
        ...
        { question: `Renk körlüğü ve hemofili hastalıkları hangi tip kalıtım gösterir?`, options: [`X kromozomuna bağlı çekinik`, `Y kromozomuna bağlı`, `Otozomal baskın`, `Tüm hücrelerde baskın`], correctIndex: 0 },
        ...
        { question: `İkinci kuşakta saf döl baskın × saf döl çekinik çaprazlamasında fenotip nasıl olur?`, options: [`3 baskın : 1 çekinik`, `1:1`, `1:2:1`, `Hepsi baskın`], correctIndex: 0 },
        ...
        { question: `Genetik kod kaç bazdan oluşur?`, options: [`4 (A, T, G, C)`, `2`, `3`, `5`], correctIndex: 0 },
...
[tuzak] "Yükseğe çıkınca açık hava basıncı artar" yanlıştır; azalır.`,
      ...
      quickQuestions: [
        ...
        { question: `Pascal Prensibi neyle ilgilidir?`, options: [`Sıvı veya gazda yapılan basıncın aynen iletilmesi`, `Sıvının kaynaması`, `Donmaları`, `Çözünmeleri`], correctIndex: 0 },
        ...
        { question: `Sıvı basıncını ölçen alet hangisidir?`, options: [`Manometre`, `Barometre`, `Termometre`, `Higrometre`], correctIndex: 0 },
...
Çıkrık, kuyudan su çekmekte kullanılan bir araçtır. Dişliler ve kasnaklar dönme hareketini iletir; birbirine geçen dişlilerde diş sayısı çok olan dişli daha yavaş ama daha güçlü döner.`,
      ...
      quickQuestions: [
        ...
        { question: `İki sabit + iki hareketli makaralı bir palangada kuvvet kaza kaç kazanılır?`, options: [`4 (hareketli sayısı × 2)`, `2`, `8`, `1`], correctIndex: 0 },
        ...
        { question: `Yumurta sıkacağı (kafa kıracağı) hangi tür kaldıraçtır?`, options: [`1. tür`, `2. tür`, `3. tür`, `Kaldıraç değil`], correctIndex: 0 },
...
[örnek] Geri dönüşüm, enerji tasarrufu ve doğanın korunması sürdürülebilirliği destekler.`,
      ...
      quickQuestions: [
        ...
        { question: `Ozon tabakasının inceltilmesinin nedeni hangisidir?`, options: [`Kloroflorokarbon (CFC) gazları`, `Karbondioksit`, `Su buharı`, `Oksijen`], correctIndex: 0 },
        { question: `Ozon tabakası bizi neye karşı korur?`, options: [`Ultraviyole (mor ötesi) ışınlardan`, `Yağmurdan`, `Mıknatıs gücünden`, `Rüzgardan`], correctIndex: 0 },
        ...
        { question: `Nükleer santralde hangi olay enerji üretir?`, options: [`Atom çekirdeğinin parçalanması (fisyon)`, `Yer çekimi`, `Sürtünme`, `Fotosentez`], correctIndex: 0 },
        { question: `Düşen bir cismin ivmesi yer çekimi ivmesine eşittir; bu nedenle hangi enerji artar?`, options: [`Kinetik enerji`, `Potansiyel enerji`, `Isı enerjisi`, `Esneklik enerjisi`], correctIndex: 0 },
...
[örnek] Ütü ve sobada **ısıya**, ampulde **ışığa**, çamaşır makinesi ve vantilatörde **hareket** enerjisine dönüşür.`,
      ...
      quickQuestions: [
        ...
        { question: `Ohm yasasını formülle ifade ediniz:`, options: [`V = I × R`, `V = I + R`, `V = I - R`, `V = I / R`], correctIndex: 0 },
        ...
        { question: `Seri bağlı dirençlerin eş değer direnci nasıl hesaplanır?`, options: [`R_eş = R₁ + R₂ + R₃ ...`, `R_eş = R₁ × R₂`, `1/R_eş = 1/R₁ + 1/R₂`, `R_eş = R₁ - R₂`], correctIndex: 0 },
        { question: `Paralel bağlı dirençlerin eş değer direnci nasıl hesaplanır?`, options: [`1/R_eş = 1/R₁ + 1/R₂ + ...`, `R_eş = R₁ + R₂`, `R_eş = R₁ × R₂`, `R_eş = R₁ - R₂`], correctIndex: 0 },
