...
[örnek] Geri dönüşüm, enerji tasarrufu ve doğanın korunması sürdürülebilirliği destekler.`,
      ...
      quickQuestions: [
        ...
        { question: `Bisiklet dinamosu hangi enerji dönüşümünü gerçekleştirir?`, options: [`Hareket (kinetik) → Elektrik`, `Elektrik → Hareket`, `Isı → Elektrik`, `Ses → Elektrik`], correctIndex: 0 },
