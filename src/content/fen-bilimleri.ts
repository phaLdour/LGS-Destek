...
[örnek] Fosil yakıt kullanımı → sera gazlarının artışı → küresel ısınma → buzulların erimesi ve deniz seviyesinin yükselmesi.`,
      ...
      quickQuestions: [
        ...
        { question: `Dünya'nın dönme ekseni kaç derece eğiktir?`, options: [`23° 27'`, `45°`, `90°`, `0°`], correctIndex: 0, explanation: `23° 27' (yaklaşık 23,5°)` },
...
[tuzak] Cinsiyeti belirleyen kromozom **babadan** gelir.`,
      ...
      quickQuestions: [
        ...
        { question: `Heterozigot bir bireyin gametleri nasıldır?`, options: [`İki farklı tip alel taşır`, `Aynı alel`, `Hiç alel taşımaz`, `Üç farklı alel taşır`], correctIndex: 0, explanation: `İki farklı tip alel taşır (Aa → A ve a)` },
...
[tuzak] "Saf su kaynarken sıcaklığı sürekli artar" yanlıştır; hâl değişiminde sıcaklık sabittir.`,
      ...
      quickQuestions: [
        ...
        { question: `Asit yağmurlarının ana nedeni nedir?`, options: [`Hava kirliliği`, `Yer çekimi`, `Buharlaşma`, `Fotosentez`], correctIndex: 0 },
        ...
        { question: `Yangın söndürmek için kullanılan gaz hangisidir?`, options: [`Karbondioksit`, `Oksijen`, `Hidrojen`, `Helyum`], correctIndex: 0 },
      ],
    },
    {
      id: "basit-makineler",
...
Çıkrık, kuyudan su çekmekte kullanılan bir araçtır. Dişliler ve kasnaklar dönme hareketini iletir; birbirine geçen dişlilerde diş sayısı çok olan dişli daha yavaş ama daha güçlü döner.`,
      ...
      quickQuestions: [
        ...
        { question: `Vida (cıvata) hangi basit makinenin uyarlamasıdır?`, options: [`Eğik düzlem`, `Kaldıraç`, `Makara`, `Çark`], correctIndex: 0, explanation: `Eğik düzlem (helezon şeklinde sarılmış)` },
        { question: `Kama hangi basit makinenin uyarlamasıdır?`, options: [`Eğik düzlem`, `Kaldıraç`, `Makara`, `Çark`], correctIndex: 0, explanation: `Eğik düzlem (iki adet karşılıklı)` },
        ...
        { question: `Bayrak direğinde sabit makara kullanılır. Bunun faydası nedir?`, options: [`Bayrağı yukarı çekmek için aşağı doğru kuvvet uygulanır`, `Kuvvetten kazanç sağlar`, `Yoldan kazanç sağlar`, `Hiç faydası yoktur`], correctIndex: 0, explanation: `Bayrağı yukarı çekmek için aşağı doğru kuvvet uygulanır (yön değişir)` },
      ],
    },
    {
...
[örnek] Geri dönüşüm, enerji tasarrufu ve doğanın korunması sürdürülebilirliği destekler.`,
      ...
      quickQuestions: [
        ...
        { question: `Aşağıdakilerden hangisi sera gazı etkisi yapar?`, options: [`Karbondioksit`, `Oksijen`, `Hidrojen`, `Azot`], correctIndex: 0 },
        ...
        { question: `Fotosentezde hangi gaz alınır?`, options: [`Karbondioksit`, `Oksijen`, `Azot`, `Hidrojen`], correctIndex: 0 },
        ...
        { question: `Çevre kirliliğini azaltmak için en etkili davranış nedir?`, options: [`Bireysel ve toplu sorumluluk almak`, `Daha çok atık üretmek`, `Sadece konuşmak`, `Hiçbir şey yapmamak`], correctIndex: 0, explanation: `Bireysel ve toplu sorumluluk almak (3R: Azalt, Tekrar kullan, Geri dönüştür)` },
        { question: `Aşağıdakilerden hangisi sera gazı değildir?`, options: [`Oksijen`, `Karbondioksit`, `Metan`, `Su buharı`], correctIndex: 0 },
        { question: `Termik santral hangi yakıttan elektrik üretir?`, options: [`Fosil yakıt`, `Rüzgâr`, `Güneş`, `Su`], correctIndex: 0, explanation: `Fosil yakıt (kömür, doğal gaz, petrol)` },
...
[örnek] Ütü ve sobada **ısıya**, ampulde **ışığa**, çamaşır makinesi ve vantilatörde **hareket** enerjisine dönüşür.`,
      ...
      quickQuestions: [
        ...
        { question: `Yüklü bir cismin yaklaştırılmasıyla yüksüz cismin yüklenmesine ne denir?`, options: [`Etkiyle elektriklenme`, `Sürtünmeyle`, `Dokunmayla`, `Topraklama`], correctIndex: 0, explanation: `Etkiyle (indüksiyonla) elektriklenme` },
        ...
        { question: `Vantilatörde elektrik enerjisi hangi enerjiye dönüşür?`, options: [`Mekanik enerjisine`, `Isı`, `Işık`, `Kimyasal`], correctIndex: 0 },
        ...
        { question: `Elektrikli aletlerde enerji tasarrufu için ne yapılır?`, options: [`Tasarruflu ampul ve A++ aletler kullanılır`, `Sürekli açık tutulur`, `Eski ampuller kullanılır`, `Sürekli ütü yapılır`], correctIndex: 0 },
      ],
    },
  ],
};
