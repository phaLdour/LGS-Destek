...
[örnek] Fosil yakıt kullanımı → sera gazlarının artışı → küresel ısınma → buzulların erimesi ve deniz seviyesinin yükselmesi.`,
      ...
      quickQuestions: [
        ...
        { question: `Dünya'nın dönme ekseni kaç derece eğiktir?`, options: [`23° 27'`, `45°`, `90°`, `0°`], correctIndex: 0, explanation: `Doğru cevap: 23° 27' (yaklaşık 23,5°)` },
        ...
        { question: `21 Haziran'da Güneş ışınları hangi paralel üzerinde dik açıyla düşer?`, options: [`Yengeç Dönencesi`, `Ekvator`, `Oğlak Dönencesi`, `Kuzey Kutbu`], correctIndex: 0, explanation: `Doğru cevap: Yengeç Dönencesi (23° 27' K)` },
        { question: `21 Aralık'ta Güneş ışınları hangi paralel üzerinde dik açıyla düşer?`, options: [`Oğlak Dönencesi`, `Ekvator`, `Yengeç Dönencesi`, `Güney Kutbu`], correctIndex: 0, explanation: `Doğru cevap: Oğlak Dönencesi (23° 27' G)` },
...
[tuzak] Cinsiyeti belirleyen kromozom **babadan** gelir.`,
      ...
      quickQuestions: [
        ...
        { question: `Bir nükleotit hangi üç birimden oluşur?`, options: [`Şeker + Fosfat + Organik baz`, `Şeker + Protein + Yağ`, `Aminoasit + Glikoz + Su`, `Fosfat + Protein + Yağ`], correctIndex: 0, explanation: `Doğru cevap: Şeker (deoksiriboz) + Fosfat + Organik baz` },
        ...
        { question: `DNA kaç iplikten (zincirden) oluşur?`, options: [`İki iplik`, `Tek iplik`, `Üç iplik`, `Dört iplik`], correctIndex: 0, explanation: `Doğru cevap: İki iplik (çift sarmal)` },
        { question: `DNA molekülünün şekli nasıldır?`, options: [`Çift sarmal`, `Düz çizgi`, `Halka`, `Kare`], correctIndex: 0, explanation: `Doğru cevap: Çift sarmal (helezon)` },
        { question: `Bir DNA ipliğinde Adenin sayısı 100 ise diğer iplikte kaç Timin olur?`, options: [`100`, `50`, `200`, `Bilinemez`], correctIndex: 0, explanation: `Doğru cevap: 100 (A-T eşleşmesi)` },
        { question: `Bir DNA ipliğinde Guanin sayısı 60 ise diğer iplikte kaç Sitozin olur?`, options: [`60`, `30`, `120`, `Bilinemez`], correctIndex: 0, explanation: `Doğru cevap: 60 (G-C eşleşmesi)` },
        ...
        { question: `İnsan vücut hücrelerinde kaç kromozom vardır?`, options: [`46`, `23`, `48`, `44`], correctIndex: 0, explanation: `Doğru cevap: 46 (23 çift)` },
        ...
        { question: `Bebeğin cinsiyetini belirleyen ebeveyn hangisidir?`, options: [`Baba`, `Anne`, `İkisi birlikte eşit`, `Hiçbiri`], correctIndex: 0, explanation: `Doğru cevap: Baba (X veya Y verir)` },
        ...
        { question: `Saf döl olarak iki çekinik gen birleştiğinde ortaya çıkan karaktere ne denir?`, options: [`Çekinik`, `Baskın`, `Mutant`, `Modifikasyon`], correctIndex: 0, explanation: `Doğru cevap: Çekinik (resesif)` },
        { question: `Aynı genleri taşıyan birey için kullanılan terim hangisidir?`, options: [`Homozigot`, `Heterozigot`, `Mutant`, `Modifikasyon`], correctIndex: 0, explanation: `Doğru cevap: Homozigot (saf döl)` },
        { question: `Farklı alelleri taşıyan birey için kullanılan terim hangisidir?`, options: [`Heterozigot`, `Homozigot`, `Mutant`, `Modifikasyon`], correctIndex: 0, explanation: `Doğru cevap: Heterozigot (melez)` },
        ...
        { question: `Aşağıdakilerden hangisi biyoteknoloji uygulamasıdır?`, options: [`GDO`, `Buz çözme`, `Resim çizme`, `Buharlaşma`], correctIndex: 0, explanation: `Doğru cevap: GDO (genetiği değiştirilmiş organizma)` },
        ...
        { question: `Genler hangi büyük yapı içinde bulunur?`, options: [`Kromozom`, `Sitoplazma`, `Hücre zarı`, `Ribozom`], correctIndex: 0, explanation: `Doğru cevap: Kromozom (DNA üzerinde)` },
        { question: `Saf döl baskın × saf döl çekinik çaprazlamasında (F1) yavruların fenotipi nasıl olur?`, options: [`Hepsi baskın görünümlü`, `Hepsi çekinik`, `3 baskın : 1 çekinik`, `Yarı yarıya`], correctIndex: 0, explanation: `Doğru cevap: Hepsi baskın görünümlü (heterozigot)` },
        { question: `Heterozigot bir bireyin gametleri nasıldır?`, options: [`İki farklı tip alel taşır`, `Aynı alel`, `Hiç alel taşımaz`, `Üç farklı alel taşır`], correctIndex: 0, explanation: `Doğru cevap: İki farklı tip alel taşır (Aa → A ve a)` },
...
[tuzak] "Yükseğe çıkınca açık hava basıncı artar" yanlıştır; azalır.`,
      ...
      quickQuestions: [
        ...
        { question: `Sıvının ağırlığı sıvı basıncına etki eder mi?`, options: [`Hayır`, `Evet, doğrudan`, `Evet, ters orantılı`, `Sadece okyanusta`], correctIndex: 0, explanation: `Doğru cevap: Hayır (ağırlık değil; yükseklik, yoğunluk ve g önemli)` },
        { question: `Dünya'nın etrafını saran hava tabakasına ne denir?`, options: [`Atmosfer`, `Litosfer`, `Hidrosfer`, `Biyosfer`], correctIndex: 0 },
        { question: `Atmosferin yeryüzüne yaptığı basınca ne denir?`, options: [`Açık hava basıncı`, `Sıvı basıncı`, `Katı basıncı`, `Kapalı kap basıncı`], correctIndex: 0, explanation: `Doğru cevap: Açık hava basıncı (atmosfer basıncı)` },
        ...
        { question: `Gaz basıncı gaz moleküllerinin neyiyle ilişkilidir?`, options: [`Hareketleri`, `Renkleri`, `Boyutları`, `Yoğunlukları yalnız`], correctIndex: 0, explanation: `Doğru cevap: Hareketleri (çarpışmaları)` },
        ...
        { question: `Hidrolik sistemler hangi sıvının basıncını kullanır?`, options: [`Sıvı`, `Hava`, `Su buharı`, `Cıva`], correctIndex: 0, explanation: `Doğru cevap: Sıvı (genelde yağ)` },
...
[tuzak] "Saf su kaynarken sıcaklığı sürekli artar" yanlıştır; hâl değişiminde sıcaklık sabittir.`,
      ...
      quickQuestions: [
        ...
        { question: `Aşağıdakilerden hangisi soygazdır?`, options: [`Helyum`, `Demir`, `Bakır`, `Klor`], correctIndex: 0, explanation: `Doğru cevap: Helyum (He)` },
        ...
        { question: `Soygazların kimyasal aktiflikleri nasıldır?`, options: [`Çok düşüktür`, `Çok yüksektir`, `Orta düzeydedir`, `Soygazlar bileşik yapar`], correctIndex: 0, explanation: `Doğru cevap: Çok düşüktür (kararlıdır)` },
        ...
        { question: `Aşağıdakilerden hangisi günlük yaşamda kullanılan bir asittir?`, options: [`Sirke`, `Karbonat`, `Sabun`, `Çamaşır sodası`], correctIndex: 0, explanation: `Doğru cevap: Sirke (asetik asit)` },
        ...
        { question: `Asit yağmurlarının ana nedeni nedir?`, options: [`Hava kirliliği`, `Yer çekimi`, `Buharlaşma`, `Fotosentez`], correctIndex: 0, explanation: `Doğru cevap: Hava kirliliği (SO₂, NOx)` },
        { question: `Mide asidi hangi asittir?`, options: [`Hidroklorik asit`, `Sülfürik asit`, `Asetik asit`, `Karbonik asit`], correctIndex: 0, explanation: `Doğru cevap: Hidroklorik asit (HCl)` },
        ...
        { question: `Aşağıdakilerden hangisi karışım değildir?`, options: [`Su`, `Hava`, `Tuzlu su`, `Çay`], correctIndex: 0, explanation: `Doğru cevap: Su (H₂O)` },
        ...
        { question: `Su + alkol karışımı nasıl ayrılır?`, options: [`Damıtma`, `Mıknatıs`, `Süzme`, `Eleme`], correctIndex: 0, explanation: `Doğru cevap: Damıtma (kaynama noktası farkı)` },
        ...
        { question: `Yangın söndürmek için kullanılan gaz hangisidir?`, options: [`Karbondioksit`, `Oksijen`, `Hidrojen`, `Helyum`], correctIndex: 0, explanation: `Doğru cevap: Karbondioksit (CO₂)` },
      ],
    },
    {
      id: "basit-makineler",
...
Çıkrık, kuyudan su çekmekte kullanılan bir araçtır. Dişliler ve kasnaklar dönme hareketini iletir; birbirine geçen dişlilerde diş sayısı çok olan dişli daha yavaş ama daha güçlü döner.`,
      ...
      quickQuestions: [
        ...
        { question: `Hareketli makara aşağıdakilerden hangisini sağlar?`, options: [`Kuvvetten kazanç`, `Yoldan kazanç`, `Hızdan kazanç`, `İşten kazanç`], correctIndex: 0, explanation: `Doğru cevap: Kuvvetten kazanç (yarıya iner)` },
        ...
        { question: `Eğik düzlem bir basit makinedir; aşağıdakilerden hangisini sağlar?`, options: [`Kuvvetten kazanç`, `Yoldan kazanç`, `Yön değişimi yalnız`, `İşten kazanç`], correctIndex: 0, explanation: `Doğru cevap: Kuvvetten kazanç (yoldan kayıp)` },
        ...
        { question: `Vida (cıvata) hangi basit makinenin uyarlamasıdır?`, options: [`Eğik düzlem`, `Kaldıraç`, `Makara`, `Çark`], correctIndex: 0, explanation: `Doğru cevap: Eğik düzlem (helezon şeklinde sarılmış)` },
        { question: `Kama hangi basit makinenin uyarlamasıdır?`, options: [`Eğik düzlem`, `Kaldıraç`, `Makara`, `Çark`], correctIndex: 0, explanation: `Doğru cevap: Eğik düzlem (iki adet karşılıklı)` },
        { question: `Balta, bıçak ve testere hangi basit makineye dayanır?`, options: [`Kama`, `Kaldıraç`, `Makara`, `Çark`], correctIndex: 0, explanation: `Doğru cevap: Kama (eğik düzlem)` },
        { question: `Çıkrık hangi basit makinedir?`, options: [`Çark / dingilin birleşimi`, `Kaldıraç`, `Makara`, `Eğik düzlem`], correctIndex: 0 },
        { question: `Bisiklet pedalı + dişlisi hangi basit makineye dayanır?`, options: [`Çark-dingil`, `Eğik düzlem`, `Makara`, `Kama`], correctIndex: 0, explanation: `Doğru cevap: Çark-dingil (volan-mil)` },
        ...
        { question: `Basit makine kullanırken kuvvetten kazanç olduğunda yol nasıl olur?`, options: [`Artar`, `Azalır`, `Değişmez`, `Sıfır olur`], correctIndex: 0, explanation: `Doğru cevap: Artar (yoldan kayıp)` },
        ...
        { question: `Eğik düzlemde uygulanan kuvvetin minimum olması için eğim ne olmalı?`, options: [`Mümkün olduğunca küçük olmalı`, `Mümkün olduğunca büyük olmalı`, `Eğim önemli değil`, `Eğim 90° olmalı`], correctIndex: 0, explanation: `Doğru cevap: Mümkün olduğunca küçük olmalı (yol uzun)` },
        ...
        { question: `Düz yola dik vurulmuş bir çivinin çıkarılmasında en uygun basit makine hangisidir?`, options: [`Kaldıraç`, `Eğik düzlem`, `Makara`, `Vida`], correctIndex: 0, explanation: `Doğru cevap: Kaldıraç (kerpeten, çekiç tırnağı)` },
        ...
        { question: `Bir eğik düzlemin yüksekliği h, uzunluğu L ise, F·L = W·h ifadesi neyi gösterir?`, options: [`İş eşitliği`, `Yer değişimi`, `Hız eşitliği`, `Sürtünme eşitliği`], correctIndex: 0, explanation: `Doğru cevap: İş eşitliği (enerjinin korunumu)` },
        ...
        { question: `Bayrak direğinde sabit makara kullanılır. Bunun faydası nedir?`, options: [`Bayrağı yukarı çekmek için aşağı doğru kuvvet uygulanır`, `Kuvvetten kazanç sağlar`, `Yoldan kazanç sağlar`, `Hiç faydası yoktur`], correctIndex: 0, explanation: `Doğru cevap: Bayrağı yukarı çekmek için aşağı doğru kuvvet uygulanır (yön değişir)` },
      ],
    },
    {
...
[örnek] Geri dönüşüm, enerji tasarrufu ve doğanın korunması sürdürülebilirliği destekler.`,
      ...
      quickQuestions: [
        ...
        { question: `Bisiklet dinamosu hangi enerji dönüşümünü gerçekleştirir?`, options: [`Hareket → Elektrik`, `Elektrik → Hareket`, `Isı → Elektrik`, `Ses → Elektrik`], correctIndex: 0, explanation: `Doğru cevap: Hareket (kinetik) → Elektrik` },
        { question: `Jeneratör (generator) hangi dönüşümle elektrik üretir?`, options: [`Hareket enerjisi → Elektrik enerjisi`, `Elektrik → Hareket`, `Işık → Elektrik`, `Ses → Elektrik`], correctIndex: 0 },
        { question: `Termik santralde hangi dönüşüm sıralaması vardır?`, options: [`Kimyasal (yakıt) → Isı → Kinetik (buhar) → Elektrik`, `Sadece elektrik`, `Sadece ısı`, `Sadece kinetik`], correctIndex: 0 },
        ...
        { question: `Güneş panellerinde hangi dönüşüm gerçekleşir?`, options: [`Güneş → Elektrik`, `Elektrik → Işık`, `Kinetik → Elektrik`, `Isı → Elektrik`], correctIndex: 0, explanation: `Doğru cevap: Güneş (ışık) → Elektrik` },
        { question: `Rüzgâr türbinlerinde hangi dönüşüm gerçekleşir?`, options: [`Kinetik → Elektrik`, `Elektrik → Kinetik`, `Isı → Elektrik`, `Kimyasal → Elektrik`], correctIndex: 0, explanation: `Doğru cevap: Kinetik (rüzgâr) → Elektrik` },
        ...
        { question: `Aşağıdakilerden hangisi sera gazı etkisi yapar?`, options: [`Karbondioksit`, `Oksijen`, `Hidrojen`, `Azot`], correctIndex: 0, explanation: `Doğru cevap: Karbondioksit (CO₂)` },
        ...
        { question: `Enerji tasarrufu için aşağıdakilerden hangisi yapılmalıdır?`, options: [`Tasarruflu ampul kullanmak`, `Tüm ışıkları sürekli açık tutmak`, `Aşırı klima kullanmak`, `Sürekli ütü kullanmak`], correctIndex: 0, explanation: `Doğru cevap: Tasarruflu (LED) ampul kullanmak` },
        ...
        { question: `Bir besin zincirinin ilk halkası daima nedir?`, options: [`Üretici`, `Otçul`, `Etçil`, `Ayrıştırıcı`], correctIndex: 0, explanation: `Doğru cevap: Üretici (bitki)` },
        ...
        { question: `Fotosentezde hangi gaz alınır?`, options: [`Karbondioksit`, `Oksijen`, `Azot`, `Hidrojen`], correctIndex: 0, explanation: `Doğru cevap: Karbondioksit (CO₂)` },
        { question: `Fotosentezde hangi gaz salınır?`, options: [`Oksijen`, `Karbondioksit`, `Azot`, `Hidrojen`], correctIndex: 0, explanation: `Doğru cevap: Oksijen (O₂)` },
        ...
        { question: `Çevre kirliliğini azaltmak için en etkili davranış nedir?`, options: [`Bireysel ve toplu sorumluluk almak`, `Daha çok atık üretmek`, `Sadece konuşmak`, `Hiçbir şey yapmamak`], correctIndex: 0, explanation: `Doğru cevap: Bireysel ve toplu sorumluluk almak (3R: Azalt, Tekrar kullan, Geri dönüştür)` },
        { question: `Aşağıdakilerden hangisi sera gazı değildir?`, options: [`Oksijen`, `Karbondioksit`, `Metan`, `Su buharı`], correctIndex: 0 },
        { question: `Termik santral hangi yakıttan elektrik üretir?`, options: [`Fosil yakıt`, `Rüzgâr`, `Güneş`, `Su`], correctIndex: 0, explanation: `Doğru cevap: Fosil yakıt (kömür, doğal gaz, petrol)` },
        ...
        { question: `Aşağıdakilerden hangisi enerji dönüşümüne örnektir?`, options: [`Pil → Ampul`, `Sadece pil`, `Sadece ampul`, `Sadece bağlantı`], correctIndex: 0, explanation: `Doğru cevap: Pil → Ampul (kimyasal → ışık ve ısı)` },
...
[örnek] Ütü ve sobada **ısıya**, ampulde **ışığa**, çamaşır makinesi ve vantilatörde **hareket** enerjisine dönüşür.`,
      ...
      quickQuestions: [
        ...
        { question: `Nötronun yükü nasıldır?`, options: [`Yüksüz`, `Pozitif`, `Negatif`, `Değişken`], correctIndex: 0, explanation: `Doğru cevap: Yüksüz (nötr)` },
        ...
        { question: `Yüklü bir cismin yaklaştırılmasıyla yüksüz cismin yüklenmesine ne denir?`, options: [`Etkiyle elektriklenme`, `Sürtünmeyle`, `Dokunmayla`, `Topraklama`], correctIndex: 0, explanation: `Doğru cevap: Etkiyle (indüksiyonla) elektriklenme` },
        ...
        { question: `Vantilatörde elektrik enerjisi hangi enerjiye dönüşür?`, options: [`Mekanik enerjisine`, `Isı`, `Işık`, `Kimyasal`], correctIndex: 0, explanation: `Doğru cevap: Mekanik (hareket) enerjisine` },
        ...
        { question: `Devrede akım yönü hangi yönde kabul edilir?`, options: [`Pozitiften negatife`, `Negatiften pozitife`, `Aşağı`, `Yukarı`], correctIndex: 0, explanation: `Doğru cevap: Pozitiften negatife (geleneksel)` },
        ...
        { question: `Elektrikli aletlerde enerji tasarrufu için ne yapılır?`, options: [`Tasarruflu ampul ve A++ aletler kullanılır`, `Sürekli açık tutulur`, `Eski ampuller kullanılır`, `Sürekli ütü yapılır`], correctIndex: 0, explanation: `Doğru cevap: Tasarruflu (LED) ampul ve A++ aletler kullanılır` },
      ],
    },
  ],
};
