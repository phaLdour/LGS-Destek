...
[soru] "Sınava çalışmadan 'kaderimde ne varsa o olur' demek" tevekkülün **yanlış** anlaşılmasıdır.`,
      ...
      quiz: [
        ...
        { question: `İnsanın yaptıklarından sorumlu tutulmasının temel sebebi nedir?`, options: [`Seçme özgürlüğünün olması`, `Zengin olması`, `Çevresi`, `Şansı`], correctIndex: 0 },
      ],
      quickQuestions: [
...
[soru] Zekât, sadaka, hac ve kurbanın ortak toplumsal faydası → **yardımlaşma ve paylaşmayı** artırmaktır.`,
      ...
      quiz: [
        { question: `Zekât kimlere farzdır?`, options: [`Her Müslümana`, `Belirli zenginliğe ulaşan Müslümana`, `Sadece erkeklere`, `Çocuklara`], correctIndex: 1 },
