...
[soru] "Sınava çalışmadan 'kaderimde ne varsa o olur' demek" tevekkülün **yanlış** anlaşılmasıdır.`,
      ...
      quickQuestions: [
        ...
        { question: `"Çalışan demir paslanmaz" deyimi hangi inançla uyumludur?`, options: [`Tembelliğe teşvik`, `Çaba ve emek (tevekkülle birlikte)`, `Kaderi inkâr`, `Şansa güven`], correctIndex: 1 },
...
[soru] Zekât, sadaka, hac ve kurbanın ortak toplumsal faydası → **yardımlaşma ve paylaşmayı** artırmaktır.`,
      ...
      quickQuestions: [
        ...
        { question: `Zekâtın temel oranı kaçtır?`, options: [`1/40 (kırkta bir)`, `1/10`, `1/2`, `1/4`], correctIndex: 0 },
        ...
        { question: `Zekât verilecek 8 grup Kur'an'ın hangi suresinde belirtilmiştir?`, options: [`Bakara`, `Tevbe (Tevbe 60)`, `Mâide`, `Yâsîn`], correctIndex: 1 },
        ...
        { question: `Zekât akrabalara verilebilir mi?`, options: [`Hayır`, `Evet (anne-baba ve eş hariç)`, `Sadece kardeşe`, `Hiçbir yakına verilmez`], correctIndex: 1 },
...
[soru] "Aklı korumak amacıyla hangisi yasaklanmıştır?" → içki ve uyuşturucu.`,
      ...
      quickQuestions: [
        ...
        { question: `"Temizlik imanın yarısıdır" sözü kime aittir?`, options: [`Hz. Ömer`, `Hz. Muhammed (hadis)`, `Hz. Ebubekir`, `İmam Şafii`], correctIndex: 1 },
...
[soru] "Peygamberimize peygamberlikten önce verilen unvan?" → Muhammedü'l-Emin (güvenilir).`,
      ...
      quickQuestions: [
        ...
        { question: `"İnsanlar arasında en adil davran" emri kimden gelir?`, options: [`Allah'tan (Kur'an)`, `Hz. Ömer'den`, `Filozoflardan`, `Sahabelerden`], correctIndex: 0 },
