...
[soru] "Sınava çalışmadan 'kaderimde ne varsa o olur' demek" tevekkülün **yanlış** anlaşılmasıdır.`,
      ...
      quiz: [
        ...
        { question: `İnsanın yaptıklarından sorumlu tutulmasının temel sebebi nedir?`, options: [`Seçme özgürlüğünün olması`, `Zengin olması`, `Çevresi`, `Şansı`], correctIndex: 0, explanation: `Doğru cevap: Seçme özgürlüğünün (iradesinin) olması` },
      ],
      quickQuestions: [
        ...
        { question: `"Her şey kaderdir, ben ne yapsam değişmez" düşüncesi neden yanlıştır?`, options: [`İnsanın iradesi yoktur`, `İnsanın iradesi ve sorumluluğu vardır`, `Allah belirlemez`, `Şans her şeyi belirler`], correctIndex: 1 },
        ...
        { question: `Sınava çalışmadan "kaderimde varsa kazanırım" demek hangi yanlışı içerir?`, options: [`Tevekkülün yanlış anlaşılması`, `Kader-kaza karışıklığı`, `Yasa-kural karışıklığı`, `Yanlış yoktur`], correctIndex: 0 },
        ...
        { question: `Aşağıdakilerden hangisi insanın sorumluluğunun şartlarından DEĞİLDİR?`, options: [`Akıl`, `İrade`, `Bilinç`, `Zenginlik`], correctIndex: 3 },
        { question: `Tevekkül eden bir öğrencinin sınavdan önce yapması gereken nedir?`, options: [`Hiç çalışmamak`, `Çalışıp sonra Allah'a güvenmek`, `Yalnız şans dilemek`, `Beklemek`], correctIndex: 1 },
        ...
        { question: `Sünnetullah ne anlama gelir?`, options: [`Peygamberin sünnetleri`, `Allah'ın evrene koyduğu değişmez yasalar`, `İslam'ın 5 şartı`, `Cuma namazı`], correctIndex: 1 },
        { question: `Hangisi insan iradesinin gücünü gösterir?`, options: [`Doğa olayları`, `Mevsim değişimi`, `Eğitim ve meslek seçimi`, `Yer çekimi`], correctIndex: 2 },
        ...
        { question: `Müslüman bir öğrencinin sınava hazırlığı nasıl olmalıdır?`, options: [`Sadece dua etmek`, `Hem çalışmak hem dua etmek`, `Sadece çalışmak`, `Hiç hazırlanmamak`], correctIndex: 1 },
        { question: `Aşağıdakilerden hangisi toplumsal yasaya örnektir?`, options: [`Suyun kaynaması`, `Bitkinin büyümesi`, `Birlikten kuvvet doğması`, `Yer çekimi`], correctIndex: 2 },
        { question: `Allah'ın gücünün sınırı var mıdır?`, options: [`Vardır`, `Yoktur, sınırsızdır`, `Bazen vardır`, `Bilinmez`], correctIndex: 1 },
        { question: `"Çalışan demir paslanmaz" deyimi hangi inançla uyumludur?`, options: [`Tembelliğe teşvik`, `Çaba ve emek`, `Kaderi inkâr`, `Şansa güven`], correctIndex: 1, explanation: `Doğru cevap: Çaba ve emek (tevekkülle birlikte)` },
        { question: `Kader inancı insanı nasıl etkiler?`, options: [`Sorumsuz yapar`, `Tedbir alıp tevekkül etmeye yöneltir`, `Tembelleştirir`, `Korkutur`], correctIndex: 1 },
      ],
    },
    {
      id: "zekat-sadaka-hac",
...
[soru] Zekât, sadaka, hac ve kurbanın ortak toplumsal faydası → **yardımlaşma ve paylaşmayı** artırmaktır.`,
      ...
      quiz: [
        { question: `Zekât kimlere farzdır?`, options: [`Her Müslümana`, `Belirli zenginliğe ulaşan Müslümana`, `Sadece erkeklere`, `Çocuklara`], correctIndex: 1, explanation: `Doğru cevap: Belirli zenginliğe (nisaba) ulaşan Müslümana` },
        { question: `Zekâtın temel oranı nedir?`, options: [`Kırkta bir`, `Yarısı`, `Dörtte biri`, `Tamamı`], correctIndex: 0, explanation: `Doğru cevap: Kırkta bir (1/40)` },
        { question: `Karşılık beklemeden yapılan gönüllü yardıma ne denir?`, options: [`Zekât`, `Sadaka`, `Hac`, `Nisap`], correctIndex: 1 },
        { question: `Hac ibadeti nerede yapılır?`, options: [`Medine`, `Mekke`, `Kudüs`, `İstanbul`], correctIndex: 1, explanation: `Doğru cevap: Mekke (Kâbe)` },
      ...
      quickQuestions: [
        { question: `Zekât kimlere farzdır?`, options: [`Her Müslümana`, `Nisaba ulaşan zengin Müslümana`, `Sadece erkeklere`, `Çocuklara`], correctIndex: 1 },
        { question: `Zekâtın temel oranı kaçtır?`, options: [`1/40`, `1/10`, `1/2`, `1/4`], correctIndex: 0, explanation: `Doğru cevap: 1/40 (kırkta bir)` },
        ...
        { question: `Zekât verilecek 8 grup Kur'an'ın hangi suresinde belirtilmiştir?`, options: [`Bakara`, `Tevbe`, `Mâide`, `Yâsîn`], correctIndex: 1, explanation: `Doğru cevap: Tevbe (Tevbe 60)` },
        ...
        { question: `Kurban etinin paylaşımı genelde nasıldır?`, options: [`Hepsi ev halkına`, `1/3 ev, 1/3 akraba, 1/3 fakir`, `Sadece fakirlere`, `Yarı yarı`], correctIndex: 1 },
        ...
        { question: `Zekât ne tür mallardan verilir?`, options: [`Tüketilmiş mal`, `Nisaba ulaşan ve yıllanan mal`, `Hediye gelen mal`, `Henüz alınan mal`], correctIndex: 1 },
        { question: `Zekât akrabalara verilebilir mi?`, options: [`Hayır`, `Evet`, `Sadece kardeşe`, `Hiçbir yakına verilmez`], correctIndex: 1, explanation: `Doğru cevap: Evet (anne-baba ve eş hariç)` },
        { question: `Aşağıdakilerden hangisi zekât niyetiyle verilen olamaz?`, options: [`Para`, `Tahıl`, `Altın`, `Borç`], correctIndex: 3 },
        { question: `Umre ile hac arasındaki temel fark nedir?`, options: [`Umre farz, hac sünnet`, `Hac belirli zamanda, umre yılın her zamanı`, `Aynı şey`, `Umre Medine'de`], correctIndex: 1 },
        ...
        { question: `Hac ibadetinin en önemli rüknü nedir?`, options: [`Sa'y`, `Tavaf`, `Arafat'ta vakfe`, `İhrama girme`], correctIndex: 2 },
        { question: `Kurban kesmek kimlere vacip olur?`, options: [`Çocuğa`, `Fakire`, `Nisaba ulaşan zengin Müslümana`, `Sadece erkeklere`], correctIndex: 2 },
        ...
        { question: `Zekât oranı malın yüzde kaçıdır?`, options: [`%1`, `%2,5`, `%5`, `%10`], correctIndex: 1 },
        { question: `Hac'da Arafat'a çıkma günü hangisidir?`, options: [`Zilhicce 1`, `Zilhicce 9`, `Şevval 1`, `Ramazan 27`], correctIndex: 1 },
        { question: `Aşağıdakilerden hangisi paylaşma-yardımlaşma ibadeti DEĞİLDİR?`, options: [`Zekât`, `Sadaka`, `Kurban`, `Cuma namazı`], correctIndex: 3 },
      ],
    },
    {
      id: "din-ve-hayat",
...
[soru] "Aklı korumak amacıyla hangisi yasaklanmıştır?" → içki ve uyuşturucu.`,
      ...
      quickQuestions: [
        ...
        { question: `Zinanın yasak olması hangi değeri korur?`, options: [`Can`, `Nesil`, `Akıl`, `Mal`], correctIndex: 1 },
        ...
        { question: `İslam'da temizlik kaç boyutludur?`, options: [`Yalnız beden`, `Yalnız çevre`, `Hem maddi hem manevi`, `Yalnız manevi`], correctIndex: 2 },
        { question: `"Temizlik imanın yarısıdır" sözü kime aittir?`, options: [`Hz. Ömer`, `Hz. Muhammed`, `Hz. Ebubekir`, `İmam Şafii`], correctIndex: 1, explanation: `Doğru cevap: Hz. Muhammed (hadis)` },
        { question: `Aşağıdakilerden hangisi manevi temizlik örneğidir?`, options: [`El yıkamak`, `Kötü huylardan arınmak`, `Diş fırçalamak`, `Saç taramak`], correctIndex: 1 },
        ...
        { question: `Dinin bireye en temel kazandırdığı şey nedir?`, options: [`Zenginlik`, `Ahlaki değerler`, `Güç`, `Ünlü olmak`], correctIndex: 1 },
        ...
        { question: `"Komşusu açken tok yatan bizden değildir" hadisi hangi değeri vurgular?`, options: [`Bencillik`, `Dayanışma ve komşuluk`, `Zenginlik`, `Bireysellik`], correctIndex: 1 },
        { question: `Hangisi dürüstlüğün karşıtıdır?`, options: [`Doğruluk`, `Samimiyet`, `Yalan`, `Adalet`], correctIndex: 2 },
        { question: `Hangisi adaletin gereğidir?`, options: [`Herkese hakkını vermek`, `Tarafgirlik`, `Ayrımcılık`, `Kayırma`], correctIndex: 0 },
        ...
        { question: `Çevre temizliği hangi değere katkı sağlar?`, options: [`Yalnız bireysel`, `Toplumsal sağlık ve huzur`, `Hiçbir şey`, `Yalnız ekonomi`], correctIndex: 1 },
        ...
        { question: `Hangisi manevi temizliği bozar?`, options: [`Tevbe`, `Yalan ve riya`, `Abdest`, `Namaz`], correctIndex: 1 },
        { question: `Hoşgörü ne demektir?`, options: [`Hakaret etmek`, `Affedicilik ve farklılığa saygı`, `Kayıtsız kalmak`, `Ezilmek`], correctIndex: 1 },
        ...
        { question: `Bir kişinin kalbini kötü duygulardan arındırması neye katkı sağlar?`, options: [`Yalnız bireysel mutluluğa`, `Hem bireysel hem toplumsal huzura`, `Sadece dış görünüşe`, `Hiç kimseye`], correctIndex: 1 },
        ...
        { question: `Hangisi dinin yasakladığı bir davranıştır?`, options: [`Yardımlaşma`, `Adalet`, `Yalan söylemek`, `Saygı`], correctIndex: 2 },
        { question: `Bir Müslüman'ın hayatına din nasıl yön verir?`, options: [`Yalnız ibadetler`, `Ahlak, davranış ve ilişkiler dahil tüm yaşam`, `Yalnız özel günlerde`, `Hiçbir şekilde`], correctIndex: 1 },
        { question: `Dinin tanımladığı "iyi insan" kimdir?`, options: [`Zengin olan`, `Ahlaklı, dürüst ve faydalı olan`, `Güçlü olan`, `Ünlü olan`], correctIndex: 1 },
      ],
    },
    {
...
[soru] "Peygamberimize peygamberlikten önce verilen unvan?" → Muhammedü'l-Emin (güvenilir).`,
      ...
      quickQuestions: [
        { question: `Hz. Muhammed'e peygamberlikten önce verilen "güvenilir" anlamındaki unvan?`, options: [`Muhammedü'l-Emin`, `Es-Sıddık`, `El-Faruk`, `El-Fatih`], correctIndex: 0 },
        { question: `Karar alırken çevreyle danışmaya ne denir?`, options: [`İstişare`, `Tevekkül`, `İnfak`, `Tavaf`], correctIndex: 0 },
        ...
        { question: `Hendek Savaşı'nda hendek kazma fikrini kim önerdi?`, options: [`Hz. Ebubekir`, `Hz. Ömer`, `Selman-ı Farisi`, `Hz. Osman`], correctIndex: 2 },
        { question: `Mekke fethinde Hz. Muhammed kendisine kötülük edenlere ne yaptı?`, options: [`Cezalandırdı`, `Genel af ilan etti`, `Sürdü`, `Yargıladı`], correctIndex: 1 },
        ...
        { question: `"İnsanlar arasında en adil davran" emri kimden gelir?`, options: [`Allah'tan`, `Hz. Ömer'den`, `Filozoflardan`, `Sahabelerden`], correctIndex: 0, explanation: `Doğru cevap: Allah'tan (Kur'an)` },
        { question: `Hz. Muhammed Tâif'te taşlanınca ne yaptı?`, options: [`Beddua etti`, `Sabretti, halk için hayır diledi`, `Şikâyet etti`, `Hemen Mekke'ye döndü`], correctIndex: 1 },
        ...
        { question: `Müslümanların ilk hicret ettiği yer?`, options: [`Habeşistan`, `Yemen`, `Mısır`, `Şam`], correctIndex: 0 },
        { question: `Hz. Muhammed'in Mekke'den Medine'ye göç etmesine ne denir?`, options: [`Tevbe`, `Hicret`, `İsra`, `Mirac`], correctIndex: 1 },
        { question: `"Muhammedü'l-Emin" ne anlama gelir?`, options: [`Güvenilir`, `Zengin`, `Güçlü`, `Cesur`], correctIndex: 0 },
        { question: `Hz. Muhammed çocuklara karşı nasıldı?`, options: [`Sert`, `Şefkatli ve sevgiyle dolu`, `İlgisiz`, `Mesafeli`], correctIndex: 1 },
        { question: `Hz. Muhammed'in ahlakını öven ayet hangi suredendir?`, options: [`Bakara 1`, `Kalem 4 - "Sen yüce bir ahlak üzeresin"`, `Yâsîn 1`, `İhlas 4`], correctIndex: 1 },
        { question: `Aşağıdakilerden hangisi Hz. Muhammed'in özelliği DEĞİLDİR?`, options: [`Dürüstlük`, `Merhamet`, `Kibir`, `Adalet`], correctIndex: 2 },
        { question: `Hz. Muhammed hayvanlara nasıl davranırdı?`, options: [`İlgisizdi`, `Şefkatle, eziyet etmemeye dikkat ederdi`, `Kıyıcıydı`, `Sömürürdü`], correctIndex: 1 },
        ...
        { question: `Hz. Muhammed'in vefatından sonra ilk halife kim oldu?`, options: [`Hz. Ali`, `Hz. Ömer`, `Hz. Ebubekir`, `Hz. Osman`], correctIndex: 2 },
        { question: `Hz. Muhammed antlaşmalara nasıl davranırdı?`, options: [`Verdiği sözü tutardı`, `Bozardı`, `Önemsemezdi`, `Zorla bozdururdu`], correctIndex: 0 },
        { question: `Hz. Muhammed savaş öncesi mevzi seçiminde sahabenin görüşünü tercih etmesi hangi özelliğinin örneğidir?`, options: [`Cesaret`, `İstişare ve tevazu`, `Korku`, `Bilgisizlik`], correctIndex: 1 },
        { question: `Hz. Muhammed'in en kıymetli mirası nedir?`, options: [`Mal`, `Mülk`, `Kur'an ve güzel ahlak`, `Saray`], correctIndex: 2 },
      ],
    },
    {
...
[soru] "İlk inen emir hangisidir?" → "Oku" (Alak suresi).`,
      ...
      quickQuestions: [
        ...
        { question: `Kur'an-ı Kerim hangi peygambere indirilmiştir?`, options: [`Hz. Muhammed`, `Hz. İsa`, `Hz. Musa`, `Hz. Davud`], correctIndex: 0 },
        { question: `Kur'an hangi dilde indirilmiştir?`, options: [`Arapça`, `Türkçe`, `Farsça`, `İbranice`], correctIndex: 0 },
        { question: `Kur'an-ı Kerim hangi halife döneminde kitap haline getirilmiştir?`, options: [`Hz. Ebubekir`, `Hz. Ömer`, `Hz. Osman`, `Hz. Ali`], correctIndex: 0 },
        ...
        { question: `Aşağıdakilerden hangisi Kur'an'ın temel konularından biri DEĞİLDİR?`, options: [`Spor kuralları`, `İnanç`, `İbadet`, `Ahlak`], correctIndex: 0 },
        { question: `Kur'an'ın günümüze kadar değişmeden gelmesinin temel sebebi nedir?`, options: [`Allah'ın koruması ve hafızlar`, `Tesadüf`, `Tek nüsha olması`, `Az okunması`], correctIndex: 0 },
        ...
        { question: `Kur'an'a göre insanın yaratılış amacı nedir?`, options: [`Allah'a kulluk etmek`, `Mal biriktirmek`, `Eğlenmek`, `Sadece çalışmak`], correctIndex: 0 },
        { question: `Kur'an okumadan önce söylenen söz hangisidir?`, options: [`Eûzü-besmele`, `Salavat`, `Tekbir`, `Tahmid`], correctIndex: 0 },
        { question: `"Besmele" hangi sözün kısaltmasıdır?`, options: [`Bismillahirrahmanirrahim`, `Elhamdülillah`, `Subhanallah`, `Allahüekber`], correctIndex: 0 },
