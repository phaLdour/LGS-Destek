...
[örnek] **Selanik** (çok kültürlü yapı, fikir akımları), **Manastır** (askerî ortam, milliyetçilik) ve **İstanbul** (siyasi gelişmeler) Mustafa Kemal'i etkiledi.`,
      ...
      quickQuestions: [
        ...
        { question: `Mustafa Kemal Harp Akademisi sonrası ilk görev yeri neresidir?`, options: [`Şam (Suriye)`, `İstanbul`, `Selanik`, `İzmir`], correctIndex: 0 },
        ...
        { question: `Trablusgarp Savaşı sonunda imzalanan antlaşma hangisidir?`, options: [`Uşi Antlaşması (1912)`, `Lozan`, `Sevr`, `Mondros`], correctIndex: 0 },
        { question: `Mustafa Kemal'i dünyaca tanıtan savaş hangisidir?`, options: [`Çanakkale Savaşı (1915)`, `Trablusgarp`, `İnönü`, `Sakarya`], correctIndex: 0 },
        ...
        { question: `Çanakkale Savaşı sonucunda hangi olaylar ertelenmiştir?`, options: [`Rusya'da Bolşevik İhtilali ve I. Dünya Savaşı'nın bitişi etkilenmiştir`, `Trablusgarp`, `Balkan Savaşları`, `Sevr Antlaşması`], correctIndex: 0 },
        { question: `Mustafa Kemal Çanakkale'de hangi rütbededir?`, options: [`Yarbay (sonradan Albay)`, `Teğmen`, `General`, `Mareşal`], correctIndex: 0 },
        ...
        { question: `Mondros Antlaşması hangi devletle imzalanmıştır?`, options: [`İtilaf Devletleri (İngiltere, Fransa, İtalya)`, `Sadece İngiltere`, `Sadece Almanya`, `Rusya`], correctIndex: 0 },
        { question: `Mondros Antlaşmasının en tehlikeli maddesi hangisidir?`, options: [`7. madde (İtilaf Devletleri istedikleri yeri işgal edebilecek)`, `1. madde`, `2. madde`, `5. madde`], correctIndex: 0 },
        { question: `Mondros Antlaşmasından sonra Mustafa Kemal'in görevi nedir?`, options: [`9. Ordu Müfettişliği (Samsun'a görevlendirildi)`, `Başkomutanlık`, `Genelkurmay başkanlığı`, `Padişahlık`], correctIndex: 0 },
        ...
        { question: `Mustafa Kemal'in askerî başarıları nedeniyle aldığı ilk önemli unvan nedir?`, options: [`Anafartalar Kahramanı (Çanakkale)`, `Mareşal`, `Gazi`, `Atatürk`], correctIndex: 0 },
        ...
        { question: `Mustafa Kemal Milli Mücadele'yi başlatmadan önce hangi şehirde önemli toplantı yapmıştır?`, options: [`Amasya (Genelgesi)`, `Sivas`, `Erzurum`, `Ankara`], correctIndex: 0 },
      ],
    },
    {
      id: "milli-uyanis",
...
[soru] "Ulusal sınırları belirleyen karar?" → Misak-ı Millî.`,
      ...
      quickQuestions: [
        ...
        { question: `Amasya Genelgesinde "Milletin istikbalini yine milletin azim ve kararı kurtaracaktır" ifadesi neyi belirtir?`, options: [`Milli egemenlik fikrinin doğuşunu`, `Padişah egemenliğini`, `Yabancı yardımını`, `Ordunun bağımsızlığını`], correctIndex: 0 },
        ...
        { question: `Misak-ı Milli kararları hangi mecliste alınmıştır?`, options: [`Son Osmanlı Mebusan Meclisi (28 Ocak 1920)`, `TBMM`, `Sivas Kongresi`, `Lozan`], correctIndex: 0 },
        ...
        { question: `TBMM'nin özelliklerinden biri nedir?`, options: [`Güçler birliği (kuvvetler birliği) ilkesini benimsedi`, `Güçler ayrılığı`, `Padişahlığı korudu`, `Saltanatı sürdürdü`], correctIndex: 0 },
        ...
        { question: `Kuvâ-yı Milliye'nin yerini hangi ordu almıştır?`, options: [`Düzenli Türk Ordusu (TBMM ordusu)`, `Yeniçeri Ocağı`, `Osmanlı Hassa Ordusu`, `İttihatçı ordu`], correctIndex: 0 },
        ...
        { question: `Milli mücadeleyi destekleyen ilk gazete hangisidir?`, options: [`İrade-i Milliye (Sivas)`, `Hâkimiyet-i Milliye`, `Tasvir`, `Tanin`], correctIndex: 0 },
        ...
        { question: `İlk düzenli ordumuzun komutanı kimdir?`, options: [`İsmet (İnönü) Paşa`, `Mustafa Kemal Paşa`, `Fevzi Çakmak`, `Kazım Karabekir`], correctIndex: 0 },
        ...
        { question: `1921 Anayasasında yargı yetkisi kime aittir?`, options: [`TBMM'ye (güçler birliği)`, `Padişaha`, `Sadrazama`, `Halifeye`], correctIndex: 0 },
...
[kural] **Mudanya Ateşkesi (11 Ekim 1922)** silahları susturdu; **Lozan Barış Antlaşması (24 Temmuz 1923)** ile bağımsızlık dünyaca tanındı.`,
      ...
      quickQuestions: [
        ...
        { question: `I. İnönü Savaşı'nın komutanı kimdir?`, options: [`İsmet (İnönü) Paşa`, `Mustafa Kemal Paşa`, `Fevzi Çakmak`, `Kazım Karabekir`], correctIndex: 0 },
        { question: `I. İnönü Savaşı kime karşı yapılmıştır?`, options: [`Yunanistan`, `İngiltere`, `Fransa`, `İtalya`], correctIndex: 0 },
        { question: `I. İnönü Savaşı sonucunda hangi anayasa yapılmıştır?`, options: [`1921 Anayasası (Teşkilat-ı Esasiye)`, `1924 Anayasası`, `1961 Anayasası`, `1982 Anayasası`], correctIndex: 0 },
        ...
        { question: `II. İnönü Zaferi sonrası "Siz orada yalnız düşmanı değil, milletin makus talihini de yendiniz." sözünü kim söylemiştir?`, options: [`Mustafa Kemal (İsmet Paşa'ya)`, `Padişah`, `İsmet Paşa`, `Fevzi Çakmak`], correctIndex: 0 },
        ...
        { question: `Kars Antlaşması hangi devletlerle imzalanmıştır?`, options: [`Sovyet etkisindeki Kafkas Cumhuriyetleri (Azerbaycan, Ermenistan, Gürcistan)`, `Yunanistan`, `İngiltere`, `Almanya`], correctIndex: 0 },
        { question: `Ankara Antlaşması hangi devletle imzalanmıştır?`, options: [`Fransa (20 Ekim 1921)`, `İngiltere`, `İtalya`, `Yunanistan`], correctIndex: 0 },
        ...
        { question: `Başkomutanlık Meydan Muharebesi hangi tarihte kazanılmıştır?`, options: [`30 Ağustos 1922 (Dumlupınar)`, `26 Ağustos 1922`, `9 Eylül 1922`, `13 Eylül 1921`], correctIndex: 0 },
        ...
        { question: `Saltanatın kaldırılmasının nedeni nedir?`, options: [`Lozan'a iki heyet (İstanbul + Ankara) çağrılmasını engellemek`, `Halifeliği kurmak`, `Yeni vergi koymak`, `Eğitim`], correctIndex: 0 },
        ...
        { question: `I. İnönü Zaferi'nin dış politikadaki önemli sonucu hangisidir?`, options: [`Londra Konferansı'na çağrılmamız (TBMM tanınmaya başlandı)`, `Cumhuriyet ilanı`, `Saltanatın kaldırılması`, `Sevr'in imzası`], correctIndex: 0 },
        ...
        { question: `Gümrü Antlaşması'nın TBMM açısından önemi nedir?`, options: [`İlk siyasi ve askeri başarısıdır (Doğu Cephesi kapandı)`, `Cumhuriyet ilanıdır`, `Saltanat kaldırılışıdır`, `Lozan'ın başlangıcıdır`], correctIndex: 0 },
        { question: `Çukurova bölgesinde Fransızlara karşı verilen direnişlerin lideri kim olarak öne çıkar?`, options: [`Kara Fatma ve yerli kuvvetler (Kuvâ-yı Milliye)`, `Mustafa Kemal şahsen`, `İsmet Paşa`, `Padişah`], correctIndex: 0 },
        ...
        { question: `İstiklal Marşı'nın 41. dize yarışması hangi yıl yapılmıştır?`, options: [`1920-1921 (kabul: 12 Mart 1921)`, `1923`, `1924`, `1938`], correctIndex: 0 },
        { question: `Tekalif-i Milliye Emirleri toplam kaç maddedir?`, options: [`10`, `5`, `15`, `20`], correctIndex: 0 },
        { question: `Mudanya Ateşkesinin imzalanmasında etkili devletler kimlerdir?`, options: [`Türkiye + İngiltere, Fransa, İtalya + Yunanistan (gözlemci)`, `Sadece Yunanistan`, `Sadece İtalya`, `Sadece Almanya`], correctIndex: 0 },
...
[soru] "Aşağıdakilerden hangisi Atatürk ilkesi değildir?" → bu altısı dışındaki seçenek.`,
      ...
      quickQuestions: [
        ...
        { question: `Türk kadını seçme-seçilme hakkını ne zaman kazanmıştır?`, options: [`5 Aralık 1934 (genel seçimlerde)`, `1923`, `1930`, `1924`], correctIndex: 0 },
        ...
        { question: `Halifeliğin kaldırılması ile laiklik ilkesi arasında nasıl bir bağ vardır?`, options: [`Laikliğin temeli olmuştur (din-devlet ayrımı için gereklidir)`, `Hiç ilgisi yoktur`, `Tam zıttıdır`, `Bağımsızdır`], correctIndex: 0 },
...
Bu dönemde hukuk önünde eşitlik ve kadın haklarıyla ilgili önemli adımlar atıldı; toplumun çağdaşlaşması hedeflendi.`,
      ...
      quickQuestions: [
        { question: `Cumhuriyetimizin ilk siyasi partisi hangisidir?`, options: [`Cumhuriyet Halk Fırkası (CHF)`, `Demokrat Parti`, `Adalet Partisi`, `Halk Partisi`], correctIndex: 0 },
        ...
        { question: `Çok partili demokrasiye geçişin başarılı olduğu yıl hangisidir?`, options: [`1946 (gerçek anlamda, Atatürk dönemi sonrası)`, `1923`, `1930`, `1938`], correctIndex: 0 },
        { question: `Atatürk döneminde TBMM hangi seçim türüyle oluşmuştur?`, options: [`Tek dereceli seçim (1946'dan sonra), Atatürk döneminde iki dereceli`, `Sadece halk oylaması`, `Hiç seçim olmadı`, `Padişah atamasıyla`], correctIndex: 0 },
        ...
        { question: `Demokratik hayatın temel kurumu hangisidir?`, options: [`TBMM (Türkiye Büyük Millet Meclisi)`, `Padişah Sarayı`, `Halifelik`, `Sadrazamlık`], correctIndex: 0 },
        ...
        { question: `Yurttaşlık kavramının pekiştirilmesi için yapılan inkılap hangisidir?`, options: [`Soyadı Kanunu (1934)`, `Halifelik`, `Saltanat`, `Hilal-i Ahmer`], correctIndex: 0 },
        ...
        { question: `Atatürk dönemi tek partili dönem hangi partidir?`, options: [`Cumhuriyet Halk Fırkası (Partisi)`, `Demokrat Parti`, `Halk Partisi`, `Adalet Partisi`], correctIndex: 0 },
        ...
        { question: `Cumhuriyet rejiminin korunmasını sağlayan kurumlar hangileridir?`, options: [`TBMM, Anayasa Mahkemesi (sonradan), Cumhurbaşkanlığı`, `Halifelik`, `Sadrazamlık`, `Padişahlık`], correctIndex: 0 },
        ...
        { question: `Köy Enstitüleri hangi yıllar arasında açılmıştır?`, options: [`1940 (Atatürk sonrası, İnönü dönemi)`, `1923`, `1930`, `1925`], correctIndex: 0 },
...
[tuzak] Hatay 1936'da değil, **1939'da** katıldı.`,
      ...
      quickQuestions: [
        ...
        { question: `Türkiye'nin Sovyet Rusya ile ilk antlaşması hangisidir?`, options: [`Moskova Antlaşması (1921)`, `Lozan`, `Sevr`, `Mondros`], correctIndex: 0 },
        ...
        { question: `Hatay sorunu hangi tarafla yaşanmıştır?`, options: [`Fransa (mandater)`, `İngiltere`, `İtalya`, `Almanya`], correctIndex: 0 },
        { question: `Hatay Devleti ne zaman kurulmuştur?`, options: [`2 Eylül 1938`, `1923`, `1939`, `1936`], correctIndex: 0 },
        { question: `Hatay anavatana ne zaman katılmıştır?`, options: [`29 Haziran 1939 (Atatürk öldükten sonra)`, `1923`, `1938`, `1934`], correctIndex: 0 },
        ...
        { question: `Türkiye'nin Yunanistan ile ilişkilerinin düzelmesi hangi olayla başlamıştır?`, options: [`Venizelos'un Ankara ziyareti (1930)`, `Lozan`, `Sevr`, `Mondros`], correctIndex: 0 },
        ...
        { question: `Lozan Antlaşması'ndan sonra Türkiye ile Yunanistan arasında en büyük sorun neydi?`, options: [`Etabli (yerleşik) Rumlar meselesi`, `Hatay`, `Boğazlar`, `Doğu Trakya`], correctIndex: 0 },
        ...
        { question: `Mübadelenin dışında tutulan Rumlar hangileridir?`, options: [`İstanbul Rumları (etabli)`, `Anadolu Rumları`, `Batı Trakya Türkleri`, `Hiçbiri`], correctIndex: 0 },
        ...
        { question: `Musul Meselesi hangi yıl ve nasıl çözülmüştür?`, options: [`1926 Ankara Antlaşması (Musul Irak'a bırakıldı)`, `1923 Lozan`, `1934`, `1938`], correctIndex: 0 },
        { question: `Türkiye'nin Sovyet Rusya ile ilişkileri ne zaman bozulmaya başlamıştır?`, options: [`II. Dünya Savaşı yaklaşırken (1939-)`, `1923 hemen sonra`, `1928`, `1925`], correctIndex: 0 },
        ...
        { question: `Atatürk dönemi sonrası en önemli dış politika başarısı nedir?`, options: [`Hatay'ın anavatana katılması (1939)`, `Sevr`, `Mondros`, `Padişahlık`], correctIndex: 0 },
        ...
        { question: `Türkiye-Yugoslavya ilişkilerinde hangi pakt önemlidir?`, options: [`Balkan Antantı (1934)`, `Saadabat`, `Montrö`, `Lozan`], correctIndex: 0 },
        ...
        { question: `Atatürk dönemi dış politikasında en çok hangi devletlerle iyi ilişki kurulmuştur?`, options: [`SSCB, İngiltere, Yunanistan (zamanla), Balkan ülkeleri`, `Sadece Almanya`, `Sadece Japonya`, `Sadece İtalya`], correctIndex: 0 },
        ...
        { question: `Türkiye'nin Milletler Cemiyetine girişi hangi devletlerin daveti üzerine olmuştur?`, options: [`İspanya öncülüğünde 41 ülkenin önerisi`, `Sadece İngiltere`, `Sadece Yunanistan`, `Sadece SSCB`], correctIndex: 0 },
...
Atatürk; ilke ve inkılaplarıyla **laik, çağdaş ve bağımsız** bir Türkiye Cumhuriyeti bıraktı. Naaşı Ankara'da **Anıtkabir'e** taşınmıştır.`,
      ...
      quickQuestions: [
        ...
        { question: `Atatürk'ün cenazesi ilk olarak nereye defnedilmiştir?`, options: [`Etnografya Müzesi (Ankara) — geçici defin`, `Anıtkabir doğrudan`, `Dolmabahçe`, `Çankaya`], correctIndex: 0 },
        ...
        { question: `Anıtkabir nerede yer alır?`, options: [`Ankara - Rasattepe (Anıttepe)`, `İstanbul`, `İzmir`, `Samsun`], correctIndex: 0 },
        ...
        { question: `İsmet İnönü dönemi II. Dünya Savaşı'nda Türkiye nasıl bir politika izlemiştir?`, options: [`Aktif tarafsızlık (savaşa girmemek)`, `Almanya yanında savaşa katıldı`, `İngiltere yanında`, `SSCB yanında`], correctIndex: 0 },
        ...
        { question: `Köy Enstitüleri ne zaman kapatılmıştır?`, options: [`1954 (Adnan Menderes dönemi)`, `1940`, `1960`, `1980`], correctIndex: 0 },
        { question: `Türkiye'de çok partili hayata gerçek anlamda geçiş ne zaman olmuştur?`, options: [`1946 (Demokrat Parti kurulması ve seçimler)`, `1923`, `1934`, `1980`], correctIndex: 0 },
        ...
        { question: `Türkiye NATO'ya ne zaman katılmıştır?`, options: [`1952`, `1923`, `1945`, `1960`], correctIndex: 0 },
        { question: `Türkiye'nin Marshall yardımından yararlanmasının önemi nedir?`, options: [`Savaş sonrası ekonomik kalkınma`, `Saldırı`, `Toprak kaybı`, `İhanet`], correctIndex: 0 },
        { question: `27 Mayıs 1960 olayı nedir?`, options: [`Askeri darbe; DP iktidarına son verildi`, `Cumhuriyet ilanı`, `Lozan`, `Sevr`], correctIndex: 0 },
        { question: `27 Mayıs darbesinden sonra hangi anayasa hazırlanmıştır?`, options: [`1961 Anayasası`, `1924`, `1982`, `1921`], correctIndex: 0 },
        { question: `12 Eylül 1980 olayı nedir?`, options: [`Askerî darbe; siyasi partiler ve TBMM kapatıldı`, `Cumhuriyet ilanı`, `Lozan`, `Hatay'ın katılması`], correctIndex: 0 },
        { question: `12 Eylül 1980 darbesinden sonra hangi anayasa hazırlanmıştır?`, options: [`1982 Anayasası`, `1924`, `1961`, `1921`], correctIndex: 0 },
        ...
        { question: `Atatürk'ün vasiyetinde mirası kimlere bırakmıştır?`, options: [`Türk Tarih Kurumu ve Türk Dil Kurumu (bilim ve eğitim)`, `Kendi ailesine`, `Yabancılara`, `Padişaha`], correctIndex: 0 },
        ...
        { question: `Atatürk'ün gençlere bıraktığı vasiyetin adı nedir?`, options: [`Gençliğe Hitabe (Bursa Nutku içinde değil; 20 Ekim 1927)`, `Saltanat Beyannamesi`, `Halifelik Bildirisi`, `Sevr metni`], correctIndex: 0 },
        ...
        { question: `Atatürk'ün ölümünden sonra TBMM'nin aldığı önemli karar hangisidir?`, options: [`Hatay'ın anavatana katılması (1939)`, `Halifelik`, `Saltanat`, `Sevr`], correctIndex: 0 },
        ...
        { question: `Atatürk dönemi mirasının korunması için yapılan kanun hangisidir?`, options: [`Atatürk Aleyhine İşlenen Suçlar Hakkında Kanun (5816 sayılı, 1951)`, `Şapka Kanunu`, `Soyadı Kanunu`, `Tevhid-i Tedrisat`], correctIndex: 0 },
        ...
        { question: `30 Ağustos hangi bayramdır?`, options: [`Zafer Bayramı (Başkomutanlık Meydan Muharebesi 1922)`, `Cumhuriyet`, `19 Mayıs`, `23 Nisan`], correctIndex: 0 },
