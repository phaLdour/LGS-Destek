...
[örnek] **Selanik** (çok kültürlü yapı, fikir akımları), **Manastır** (askerî ortam, milliyetçilik) ve **İstanbul** (siyasi gelişmeler) Mustafa Kemal'i etkiledi.`,
      ...
      quickQuestions: [
        ...
        { question: `Mustafa Kemal Harp Akademisi sonrası ilk görev yeri neresidir?`, options: [`Şam`, `İstanbul`, `Selanik`, `İzmir`], correctIndex: 0, explanation: `Doğru cevap: Şam (Suriye)` },
        ...
        { question: `Trablusgarp Savaşı sonunda imzalanan antlaşma hangisidir?`, options: [`Uşi Antlaşması`, `Lozan`, `Sevr`, `Mondros`], correctIndex: 0, explanation: `Doğru cevap: Uşi Antlaşması (1912)` },
        { question: `Mustafa Kemal'i dünyaca tanıtan savaş hangisidir?`, options: [`Çanakkale Savaşı`, `Trablusgarp`, `İnönü`, `Sakarya`], correctIndex: 0, explanation: `Doğru cevap: Çanakkale Savaşı (1915)` },
        ...
        { question: `Mustafa Kemal Çanakkale'de hangi rütbededir?`, options: [`Yarbay`, `Teğmen`, `General`, `Mareşal`], correctIndex: 0, explanation: `Doğru cevap: Yarbay (sonradan Albay)` },
        ...
        { question: `Mondros Antlaşması hangi devletle imzalanmıştır?`, options: [`İtilaf Devletleri`, `Sadece İngiltere`, `Sadece Almanya`, `Rusya`], correctIndex: 0, explanation: `Doğru cevap: İtilaf Devletleri (İngiltere, Fransa, İtalya)` },
        { question: `Mondros Antlaşmasının en tehlikeli maddesi hangisidir?`, options: [`7. madde`, `1. madde`, `2. madde`, `5. madde`], correctIndex: 0, explanation: `Doğru cevap: 7. madde (İtilaf Devletleri istedikleri yeri işgal edebilecek)` },
        { question: `Mondros Antlaşmasından sonra Mustafa Kemal'in görevi nedir?`, options: [`9. Ordu Müfettişliği`, `Başkomutanlık`, `Genelkurmay başkanlığı`, `Padişahlık`], correctIndex: 0, explanation: `Doğru cevap: 9. Ordu Müfettişliği (Samsun'a görevlendirildi)` },
        ...
        { question: `Mustafa Kemal'in askerî başarıları nedeniyle aldığı ilk önemli unvan nedir?`, options: [`Anafartalar Kahramanı`, `Mareşal`, `Gazi`, `Atatürk`], correctIndex: 0, explanation: `Doğru cevap: Anafartalar Kahramanı (Çanakkale)` },
        ...
        { question: `Mustafa Kemal Milli Mücadele'yi başlatmadan önce hangi şehirde önemli toplantı yapmıştır?`, options: [`Amasya`, `Sivas`, `Erzurum`, `Ankara`], correctIndex: 0, explanation: `Doğru cevap: Amasya (Genelgesi)` },
      ],
    },
    {
      id: "milli-uyanis",
...
[soru] "Ulusal sınırları belirleyen karar?" → Misak-ı Millî.`,
      ...
      quickQuestions: [
        ...
        { question: `Misak-ı Milli kararları hangi mecliste alınmıştır?`, options: [`Son Osmanlı Mebusan Meclisi`, `TBMM`, `Sivas Kongresi`, `Lozan`], correctIndex: 0, explanation: `Doğru cevap: Son Osmanlı Mebusan Meclisi (28 Ocak 1920)` },
        ...
        { question: `TBMM'nin özelliklerinden biri nedir?`, options: [`Güçler birliği ilkesini benimsedi`, `Güçler ayrılığı`, `Padişahlığı korudu`, `Saltanatı sürdürdü`], correctIndex: 0, explanation: `Doğru cevap: Güçler birliği (kuvvetler birliği) ilkesini benimsedi` },
        ...
        { question: `Kuvâ-yı Milliye'nin yerini hangi ordu almıştır?`, options: [`Düzenli Türk Ordusu`, `Yeniçeri Ocağı`, `Osmanlı Hassa Ordusu`, `İttihatçı ordu`], correctIndex: 0, explanation: `Doğru cevap: Düzenli Türk Ordusu (TBMM ordusu)` },
        ...
        { question: `Milli mücadeleyi destekleyen ilk gazete hangisidir?`, options: [`İrade-i Milliye`, `Hâkimiyet-i Milliye`, `Tasvir`, `Tanin`], correctIndex: 0, explanation: `Doğru cevap: İrade-i Milliye (Sivas)` },
        ...
        { question: `İlk düzenli ordumuzun komutanı kimdir?`, options: [`İsmet Paşa`, `Mustafa Kemal Paşa`, `Fevzi Çakmak`, `Kazım Karabekir`], correctIndex: 0, explanation: `Doğru cevap: İsmet (İnönü) Paşa` },
        ...
        { question: `1921 Anayasasında yargı yetkisi kime aittir?`, options: [`TBMM'ye`, `Padişaha`, `Sadrazama`, `Halifeye`], correctIndex: 0, explanation: `Doğru cevap: TBMM'ye (güçler birliği)` },
...
[kural] **Mudanya Ateşkesi (11 Ekim 1922)** silahları susturdu; **Lozan Barış Antlaşması (24 Temmuz 1923)** ile bağımsızlık dünyaca tanındı.`,
      ...
      quickQuestions: [
        ...
        { question: `I. İnönü Savaşı'nın komutanı kimdir?`, options: [`İsmet Paşa`, `Mustafa Kemal Paşa`, `Fevzi Çakmak`, `Kazım Karabekir`], correctIndex: 0, explanation: `Doğru cevap: İsmet (İnönü) Paşa` },
        { question: `I. İnönü Savaşı kime karşı yapılmıştır?`, options: [`Yunanistan`, `İngiltere`, `Fransa`, `İtalya`], correctIndex: 0 },
        { question: `I. İnönü Savaşı sonucunda hangi anayasa yapılmıştır?`, options: [`1921 Anayasası`, `1924 Anayasası`, `1961 Anayasası`, `1982 Anayasası`], correctIndex: 0, explanation: `Doğru cevap: 1921 Anayasası (Teşkilat-ı Esasiye)` },
        ...
        { question: `II. İnönü Zaferi sonrası "Siz orada yalnız düşmanı değil, milletin makus talihini de yendiniz." sözünü kim söylemiştir?`, options: [`Mustafa Kemal`, `Padişah`, `İsmet Paşa`, `Fevzi Çakmak`], correctIndex: 0, explanation: `Doğru cevap: Mustafa Kemal (İsmet Paşa'ya)` },
        ...
        { question: `Kars Antlaşması hangi devletlerle imzalanmıştır?`, options: [`Sovyet etkisindeki Kafkas Cumhuriyetleri`, `Yunanistan`, `İngiltere`, `Almanya`], correctIndex: 0, explanation: `Doğru cevap: Sovyet etkisindeki Kafkas Cumhuriyetleri (Azerbaycan, Ermenistan, Gürcistan)` },
        { question: `Ankara Antlaşması hangi devletle imzalanmıştır?`, options: [`Fransa`, `İngiltere`, `İtalya`, `Yunanistan`], correctIndex: 0, explanation: `Doğru cevap: Fransa (20 Ekim 1921)` },
        ...
        { question: `Başkomutanlık Meydan Muharebesi hangi tarihte kazanılmıştır?`, options: [`30 Ağustos 1922`, `26 Ağustos 1922`, `9 Eylül 1922`, `13 Eylül 1921`], correctIndex: 0, explanation: `Doğru cevap: 30 Ağustos 1922 (Dumlupınar)` },
        ...
        { question: `Saltanatın kaldırılmasının nedeni nedir?`, options: [`Lozan'a iki heyet çağrılmasını engellemek`, `Halifeliği kurmak`, `Yeni vergi koymak`, `Eğitim`], correctIndex: 0, explanation: `Doğru cevap: Lozan'a iki heyet (İstanbul + Ankara) çağrılmasını engellemek` },
        ...
        { question: `I. İnönü Zaferi'nin dış politikadaki önemli sonucu hangisidir?`, options: [`Londra Konferansı'na çağrılmamız`, `Cumhuriyet ilanı`, `Saltanatın kaldırılması`, `Sevr'in imzası`], correctIndex: 0, explanation: `Doğru cevap: Londra Konferansı'na çağrılmamız (TBMM tanınmaya başlandı)` },
        ...
        { question: `Gümrü Antlaşması'nın TBMM açısından önemi nedir?`, options: [`İlk siyasi ve askeri başarısıdır`, `Cumhuriyet ilanıdır`, `Saltanat kaldırılışıdır`, `Lozan'ın başlangıcıdır`], correctIndex: 0, explanation: `Doğru cevap: İlk siyasi ve askeri başarısıdır (Doğu Cephesi kapandı)` },
        { question: `Çukurova bölgesinde Fransızlara karşı verilen direnişlerin lideri kim olarak öne çıkar?`, options: [`Kara Fatma ve yerli kuvvetler`, `Mustafa Kemal şahsen`, `İsmet Paşa`, `Padişah`], correctIndex: 0, explanation: `Doğru cevap: Kara Fatma ve yerli kuvvetler (Kuvâ-yı Milliye)` },
        ...
        { question: `İstiklal Marşı'nın güftesi yarışması hangi yıllarda yapılmıştır?`, options: [`1920-1921`, `1923`, `1924`, `1938`], correctIndex: 0, explanation: `Doğru cevap: 1920-1921 (TBMM 12 Mart 1921'de kabul etti)` },
        { question: `Tekalif-i Milliye Emirleri toplam kaç maddedir?`, options: [`10`, `5`, `15`, `20`], correctIndex: 0 },
        { question: `Mudanya Ateşkesinin imzalanmasında etkili devletler kimlerdir?`, options: [`Türkiye + İngiltere, Fransa, İtalya + Yunanistan`, `Sadece Yunanistan`, `Sadece İtalya`, `Sadece Almanya`], correctIndex: 0, explanation: `Doğru cevap: Türkiye + İngiltere, Fransa, İtalya + Yunanistan (gözlemci)` },
...
[soru] "Aşağıdakilerden hangisi Atatürk ilkesi değildir?" → bu altısı dışındaki seçenek.`,
      ...
      quickQuestions: [
        ...
        { question: `Türk kadını seçme-seçilme hakkını ne zaman kazanmıştır?`, options: [`5 Aralık 1934`, `1923`, `1930`, `1924`], correctIndex: 0, explanation: `Doğru cevap: 5 Aralık 1934 (genel seçimlerde)` },
        ...
        { question: `Halifeliğin kaldırılması ile laiklik ilkesi arasında nasıl bir bağ vardır?`, options: [`Laikliğin temeli olmuştur`, `Hiç ilgisi yoktur`, `Tam zıttıdır`, `Bağımsızdır`], correctIndex: 0, explanation: `Doğru cevap: Laikliğin temeli olmuştur (din-devlet ayrımı için gereklidir)` },
...
Bu dönemde hukuk önünde eşitlik ve kadın haklarıyla ilgili önemli adımlar atıldı; toplumun çağdaşlaşması hedeflendi.`,
      ...
      quickQuestions: [
        { question: `Cumhuriyetimizin ilk siyasi partisi hangisidir?`, options: [`Cumhuriyet Halk Fırkası`, `Demokrat Parti`, `Adalet Partisi`, `Halk Partisi`], correctIndex: 0, explanation: `Doğru cevap: Cumhuriyet Halk Fırkası (CHF)` },
        ...
        { question: `Çok partili demokrasiye geçişin başarılı olduğu yıl hangisidir?`, options: [`1946`, `1923`, `1930`, `1938`], correctIndex: 0, explanation: `Doğru cevap: 1946 (gerçek anlamda, Atatürk dönemi sonrası)` },
        ...
        { question: `Demokratik hayatın temel kurumu hangisidir?`, options: [`TBMM`, `Padişah Sarayı`, `Halifelik`, `Sadrazamlık`], correctIndex: 0, explanation: `Doğru cevap: TBMM (Türkiye Büyük Millet Meclisi)` },
        ...
        { question: `Yurttaşlık kavramının pekiştirilmesi için yapılan inkılap hangisidir?`, options: [`Soyadı Kanunu`, `Halifelik`, `Saltanat`, `Hilal-i Ahmer`], correctIndex: 0, explanation: `Doğru cevap: Soyadı Kanunu (1934)` },
        ...
        { question: `Atatürk dönemi tek partili dönem hangi partidir?`, options: [`Cumhuriyet Halk Fırkası`, `Demokrat Parti`, `Halk Partisi`, `Adalet Partisi`], correctIndex: 0, explanation: `Doğru cevap: Cumhuriyet Halk Fırkası (Partisi)` },
        ...
        { question: `Cumhuriyet rejiminin korunmasını sağlayan kurumlar hangileridir?`, options: [`TBMM, Anayasa Mahkemesi, Cumhurbaşkanlığı`, `Halifelik`, `Sadrazamlık`, `Padişahlık`], correctIndex: 0, explanation: `Doğru cevap: TBMM, Anayasa Mahkemesi (sonradan), Cumhurbaşkanlığı` },
        ...
        { question: `Köy Enstitüleri hangi yıllar arasında açılmıştır?`, options: [`1940`, `1923`, `1930`, `1925`], correctIndex: 0, explanation: `Doğru cevap: 1940 (Atatürk sonrası, İnönü dönemi)` },
...
[tuzak] Hatay 1936'da değil, **1939'da** katıldı.`,
      ...
      quickQuestions: [
        ...
        { question: `Türkiye'nin Sovyet Rusya ile ilk antlaşması hangisidir?`, options: [`Moskova Antlaşması`, `Lozan`, `Sevr`, `Mondros`], correctIndex: 0, explanation: `Doğru cevap: Moskova Antlaşması (1921)` },
        ...
        { question: `Hatay sorunu hangi tarafla yaşanmıştır?`, options: [`Fransa`, `İngiltere`, `İtalya`, `Almanya`], correctIndex: 0, explanation: `Doğru cevap: Fransa (mandater)` },
        { question: `Hatay Devleti ne zaman kurulmuştur?`, options: [`2 Eylül 1938`, `1923`, `1939`, `1936`], correctIndex: 0 },
        { question: `Hatay anavatana ne zaman katılmıştır?`, options: [`29 Haziran 1939`, `1923`, `1938`, `1934`], correctIndex: 0, explanation: `Doğru cevap: 29 Haziran 1939 (Atatürk öldükten sonra)` },
        ...
        { question: `Türkiye'nin Yunanistan ile ilişkilerinin düzelmesi hangi olayla başlamıştır?`, options: [`Venizelos'un Ankara ziyareti`, `Lozan`, `Sevr`, `Mondros`], correctIndex: 0, explanation: `Doğru cevap: Venizelos'un Ankara ziyareti (1930)` },
        ...
        { question: `Lozan Antlaşması'ndan sonra Türkiye ile Yunanistan arasında en büyük sorun neydi?`, options: [`Etabli Rumlar meselesi`, `Hatay`, `Boğazlar`, `Doğu Trakya`], correctIndex: 0, explanation: `Doğru cevap: Etabli (yerleşik) Rumlar meselesi` },
        ...
        { question: `Mübadelenin dışında tutulan Rumlar hangileridir?`, options: [`İstanbul Rumları`, `Anadolu Rumları`, `Batı Trakya Türkleri`, `Hiçbiri`], correctIndex: 0, explanation: `Doğru cevap: İstanbul Rumları (etabli)` },
        ...
        { question: `Musul Meselesi hangi yıl ve nasıl çözülmüştür?`, options: [`1926 Ankara Antlaşması`, `1923 Lozan`, `1934`, `1938`], correctIndex: 0, explanation: `Doğru cevap: 1926 Ankara Antlaşması (Musul Irak'a bırakıldı)` },
        { question: `Türkiye'nin Sovyet Rusya ile ilişkileri ne zaman bozulmaya başlamıştır?`, options: [`II. Dünya Savaşı yaklaşırken`, `1923 hemen sonra`, `1928`, `1925`], correctIndex: 0, explanation: `Doğru cevap: II. Dünya Savaşı yaklaşırken (1939-)` },
        ...
        { question: `Atatürk dönemi sonrası en önemli dış politika başarısı nedir?`, options: [`Hatay'ın anavatana katılması`, `Sevr`, `Mondros`, `Padişahlık`], correctIndex: 0, explanation: `Doğru cevap: Hatay'ın anavatana katılması (1939)` },
        ...
        { question: `Türkiye-Yugoslavya ilişkilerinde hangi pakt önemlidir?`, options: [`Balkan Antantı`, `Saadabat`, `Montrö`, `Lozan`], correctIndex: 0, explanation: `Doğru cevap: Balkan Antantı (1934)` },
        ...
        { question: `Atatürk dönemi dış politikasında en çok hangi devletlerle iyi ilişki kurulmuştur?`, options: [`SSCB, İngiltere, Yunanistan, Balkan ülkeleri`, `Sadece Almanya`, `Sadece Japonya`, `Sadece İtalya`], correctIndex: 0, explanation: `Doğru cevap: SSCB, İngiltere, Yunanistan (zamanla), Balkan ülkeleri` },
...
Atatürk; ilke ve inkılaplarıyla **laik, çağdaş ve bağımsız** bir Türkiye Cumhuriyeti bıraktı. Naaşı Ankara'da **Anıtkabir'e** taşınmıştır.`,
      ...
      quickQuestions: [
        ...
        { question: `Atatürk'ün cenazesi ilk olarak nereye defnedilmiştir?`, options: [`Etnografya Müzesi — geçici defin`, `Anıtkabir doğrudan`, `Dolmabahçe`, `Çankaya`], correctIndex: 0, explanation: `Doğru cevap: Etnografya Müzesi (Ankara) — geçici defin` },
        ...
        { question: `Anıtkabir nerede yer alır?`, options: [`Ankara - Rasattepe`, `İstanbul`, `İzmir`, `Samsun`], correctIndex: 0, explanation: `Doğru cevap: Ankara - Rasattepe (Anıttepe)` },
        ...
        { question: `İsmet İnönü dönemi II. Dünya Savaşı'nda Türkiye nasıl bir politika izlemiştir?`, options: [`Aktif tarafsızlık`, `Almanya yanında savaşa katıldı`, `İngiltere yanında`, `SSCB yanında`], correctIndex: 0, explanation: `Doğru cevap: Aktif tarafsızlık (savaşa girmemek)` },
        ...
        { question: `Türkiye'de çok partili hayata gerçek anlamda geçiş ne zaman olmuştur?`, options: [`1946`, `1923`, `1934`, `1980`], correctIndex: 0, explanation: `Doğru cevap: 1946 (Demokrat Parti kurulması ve seçimler)` },
        ...
        { question: `II. Dünya Savaşı'nın bitiminden sonra Türkiye hangi uluslararası kuruluşa kurucu üye oldu?`, options: [`Birleşmiş Milletler`, `Milletler Cemiyeti`, `Sevr`, `İtilaf Devletleri`], correctIndex: 0, explanation: `Doğru cevap: Birleşmiş Milletler (BM)` },
        ...
        { question: `Atatürk'ün vefatından sonra Türkiye'nin II. Dünya Savaşı'ndaki tutumu nasıl olmuştur?`, options: [`Aktif tarafsızlık`, `Almanya yanında savaşa girme`, `İngiltere yanında savaşa girme`, `Bağımsızlığı kaybetme`], correctIndex: 0, explanation: `Doğru cevap: Aktif tarafsızlık (savaşa girmeme)` },
        ...
        { question: `Atatürk'ün vasiyetinde mirası kimlere bırakmıştır?`, options: [`Türk Tarih Kurumu ve Türk Dil Kurumu`, `Kendi ailesine`, `Yabancılara`, `Padişaha`], correctIndex: 0, explanation: `Doğru cevap: Türk Tarih Kurumu ve Türk Dil Kurumu (bilim ve eğitim)` },
        ...
        { question: `Atatürk'ün gençlere seslendiği, Nutuk'un sonunda yer alan ünlü metnin adı nedir?`, options: [`Gençliğe Hitabe`, `Saltanat Beyannamesi`, `Halifelik Bildirisi`, `Sevr metni`], correctIndex: 0, explanation: `Doğru cevap: Gençliğe Hitabe (20 Ekim 1927)` },
        ...
        { question: `Atatürk'ün ölümünden sonra TBMM'nin aldığı önemli karar hangisidir?`, options: [`Hatay'ın anavatana katılması`, `Halifelik`, `Saltanat`, `Sevr`], correctIndex: 0, explanation: `Doğru cevap: Hatay'ın anavatana katılması (1939)` },
        ...
        { question: `30 Ağustos hangi bayramdır?`, options: [`Zafer Bayramı`, `Cumhuriyet`, `19 Mayıs`, `23 Nisan`], correctIndex: 0, explanation: `Doğru cevap: Zafer Bayramı (Başkomutanlık Meydan Muharebesi 1922)` },
