...
Atatürk; ilke ve inkılaplarıyla **laik, çağdaş ve bağımsız** bir Türkiye Cumhuriyeti bıraktı. Naaşı Ankara'da **Anıtkabir'e** taşınmıştır.`,
      ...
      quickQuestions: [
        ...
        { question: `II. Dünya Savaşı'nın bitiminden sonra Türkiye hangi uluslararası kuruluşa kurucu üye oldu?`, options: [`Birleşmiş Milletler (BM)`, `Milletler Cemiyeti`, `Sevr`, `İtilaf Devletleri`], correctIndex: 0 },
        ...
        { question: `Atatürk'ün vefatından sonra Türkiye'nin II. Dünya Savaşı'ndaki tutumu nasıl olmuştur?`, options: [`Aktif tarafsızlık (savaşa girmeme)`, `Almanya yanında savaşa girme`, `İngiltere yanında savaşa girme`, `Bağımsızlığı kaybetme`], correctIndex: 0 },
