...
[tuzak] Daveti reddederken sadece "No" demek kabadır; **"Sorry, I can't..."** ile kibarca bir sebep eklenir.`,
      ...
      quickQuestions: [
        { question: `"honest" Türkçesi nedir?`, options: [`dürüst`, `tembel`, `cömert`, `bencil`], correctIndex: 0 },
        { question: `"reliable" Türkçesi nedir?`, options: [`güvenilir`, `tembel`, `kaba`, `bencil`], correctIndex: 0 },
        { question: `"generous" Türkçesi nedir?`, options: [`cömert`, `kıskanç`, `utangaç`, `kızgın`], correctIndex: 0 },
        { question: `"supportive" Türkçesi nedir?`, options: [`destekleyici`, `yalancı`, `korkak`, `kaba`], correctIndex: 0 },
        ...
        { question: `"I'd love to" ne anlama gelir?`, options: [`Çok isterim`, `Reddetmek`, `Bilmiyorum`, `Belki`], correctIndex: 0, explanation: `Doğru cevap: Çok isterim (kabul)` },
        { question: `"I'd love to, but..." ne anlama gelir?`, options: [`Kibarca reddetme`, `Tam kabul`, `Şüphe`, `Soru`], correctIndex: 0 },
        { question: `"Sorry, I can't" nasıl bir cevaptır?`, options: [`Kibarca reddetme`, `Kabul`, `Soru`, `Davet`], correctIndex: 0 },
        ...
        { question: `Bir arkadaşa "Do you want to come with us?" diye sorulduğunda kabul cevabı?`, options: [`Yes, I'd love to.`, `No, never.`, `Maybe later.`, `What's that?`], correctIndex: 0 },
        ...
        { question: `"Friendship" Türkçesi nedir?`, options: [`arkadaşlık`, `aile`, `okul`, `iş`], correctIndex: 0 },
        ...
        { question: `Pasta partisine davet için en uygun ifade hangisidir?`, options: [`Would you like to come to my birthday party?`, `Why are you here?`, `What is your name?`, `How old are you?`], correctIndex: 0 },
...
[soru] "She ___ goes to school." cümlesinde sıklık zarfı **özne ile fiil arasına** gelir.`,
      ...
      quickQuestions: [
        { question: `"always" Türkçesi nedir?`, options: [`her zaman`, `asla`, `bazen`, `nadiren`], correctIndex: 0 },
        { question: `"never" Türkçesi nedir?`, options: [`asla / hiç`, `her zaman`, `bazen`, `genellikle`], correctIndex: 0 },
        { question: `"usually" Türkçesi nedir?`, options: [`genellikle`, `asla`, `nadiren`, `şimdi`], correctIndex: 0 },
        ...
        { question: `Simple Present Tense ne için kullanılır?`, options: [`Alışkanlıklar ve rutinler`, `Şu an olan eylem`, `Geçmiş olay`, `Gelecek plan`], correctIndex: 0 },
        ...
        { question: `"___ she like music?" (soru) boşluğa?`, options: [`Does`, `Do`, `Is`, `Are`], correctIndex: 0 },
        ...
        { question: `"How often" sorusuna ne ile cevap verilir?`, options: [`Sıklık zarfları`, `Tarih`, `Yer`, `Sayı`], correctIndex: 0, explanation: `Doğru cevap: Sıklık zarfları (always, usually, sometimes...)` },
        { question: `"What time do you get up?" sorusu neyi sorar?`, options: [`Kalkış saatini`, `Yeri`, `Kişiyi`, `Yiyeceği`], correctIndex: 0 },
        ...
        { question: `Hangisi bir activity (etkinlik) ismidir?`, options: [`watching TV`, `tomato`, `chair`, `school`], correctIndex: 0 },
        ...
        { question: `"every Sunday" hangi zamanı belirtir?`, options: [`Simple Present`, `Present Continuous`, `Past Simple`, `Future`], correctIndex: 0, explanation: `Doğru cevap: Simple Present (alışkanlık)` },
...
[tanım] **chop** (doğramak), **boil** (kaynatmak), **fry** (kızartmak), **pour** (dökmek), **slice** (dilimlemek).`,
      ...
      quickQuestions: [
        ...
        { question: `"bake" Türkçesi nedir?`, options: [`fırında pişirmek`, `dondurmak`, `kaynatmak`, `kızartmak`], correctIndex: 0 },
        ...
        { question: `"a little" hangi isimle kullanılır?`, options: [`Sayılamayan`, `Sayılabilen`, `Çoğul`, `Tek isim`], correctIndex: 0, explanation: `Doğru cevap: Sayılamayan (water, sugar)` },
        { question: `"a few" hangi isimle kullanılır?`, options: [`Sayılabilen çoğul`, `Sayılamayan`, `Tek isim`, `Hiçbiri`], correctIndex: 0, explanation: `Doğru cevap: Sayılabilen çoğul (apples, books)` },
        ...
        { question: `"meal" Türkçesi nedir?`, options: [`yemek`, `tabak`, `çatal`, `mutfak`], correctIndex: 0, explanation: `Doğru cevap: yemek (öğün)` },
...
[örnek] "What **are** you **doing**?" – "I**'m watching** a film."`,
      ...
      quickQuestions: [
        { question: `"Hello, this is Ali." telefonda nasıl bir ifadedir?`, options: [`Kendini tanıtma`, `Veda`, `Soru`, `Sipariş`], correctIndex: 0 },
        { question: `"Can I speak to Ali?" ne anlama gelir?`, options: [`Ali ile konuşabilir miyim?`, `Ali kim?`, `Ali nerede?`, `Ali geldi mi?`], correctIndex: 0 },
        { question: `"Hold on, please." ne anlama gelir?`, options: [`Bekleyin lütfen`, `Kapatın`, `Konuşun`, `Arayın`], correctIndex: 0 },
        { question: `"hang up" ne anlama gelir?`, options: [`Telefonu kapatmak`, `Aramak`, `Mesaj atmak`, `Beklemek`], correctIndex: 0 },
        { question: `"call back" ne anlama gelir?`, options: [`Geri aramak`, `Cevap vermemek`, `Kapatmak`, `Bağlanmak`], correctIndex: 0 },
        { question: `"I'll call you back." ne anlama gelir?`, options: [`Seni sonra arayacağım`, `Seni görüyorum`, `Hoşça kal`, `Teşekkürler`], correctIndex: 0 },
        ...
        { question: `Present Continuous Tense'in kullanım amacı nedir?`, options: [`Şu anda olan eylem`, `Alışkanlık`, `Geçmiş`, `Gelecek`], correctIndex: 0 },
        { question: `"I am reading a book now." cümlesi hangi tense'dir?`, options: [`Present Continuous`, `Simple Present`, `Past`, `Future`], correctIndex: 0 },
        { question: `Present Continuous yapısı nasıldır?`, options: [`am/is/are + fiil-ing`, `do/does + fiil`, `did + fiil`, `will + fiil`], correctIndex: 0 },
        ...
        { question: `"What ___ you doing?" boşluğa?`, options: [`are`, `is`, `am`, `do`], correctIndex: 0 },
        { question: `"She ___ TV at the moment." boşluğa?`, options: [`is watching`, `watches`, `watched`, `watch`], correctIndex: 0 },
        { question: `Present Continuous için anahtar zarflar hangileridir?`, options: [`now, at the moment, right now`, `always, usually`, `yesterday`, `tomorrow`], correctIndex: 0 },
        { question: `"He is sleeping." cümlesinde "sleeping" hangi -ing fiilidir?`, options: [`sleep + ing`, `sleep + ed`, `sleep + s`, `sleep`], correctIndex: 0 },
        { question: `"run" fiilinin -ing hâli nedir?`, options: [`running`, `runing`, `runs`, `runned`], correctIndex: 0, explanation: `Doğru cevap: running (n çift)` },
        { question: `"swim" fiilinin -ing hâli nedir?`, options: [`swimming`, `swiming`, `swimed`, `swimmed`], correctIndex: 0 },
        { question: `"write" fiilinin -ing hâli nedir?`, options: [`writing`, `writeing`, `writed`, `writes`], correctIndex: 0, explanation: `Doğru cevap: writing (e düşer)` },
        ...
        { question: `"He is talking on the phone." cümlesi hangi tense'dedir?`, options: [`Present Continuous`, `Simple Present`, `Past`, `Future`], correctIndex: 0 },
      ],
    },
    {
      id: "the-internet",
...
[ipucu] Güvenli kalmak için **strong password** kullan, kişisel bilgini paylaşma.`,
      ...
      quiz: [
        ...
        { question: `"browse" anlamı nedir?`, options: [`gezinmek`, `kapatmak`, `yazmak`, `silmek`], correctIndex: 0, explanation: `Doğru cevap: (internette) gezinmek` },
        ...
        { question: `"because" shows...?`, options: [`sebep`, `sonuç`, `zaman`, `yer`], correctIndex: 0, explanation: `Doğru cevap: sebep (reason)` },
      ],
      quickQuestions: [
        ...
        { question: `"browse" Türkçesi nedir?`, options: [`gezinmek`, `kapatmak`, `yazmak`, `silmek`], correctIndex: 0, explanation: `Doğru cevap: (internette) gezinmek` },
        { question: `"online" Türkçesi nedir?`, options: [`çevrim içi`, `çevrim dışı`, `bozuk`, `kapalı`], correctIndex: 0 },
        { question: `"offline" Türkçesi nedir?`, options: [`çevrim dışı`, `çevrim içi`, `açık`, `meşgul`], correctIndex: 0 },
        { question: `"website" Türkçesi nedir?`, options: [`web sitesi`, `tarayıcı`, `şifre`, `e-posta`], correctIndex: 0 },
        { question: `"password" Türkçesi nedir?`, options: [`şifre`, `kullanıcı adı`, `e-posta`, `mesaj`], correctIndex: 0 },
        { question: `"username" Türkçesi nedir?`, options: [`kullanıcı adı`, `şifre`, `e-posta`, `mesaj`], correctIndex: 0 },
        { question: `"social media" Türkçesi nedir?`, options: [`sosyal medya`, `e-posta`, `mesaj`, `arama`], correctIndex: 0 },
        ...
        { question: `"because" hangi anlam ilişkisini kurar?`, options: [`Sebep`, `Sonuç`, `Zaman`, `Yer`], correctIndex: 0, explanation: `Doğru cevap: Sebep (reason)` },
        { question: `"so" hangi anlam ilişkisini kurar?`, options: [`Sonuç`, `Sebep`, `Karşıtlık`, `Yer`], correctIndex: 0, explanation: `Doğru cevap: Sonuç (result)` },
        { question: `"but" hangi anlam ilişkisini kurar?`, options: [`Karşıtlık`, `Sebep`, `Sonuç`, `Yer`], correctIndex: 0, explanation: `Doğru cevap: Karşıtlık (contrast)` },
        { question: `"and" hangi anlam ilişkisini kurar?`, options: [`Ekleme`, `Sebep`, `Karşıtlık`, `Sonuç`], correctIndex: 0, explanation: `Doğru cevap: Ekleme (addition)` },
        { question: `"I like the internet ___ it is useful." boşluğa?`, options: [`because`, `so`, `but`, `or`], correctIndex: 0 },
        ...
        { question: `"video call" Türkçesi nedir?`, options: [`görüntülü arama`, `sesli mesaj`, `e-posta`, `chat`], correctIndex: 0 },
        { question: `"e-mail" Türkçesi nedir?`, options: [`e-posta`, `mesaj`, `arama`, `dosya`], correctIndex: 0 },
        { question: `"link" Türkçesi nedir?`, options: [`bağlantı`, `dosya`, `şifre`, `mesaj`], correctIndex: 0 },
        { question: `"app" hangi sözcüğün kısaltmasıdır?`, options: [`application`, `apple`, `apprentice`, `applaud`], correctIndex: 0 },
        { question: `"connect" Türkçesi nedir?`, options: [`bağlanmak`, `ayrılmak`, `silmek`, `kapatmak`], correctIndex: 0 },
        { question: `"disconnect" Türkçesi nedir?`, options: [`bağlantıyı kesmek`, `bağlanmak`, `aramak`, `chat etmek`], correctIndex: 0 },
...
[tanım] **excited** (heyecanlı), **scared** (korkmuş), **nervous** (gergin), **bored** (sıkılmış), **brave** (cesur).`,
      ...
      quiz: [
        ...
        { question: `"should" is followed by...?`, options: [`base verb`, `to + verb`, `verb + ing`, `verb + ed`], correctIndex: 0, explanation: `Doğru cevap: base verb (go)` },
      ...
      quickQuestions: [
        { question: `"should" hangi anlama gelir?`, options: [`-meli/-malı`, `Zorunluluk`, `Gelecek`, `Geçmiş`], correctIndex: 0, explanation: `Doğru cevap: -meli/-malı (tavsiye)` },
        { question: `"should" sonra hangi fiil hâli gelir?`, options: [`Base verb`, `to + verb`, `verb + ing`, `verb + ed`], correctIndex: 0, explanation: `Doğru cevap: Base verb (yalın hâl)` },
        ...
        { question: `"Should I go?" hangi yapıdır?`, options: [`Soru cümlesi`, `Olumlu cümle`, `Emir`, `Geçmiş`], correctIndex: 0, explanation: `Doğru cevap: Soru cümlesi (tavsiye istemek)` },
        ...
        { question: `"thrilled" Türkçesi nedir?`, options: [`çok heyecanlı`, `üzgün`, `sıkılmış`, `bezgin`], correctIndex: 0 },
        ...
        { question: `"dangerous" Türkçesi nedir?`, options: [`tehlikeli`, `güvenli`, `kolay`, `zor`], correctIndex: 0 },
        { question: `"safe" Türkçesi nedir?`, options: [`güvenli`, `tehlikeli`, `kolay`, `zor`], correctIndex: 0 },
        { question: `"exciting" Türkçesi nedir?`, options: [`heyecan verici`, `sıkıcı`, `üzücü`, `kızgın`], correctIndex: 0 },
        { question: `Aşağıdaki maceralardan hangisi extreme sport (ekstrem spor)?`, options: [`bungee jumping`, `chess`, `reading`, `cooking`], correctIndex: 0 },
        ...
        { question: `"camping" Türkçesi nedir?`, options: [`kamp yapma`, `yüzmek`, `okumak`, `pişirmek`], correctIndex: 0 },
        { question: `"scuba diving" Türkçesi nedir?`, options: [`tüplü dalış`, `yüzmek`, `koşmak`, `tırmanmak`], correctIndex: 0 },
        { question: `"rock climbing" Türkçesi nedir?`, options: [`kaya tırmanışı`, `yüzme`, `kayak`, `koşu`], correctIndex: 0 },
        { question: `"skydiving" Türkçesi nedir?`, options: [`paraşütle atlama`, `yüzme`, `koşma`, `tırmanma`], correctIndex: 0 },
        { question: `"You ___ be careful when climbing." boşluğa (tavsiye)?`, options: [`should`, `shouldn't`, `don't`, `aren't`], correctIndex: 0 },
        { question: `"You ___ swim alone in the sea." (olumsuz tavsiye)`, options: [`shouldn't`, `should`, `don't`, `do`], correctIndex: 0 },
        ...
        { question: `"life jacket" Türkçesi nedir?`, options: [`can yeleği`, `mont`, `şort`, `çanta`], correctIndex: 0 },
        { question: `"first aid kit" Türkçesi nedir?`, options: [`ilk yardım çantası`, `okul çantası`, `spor çantası`, `cüzdan`], correctIndex: 0 },
        { question: `"safety rules" Türkçesi nedir?`, options: [`güvenlik kuralları`, `yasaklar`, `oyunlar`, `talimatlar`], correctIndex: 0 },
      ],
    },
    {
      id: "tourism",
...
[tanım] **sightseeing** (gezi), **souvenir** (hatıra eşyası), **tour guide** (tur rehberi), **accommodation** (konaklama), **journey** (yolculuk).`,
      ...
      quickQuestions: [
        { question: `Simple Past Tense'in kullanım amacı nedir?`, options: [`Geçmişte olmuş bitmiş eylemler`, `Şu an olan eylem`, `Alışkanlık`, `Gelecek plan`], correctIndex: 0 },
        ...
        { question: `Past Simple olumsuz nasıl yapılır?`, options: [`didn't + base verb`, `wasn't + verb`, `don't + verb`, `not + verb`], correctIndex: 0 },
        ...
        { question: `"souvenir" Türkçesi nedir?`, options: [`hatıra eşyası`, `bilet`, `harita`, `otel`], correctIndex: 0 },
        { question: `"tour guide" Türkçesi nedir?`, options: [`tur rehberi`, `yolcu`, `bilet`, `çanta`], correctIndex: 0 },
        ...
        { question: `"passport" Türkçesi nedir?`, options: [`pasaport`, `bilet`, `vize`, `kimlik`], correctIndex: 0 },
...
[tanım] **do the dishes** (bulaşık yıkamak), **make the bed** (yatağı toplamak), **take out the rubbish** (çöpü çıkarmak), **set the table** (sofrayı kurmak), **sweep the floor** (yeri süpürmek).`,
      ...
      quickQuestions: [
        { question: `"have to" ne anlama gelir?`, options: [`Zorunda olmak`, `İstemek`, `Sevmek`, `Yapabilmek`], correctIndex: 0 },
        { question: `"has to" hangi öznelerle kullanılır?`, options: [`He, she, it`, `I, you, we, they`, `Sadece I`, `Sadece you`], correctIndex: 0, explanation: `Doğru cevap: He, she, it (3. tekil)` },
        ...
        { question: `"don't have to" ne anlama gelir?`, options: [`Zorunda değilim`, `Zorundayım`, `İsterim`, `Severim`], correctIndex: 0 },
        { question: `"I ___ have to work today." (zorunda değilim) boşluğa?`, options: [`don't`, `doesn't`, `not`, `am not`], correctIndex: 0 },
        { question: `"She ___ have to cook." (zorunda değil) boşluğa?`, options: [`doesn't`, `don't`, `not`, `isn't`], correctIndex: 0 },
        ...
        { question: `"clear the table" Türkçesi nedir?`, options: [`sofrayı toplamak`, `sofra kurmak`, `temizlemek`, `silmek`], correctIndex: 0 },
        { question: `"vacuum the carpet" Türkçesi nedir?`, options: [`halıyı süpürgeyle çekmek`, `halıyı yıkamak`, `halıyı serip`, `halıyı toplamak`], correctIndex: 0 },
        ...
        { question: `Üçüncü tekil şahıs için "have to" nasıl olur?`, options: [`has to`, `have to`, `had to`, `having to`], correctIndex: 0, explanation: `Doğru cevap: has to (he/she/it has to)` },
        { question: `"I ___ to school by bus." cümlesinde "go" fiilini past hâle koyalım: ___?`, options: [`went`, `goed`, `goes`, `going`], correctIndex: 0 },
        { question: `Aşağıdaki ev işi (chore) ifadelerinden hangisi temizlik ile ilgilidir?`, options: [`vacuum the carpet`, `play football`, `read a book`, `watch TV`], correctIndex: 0 },
...
[tuzak] Çoğul/tekil uyumu: tek nesne → **was**, çoğul → **were**. "by" işi **yapanı** gösterir.`,
      ...
      quiz: [
        ...
        { question: `In a passive sentence, "by" shows...?`, options: [`the doer`, `the time`, `the place`, `the price`], correctIndex: 0, explanation: `Doğru cevap: the doer (yapan)` },
      ...
      quickQuestions: [
        ...
        { question: `"by" sözcüğü passive cümlede neyi gösterir?`, options: [`Yapan`, `Zaman`, `Yer`, `Fiyat`], correctIndex: 0, explanation: `Doğru cevap: Yapan (the doer)` },
        ...
        { question: `"The houses ___ built in 1990." (was/were)?`, options: [`were`, `was`, `is`, `did`], correctIndex: 0 },
        { question: `"The telephone ___ invented by Bell." (was/were)?`, options: [`was`, `were`, `is`, `did`], correctIndex: 0 },
        { question: `"Light bulbs ___ invented in the 19th century." (was/were)?`, options: [`were`, `was`, `is`, `are`], correctIndex: 0 },
        ...
        { question: `"scientist" Türkçesi nedir?`, options: [`bilim insanı`, `mühendis`, `doktor`, `öğretmen`], correctIndex: 0 },
        { question: `"experiment" Türkçesi nedir?`, options: [`deney`, `sonuç`, `kitap`, `okul`], correctIndex: 0 },
        { question: `"research" Türkçesi nedir?`, options: [`araştırma`, `oyun`, `sınav`, `proje`], correctIndex: 0 },
        ...
        { question: `Newton'un keşfettiği önemli prensip nedir?`, options: [`Yer çekimi`, `Elektrik`, `Buharlı motor`, `Penisilin`], correctIndex: 0, explanation: `Doğru cevap: Yer çekimi (gravity)` },
        { question: `Edison'un icadı en bilinen hangisidir?`, options: [`Ampul`, `Telefon`, `Otomobil`, `Uçak`], correctIndex: 0, explanation: `Doğru cevap: Ampul (light bulb)` },
        ...
        { question: `"The pyramids ___ built in Egypt." (was/were)?`, options: [`were`, `was`, `is`, `did`], correctIndex: 0 },
        ...
        { question: `Aşağıdaki cümlelerden hangisi passive'dir?`, options: [`The book was written in 1990.`, `He wrote the book.`, `She is writing a book.`, `They write books.`], correctIndex: 0 },
        { question: `"radioactivity" kim tarafından keşfedildi?`, options: [`Marie Curie`, `Edison`, `Bell`, `Fleming`], correctIndex: 0 },
      ],
    },
    {
      id: "natural-forces",
...
[kural] **If + geniş zaman, ... will + yalın fiil:** "**If** it **rains**, we **will stay** home."`,
      ...
      quiz: [
        ...
        { question: `"might" shows...?`, options: [`olasılık`, `kesinlik`, `geçmiş`, `emir`], correctIndex: 0, explanation: `Doğru cevap: olasılık (ihtimal)` },
      ...
      quickQuestions: [
        ...
        { question: `"wildfire" Türkçesi nedir?`, options: [`orman yangını`, `sel`, `çığ`, `deprem`], correctIndex: 0 },
        { question: `"tsunami" Türkçesi nedir?`, options: [`tsunami`, `sel`, `çığ`, `fırtına`], correctIndex: 0, explanation: `Doğru cevap: tsunami (dev dalga)` },
        { question: `Future Simple (gelecek zaman) yapısı nedir?`, options: [`will + base verb`, `am/is/are + V-ing`, `do/does + V`, `V + ed`], correctIndex: 0 },
        { question: `"will" sonra hangi fiil hâli gelir?`, options: [`Base verb`, `to + verb`, `verb + ing`, `verb + ed`], correctIndex: 0, explanation: `Doğru cevap: Base verb (yalın)` },
        ...
        { question: `"may" hangi anlama gelir?`, options: [`-ebilir`, `Kesinlikle yapacak`, `Zorunlu`, `Yasak`], correctIndex: 0, explanation: `Doğru cevap: -ebilir (ihtimal)` },
        { question: `"might" hangi anlama gelir?`, options: [`Daha düşük ihtimal`, `Kesinlik`, `Geçmiş`, `Emir`], correctIndex: 0 },
        ...
        { question: `"climate change" Türkçesi nedir?`, options: [`iklim değişikliği`, `hava durumu`, `mevsim`, `sıcaklık`], correctIndex: 0 },
        ...
        { question: `"recycle" Türkçesi nedir?`, options: [`geri dönüştürmek`, `çöpe atmak`, `temizlemek`, `yıkamak`], correctIndex: 0 },
        { question: `"environment" Türkçesi nedir?`, options: [`çevre`, `ev`, `okul`, `şehir`], correctIndex: 0 },
        { question: `"save energy" Türkçesi nedir?`, options: [`enerji tasarrufu yapmak`, `enerji harcamak`, `enerji üretmek`, `enerji satmak`], correctIndex: 0 },
