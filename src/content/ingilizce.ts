...
[tuzak] Daveti reddederken sadece "No" demek kabadır; **"Sorry, I can't..."** ile kibarca bir sebep eklenir.`,
      ...
      quickQuestions: [
        ...
        { question: `"I'd love to" ne anlama gelir?`, options: [`Çok isterim (kabul)`, `Reddetmek`, `Bilmiyorum`, `Belki`], correctIndex: 0 },
...
[soru] "She ___ goes to school." cümlesinde sıklık zarfı **özne ile fiil arasına** gelir.`,
      ...
      quickQuestions: [
        ...
        { question: `"How often" sorusuna ne ile cevap verilir?`, options: [`Sıklık zarfları (always, usually, sometimes...)`, `Tarih`, `Yer`, `Sayı`], correctIndex: 0 },
        ...
        { question: `"every Sunday" hangi zamanı belirtir?`, options: [`Simple Present (alışkanlık)`, `Present Continuous`, `Past Simple`, `Future`], correctIndex: 0 },
...
[tanım] **chop** (doğramak), **boil** (kaynatmak), **fry** (kızartmak), **pour** (dökmek), **slice** (dilimlemek).`,
      ...
      quickQuestions: [
        ...
        { question: `"a little" hangi isimle kullanılır?`, options: [`Sayılamayan (water, sugar)`, `Sayılabilen`, `Çoğul`, `Tek isim`], correctIndex: 0 },
        { question: `"a few" hangi isimle kullanılır?`, options: [`Sayılabilen çoğul (apples, books)`, `Sayılamayan`, `Tek isim`, `Hiçbiri`], correctIndex: 0 },
        ...
        { question: `"meal" Türkçesi nedir?`, options: [`yemek (öğün)`, `tabak`, `çatal`, `mutfak`], correctIndex: 0 },
...
[örnek] "What **are** you **doing**?" – "I**'m watching** a film."`,
      ...
      quickQuestions: [
        ...
        { question: `"run" fiilinin -ing hâli nedir?`, options: [`running (n çift)`, `runing`, `runs`, `runned`], correctIndex: 0 },
        { question: `"swim" fiilinin -ing hâli nedir?`, options: [`swimming`, `swiming`, `swimed`, `swimmed`], correctIndex: 0 },
        { question: `"write" fiilinin -ing hâli nedir?`, options: [`writing (e düşer)`, `writeing`, `writed`, `writes`], correctIndex: 0 },
...
[ipucu] Güvenli kalmak için **strong password** kullan, kişisel bilgini paylaşma.`,
      ...
      quickQuestions: [
        ...
        { question: `"browse" Türkçesi nedir?`, options: [`(internette) gezinmek`, `kapatmak`, `yazmak`, `silmek`], correctIndex: 0 },
        { question: `"online" Türkçesi nedir?`, options: [`çevrim içi`, `çevrim dışı`, `bozuk`, `kapalı`], correctIndex: 0 },
        { question: `"offline" Türkçesi nedir?`, options: [`çevrim dışı`, `çevrim içi`, `açık`, `mesgul`], correctIndex: 0 },
        ...
        { question: `"because" hangi anlam ilişkisini kurar?`, options: [`Sebep (reason)`, `Sonuç`, `Zaman`, `Yer`], correctIndex: 0 },
        { question: `"so" hangi anlam ilişkisini kurar?`, options: [`Sonuç (result)`, `Sebep`, `Karşıtlık`, `Yer`], correctIndex: 0 },
        { question: `"but" hangi anlam ilişkisini kurar?`, options: [`Karşıtlık (contrast)`, `Sebep`, `Sonuç`, `Yer`], correctIndex: 0 },
        { question: `"and" hangi anlam ilişkisini kurar?`, options: [`Ekleme (addition)`, `Sebep`, `Karşıtlık`, `Sonuç`], correctIndex: 0 },
...
[tanım] **excited** (heyecanlı), **scared** (korkmuş), **nervous** (gergin), **bored** (sıkılmış), **brave** (cesur).`,
      ...
      quickQuestions: [
        { question: `"should" hangi anlama gelir?`, options: [`-meli/-malı (tavsiye)`, `Zorunluluk`, `Gelecek`, `Geçmiş`], correctIndex: 0 },
        { question: `"should" sonra hangi fiil hâli gelir?`, options: [`Base verb (yalın hâl)`, `to + verb`, `verb + ing`, `verb + ed`], correctIndex: 0 },
        ...
        { question: `"Should I go?" hangi yapıdır?`, options: [`Soru cümlesi (tavsiye istemek)`, `Olumlu cümle`, `Emir`, `Geçmiş`], correctIndex: 0 },
...
[tanım] **sightseeing** (gezi), **souvenir** (hatıra eşyası), **tour guide** (tur rehberi), **accommodation** (konaklama), **journey** (yolculuk).`,
      ...
      quickQuestions: [
        ...
        { question: `"buy" fiilinin past hâli?`, options: [`bought`, `buyed`, `buy`, `bought`], correctIndex: 0 },
...
[tanım] **do the dishes** (bulaşık yıkamak), **make the bed** (yatağı toplamak), **take out the rubbish** (çöpü çıkarmak), **set the table** (sofrayı kurmak), **sweep the floor** (yeri süpürmek).`,
      ...
      quickQuestions: [
        ...
        { question: `"has to" hangi öznelerle kullanılır?`, options: [`He, she, it (3. tekil)`, `I, you, we, they`, `Sadece I`, `Sadece you`], correctIndex: 0 },
        ...
        { question: `"have to" ile "must" arasındaki fark nedir?`, options: [`Anlamca benzer; have to dış zorunluluk, must iç zorunluluk`, `Tam zıttır`, `Hiç bir fark yok`, `Sadece zaman farkı`], correctIndex: 0 },
        { question: `"I ___ to school by bus." cümlesinde "go" fiilini past hâle koyalım: ___?`, options: [`went`, `goed`, `goes`, `going`], correctIndex: 0 },
        { question: `"I had to do my homework yesterday." cümlesinde "had to" ne demektir?`, options: [`Yapmak zorundaydım (geçmiş)`, `Yapacağım`, `Yapıyorum`, `Yaparım`], correctIndex: 0 },
...
[tuzak] Çoğul/tekil uyumu: tek nesne → **was**, çoğul → **were**. "by" işi **yapanı** gösterir.`,
      ...
      quickQuestions: [
        { question: `Passive Voice (edilgen yapı) yapısı nedir?`, options: [`be (am/is/are/was/were) + V3 (past participle)`, `am/is/are + V1`, `do/does + V`, `have/has + V3`], correctIndex: 0 },
        { question: `Past Passive (geçmiş edilgen) yapısı nedir?`, options: [`was/were + V3`, `am/is/are + V3`, `did + V1`, `do/does + V`], correctIndex: 0 },
        { question: `"by" sözcüğü passive cümlede neyi gösterir?`, options: [`Yapan (the doer)`, `Zaman`, `Yer`, `Fiyat`], correctIndex: 0 },
        ...
        { question: `Newton'un keşfettiği önemli prensip nedir?`, options: [`Yer çekimi (gravity)`, `Elektrik`, `Buharlı motor`, `Penisilin`], correctIndex: 0 },
        { question: `Edison'un icadı en bilinen hangisidir?`, options: [`Ampul (light bulb)`, `Telefon`, `Otomobil`, `Uçak`], correctIndex: 0 },
...
[kural] **If + geniş zaman, ... will + yalın fiil:** "**If** it **rains**, we **will stay** home."`,
      ...
      quickQuestions: [
        ...
        { question: `"tsunami" Türkçesi nedir?`, options: [`tsunami (dev dalga)`, `sel`, `çığ`, `fırtına`], correctIndex: 0 },
        { question: `Future Simple (gelecek zaman) yapısı nedir?`, options: [`will + base verb`, `am/is/are + V-ing`, `do/does + V`, `V + ed`], correctIndex: 0 },
        { question: `"will" sonra hangi fiil hâli gelir?`, options: [`Base verb (yalın)`, `to + verb`, `verb + ing`, `verb + ed`], correctIndex: 0 },
        ...
        { question: `"may" hangi anlama gelir?`, options: [`-ebilir (ihtimal)`, `Kesinlikle yapacak`, `Zorunlu`, `Yasak`], correctIndex: 0 },
