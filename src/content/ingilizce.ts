...
[soru] "She ___ goes to school." cümlesinde sıklık zarfı **özne ile fiil arasına** gelir.`,
      ...
      quickQuestions: [
        ...
        { question: `"How often" sorusuna ne ile cevap verilir?`, options: [`Sıklık zarfları`, `Tarih`, `Yer`, `Sayı`], correctIndex: 0, explanation: `Sıklık zarfları (always, usually, sometimes...)` },
...
[tanım] **chop** (doğramak), **boil** (kaynatmak), **fry** (kızartmak), **pour** (dökmek), **slice** (dilimlemek).`,
      ...
      quickQuestions: [
        ...
        { question: `"a few" hangi isimle kullanılır?`, options: [`Sayılabilen çoğul`, `Sayılamayan`, `Tek isim`, `Hiçbiri`], correctIndex: 0, explanation: `Sayılabilen çoğul (apples, books)` },
...
[ipucu] Güvenli kalmak için **strong password** kullan, kişisel bilgini paylaşma.`,
      ...
      quickQuestions: [
        ...
        { question: `"but" hangi anlam ilişkisini kurar?`, options: [`Karşıtlık`, `Sebep`, `Sonuç`, `Yer`], correctIndex: 0 },
